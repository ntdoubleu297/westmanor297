...
//useEffect(() => {
  ...
  {name: 'Newport', counties: [{name: 'RI', towns: ['Newport, RI']}]}
]
  };  
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={multifam} alt='math' />
     ...
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/activemultifamilyctg">Active</a>
