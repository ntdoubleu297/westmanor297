...
//useEffect(() => {
  ...
  {name: 'Hillsborough', counties: [{name: 'FL', towns: ['Tampa, FL']}]},
  {name: 'Kauai', counties: [{name: 'HI', towns: ['Kalaheo, HI']}]},
...
.map((item, index) => (
  ...
  <ul className='scroll' data-index={index}>
  <br/>
...
async function brucewayne22a(e){ 
  ...
  const req = await fetch('http://localhost:5000/prototypeJS', {mode: 'cors'})
...
<br/>
<div className='borders'>
<img className='modalin' src={item.photosMAIN}></img>
<br/>
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async function populateQuoteperc(e){ //this functions onClick...
      ...
      //if (data.status ==='ok'){
        ...
        '8/1/2022','8/2/2022','8/3/2022','8/4/2022','8/5/2022','8/6/2022','8/7/2022','8/8/2022','8/9/2022','8/10/2022','8/11/2022','8/12/2022','8/13/2022','8/14/2022','8/15/2022','8/16/2022','8/17/2022','8/18/2022','8/19/2022','8/20/2022','8/21/2022','8/22/2022','8/23/2022','8/24/2022','8/25/2022','8/26/2022','8/27/2022','8/28/2022','8/29/2022','8/30/2022',
        ...
        for (let i = 0; i<data.length; i++){
          if (data[i].county ===`${county3}` && data[i].townstate === `${town2}` && data[i].listprice !=='AUCTION' && data[i].differenial !== "#VALUE!" && (data[i].saledate === '1/1/2022' || data[i].saledate ==='1/2/2022' || data[i].saledate ==='1/3/2022' || data[i].saledate ==='1/4/2022' || data[i].saledate ==='1/5/2022' || data[i].saledate ==='1/6/2022' || data[i].saledate ==='1/7/2022' || data[i].saledate ==='1/8/2022' || data[i].saledate ==='1/9/2022' || data[i].saledate ==='1/10/2022' || data[i].saledate ==='1/11/2022' || data[i].saledate ==='1/12/2022' || data[i].saledate ==='1/13/2022' || data[i].saledate ==='1/14/2022' || data[i].saledate ==='1/15/2022' || data[i].saledate ==='1/16/2022' || data[i].saledate ==='1/17/2022' || data[i].saledate ==='1/18/2022' || data[i].saledate ==='1/19/2022' || data[i].saledate ==='1/20/2022' || data[i].saledate ==='1/21/2022' || data[i].saledate ==='1/22/2022' || data[i].saledate ==='1/23/2022' || data[i].saledate ==='1/24/2022' || data[i].saledate ==='1/25/2022' || data[i].saledate ==='1/26/2022' || data[i].saledate ==='1/27/2022'|| data[i].saledate ==='1/28/2022'|| data[i].saledate ==='1/29/2022' || data[i].saledate ==='1/30/2022' || data[i].saledate ==='1/31/2022'
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   <img style={{zIndex: '7', height: '500px', width: '700px'}} src={item.photos[5]}></img>
        ...
        <td ref={(_subtitle) => (subtitle = _subtitle)}>Property Type: {item.propertytype}</td><br/>
        <td ref={(_subtitle) => (subtitle = _subtitle)}>Sale Date: {item.saledate}</td><br/>
        <td ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td><br/>
        </div>
        </ul>
...
const pageCount83 = Math.ceil(lastyear4.length / PER_PAGE); 
       ...
       const [popquoteApril, setPopquoteApril] = React.useState(0);
         ...
         // entireArrayIndex(); doesnt fire here.....
          ...
          let great = [];
          for (let i = 0; i<data.length; i++){
            if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].saleprice >= `${pricevalue}` && data[i].saleprice <= `${pricevalue2}` && data[i].year === 2021 && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" && (data[i].saledate ==='8/1/2021'|| data[i].saledate ==='8/2/2021' || data[i].saledate ==='8/3/2021' || data[i].saledate ==='8/4/2021' || data[i].saledate ==='8/5/2021' || data[i].saledate ==='8/6/2021' || data[i].saledate ==='8/7/2021' || data[i].saledate ==='8/8/2021' || data[i].saledate ==='8/9/2021' || data[i].saledate ==='8/10/2021' || data[i].saledate ==='8/11/2021' || data[i].saledate ==='8/12/2021' || data[i].saledate ==='8/13/2021' || data[i].saledate ==='8/14/2021' || data[i].saledate ==='8/15/2021' || data[i].saledate ==='8/16/2021' || data[i].saledate ==='8/17/2021' || data[i].saledate ==='8/18/2021' || data[i].saledate ==='8/19/2021' || data[i].saledate ==='8/20/2021' || data[i].saledate ==='8/21/2021' || data[i].saledate ==='8/22/2021' || data[i].saledate ==='8/23/2021' || data[i].saledate ==='8/24/2021' || data[i].saledate ==='8/25/2021' || data[i].saledate ==='8/26/2021' || data[i].saledate ==='8/27/2021'|| data[i].saledate ==='8/28/2021'|| data[i].saledate ==='8/29/2021' || data[i].saledate ==='8/30/2021' || 
             data[i].saledate === '5/1/2021' || data[i].saledate ==='5/2/2021' || data[i].saledate ==='5/3/2021' || data[i].saledate ==='5/4/2021' || data[i].saledate ==='5/5/2021' || data[i].saledate ==='5/6/2021' || data[i].saledate ==='5/7/2021' || data[i].saledate ==='5/8/2021' || data[i].saledate ==='5/9/2021' || data[i].saledate ==='5/10/2021' || data[i].saledate ==='5/11/2021' || data[i].saledate ==='5/12/2021' || data[i].saledate ==='5/13/2021' || data[i].saledate ==='5/14/2021' || data[i].saledate ==='5/15/2021'|| data[i].saledate ==='5/16/2021'|| data[i].saledate ==='5/17/2021' || data[i].saledate ==='5/18/2021' || data[i].saledate ==='5/19/2021' || data[i].saledate ==='5/20/2021' || data[i].saledate ==='5/21/2021' || data[i].saledate ==='5/22/2021' || data[i].saledate ==='5/23/2021' || data[i].saledate ==='5/24/2021' || data[i].saledate ==='5/25/2021' || data[i].saledate ==='5/26/2021'|| data[i].saledate ==='5/27/2021' || data[i].saledate ==='5/28/2021'
    ...
    const [popquoteOctober, setPopquoteOctober] = React.useState(0);
            ...
            async function jack10suit(e){ 
             ...
             React.useEffect(() => { //use the useEffect hook with useState to call that route and then update the UI
               fetch('http://localhost:5000/prototypeJS', {mode: 'cors'})
                 ...
                 console.log(data) // all 15k objects...
                       ...
                       for (let i = 0; i<data.length; i++){
                         if (data[i].county === `${pricerangecounty1}` && data[i].townstate === `${pricerangetown1}` && data[i].year === 2019 && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" && (data[i].saledate ==='1/1/2019'|| data[i].saledate ==='1/2/2019' || data[i].saledate ==='1/3/2019' || data[i].saledate ==='1/4/2019' || data[i].saledate ==='1/5/2019' || data[i].saledate ==='1/6/2019' || data[i].saledate ==='1/7/2019' || data[i].saledate ==='1/8/2019' || data[i].saledate ==='1/9/2019' || data[i].saledate ==='1/10/2019' || data[i].saledate ==='1/11/2019' || data[i].saledate ==='1/12/2019' || data[i].saledate ==='1/13/2019' || data[i].saledate ==='1/14/2019' || data[i].saledate ==='1/15/2019' || data[i].saledate ==='1/16/2019' || data[i].saledate ==='1/17/2019' || data[i].saledate ==='1/18/2019' || data[i].saledate ==='1/19/2019' || data[i].saledate ==='1/20/2019' || data[i].saledate ==='1/21/2019' || data[i].saledate ==='1/22/2019' || data[i].saledate ==='1/23/2019' || data[i].saledate ==='1/24/2019' || data[i].saledate ==='1/25/2019' || data[i].saledate ==='1/26/2019' || data[i].saledate ==='1/27/2019'|| data[i].saledate ==='1/28/2019'|| data[i].saledate ==='1/29/2019' || data[i].saledate ==='1/30/2019' || data[i].saledate ==='1/31/2019'
                           ...
                           || data[i].saledate === '3/1/2019' || data[i].saledate ==='3/2/2019'|| data[i].saledate ==='3/3/2019' || data[i].saledate ==='3/4/2019' || data[i].saledate ==='3/5/2019' || data[i].saledate ==='3/6/2019' || data[i].saledate ==='3/7/2019' || data[i].saledate ==='3/8/2019' || data[i].saledate ==='3/9/2019'|| data[i].saledate ==='3/10/2019'|| data[i].saledate ==='3/11/2019' || data[i].saledate ==='3/12/2019'|| data[i].saledate === '3/13/2019'|| data[i].saledate ==='3/14/2019' || data[i].saledate ==='3/15/2019' || data[i].saledate ==='3/16/2019' || data[i].saledate ==='3/17/2019' || data[i].saledate ==='3/18/2019' || data[i].saledate ==='3/19/2019' || data[i].saledate ==='3/20/2019' || data[i].saledate ==='3/21/2019'|| data[i].saledate ==='3/22/2019' || data[i].saledate ==='3/23/2019' || data[i].saledate ==='3/24/2019' || data[i].saledate ==='3/25/2019' || data[i].saledate ==='3/26/2019' || data[i].saledate ==='3/27/2019'|| data[i].saledate ==='3/28/2019' || data[i].saledate ==='3/29/2019' || data[i].saledate ==='3/30/2019' || data[i].saledate ==='3/31/2019' && data[i].saledate ==='8/1/2019'|| data[i].saledate ==='8/2/2019' || data[i].saledate ==='8/3/2019' || data[i].saledate ==='8/4/2019' || data[i].saledate ==='8/5/2019' || data[i].saledate ==='8/6/2019' || data[i].saledate ==='8/7/2019' || data[i].saledate ==='8/8/2019' || data[i].saledate ==='8/9/2019' || data[i].saledate ==='8/10/2019' || data[i].saledate ==='8/11/2019' || data[i].saledate ==='8/12/2019' || data[i].saledate ==='8/13/2019' || data[i].saledate ==='8/14/2019' || data[i].saledate ==='8/15/2019' || data[i].saledate ==='8/16/2019' || data[i].saledate ==='8/17/2019' || data[i].saledate ==='8/18/2019' || data[i].saledate ==='8/19/2019' || data[i].saledate ==='8/20/2019' || data[i].saledate ==='8/21/2019' || data[i].saledate ==='8/22/2019' || data[i].saledate ==='8/23/2019' || data[i].saledate ==='8/24/2019' || data[i].saledate ==='8/25/2019' || data[i].saledate ==='8/26/2019' || data[i].saledate ==='8/27/2019'|| data[i].saledate ==='8/28/2019'|| data[i].saledate ==='8/29/2019' || data[i].saledate ==='8/30/2019' || 
 ...
 ////////////////////////////////////////////////////////////////////////////////////////////////////////////
               ...
               // entireArrayIndex(); doesnt fire here.....
                ...
                let sales = [];
                   ...
                   for (let i = 0; i<data.length; i++){
                     if (data[i].county === `${pricerangecounty1}` && data[i].townstate === `${pricerangetown1}` && data[i].year === 2022 && data[i].listprice !=='AUCTION' && data[i].differenial !== "#VALUE!" && (data[i].saledate ==='1/1/2022' || data[i].saledate ==='1/2/2022' || data[i].saledate ==='1/3/2022' || data[i].saledate ==='1/4/2022' || data[i].saledate ==='1/5/2022' || data[i].saledate ==='1/6/2022' || data[i].saledate ==='1/7/2022' || data[i].saledate ==='1/8/2022' || data[i].saledate ==='1/9/2022' || data[i].saledate ==='1/10/2022' || data[i].saledate ==='1/11/2022' || data[i].saledate ==='1/12/2022' || data[i].saledate ==='1/13/2022' || data[i].saledate ==='1/14/2022' || data[i].saledate ==='1/15/2022' || data[i].saledate ==='1/16/2022' || data[i].saledate ==='1/17/2022' || data[i].saledate ==='1/18/2022' || data[i].saledate ==='1/19/2022' || data[i].saledate ==='1/20/2022' || data[i].saledate ==='1/21/2022' || data[i].saledate ==='1/22/2022' || data[i].saledate ==='1/23/2022' || data[i].saledate ==='1/24/2022' || data[i].saledate ==='1/25/2022' || data[i].saledate ==='1/26/2022' || data[i].saledate ==='1/27/2022'|| data[i].saledate ==='1/28/2022'|| data[i].saledate ==='1/29/2022' || data[i].saledate ==='1/30/2022' || data[i].saledate ==='1/31/2022'
                     || data[i].saledate === '2/1/2022' || data[i].saledate ==='2/2/2022' || data[i].saledate ==='2/3/2022' || data[i].saledate ==='2/4/2022' || data[i].saledate ==='2/5/2022' || data[i].saledate ==='2/6/2022' || data[i].saledate ==='2/7/2022' || data[i].saledate ==='2/8/2022' || data[i].saledate ==='2/9/2022' || data[i].saledate ==='2/10/2022' || data[i].saledate ==='2/11/2022' || data[i].saledate ==='2/12/2022' || data[i].saledate ==='2/13/2022' || data[i].saledate ==='2/14/2022' || data[i].saledate ==='2/15/2022'|| data[i].saledate ==='2/16/2022'|| data[i].saledate ==='2/17/2022' || data[i].saledate ==='2/18/2022' || data[i].saledate ==='2/19/2022' || data[i].saledate ==='2/20/2022' || data[i].saledate ==='2/21/2022' || data[i].saledate ==='2/22/2022' || data[i].saledate ==='2/23/2022' || data[i].saledate ==='2/24/2022' || data[i].saledate ==='2/25/2022' || data[i].saledate ==='2/26/2022'|| data[i].saledate ==='2/27/2022' || data[i].saledate ==='2/28/2022'
                     || data[i].saledate === '3/1/2022' || data[i].saledate ==='3/2/2022'|| data[i].saledate ==='3/3/2022' || data[i].saledate ==='3/4/2022' || data[i].saledate ==='3/5/2022' || data[i].saledate ==='3/6/2022' || data[i].saledate ==='3/7/2022' || data[i].saledate ==='3/8/2022' || data[i].saledate ==='3/9/2022'|| data[i].saledate ==='3/10/2022'|| data[i].saledate ==='3/11/2022' || data[i].saledate ==='3/12/2022'|| data[i].saledate === '3/13/2022'|| data[i].saledate ==='3/14/2022' || data[i].saledate ==='3/15/2022' || data[i].saledate ==='3/16/2022' || data[i].saledate ==='3/17/2022' || data[i].saledate ==='3/18/2022' || data[i].saledate ==='3/19/2022' || data[i].saledate ==='3/20/2022' || data[i].saledate ==='3/21/2022'|| data[i].saledate ==='3/22/2022' || data[i].saledate ==='3/23/2022' || data[i].saledate ==='3/24/2022' || data[i].saledate ==='3/25/2022' || data[i].saledate ==='3/26/2022' || data[i].saledate ==='3/27/2022'|| data[i].saledate ==='3/28/2022' || data[i].saledate ==='3/29/2022' || data[i].saledate ==='3/30/2022' || data[i].saledate ==='3/31/2022' || data[i].saledate ==='8/1/2022'|| data[i].saledate ==='8/2/2022' || data[i].saledate ==='8/3/2022' || data[i].saledate ==='8/4/2022' || data[i].saledate ==='8/5/2022' || data[i].saledate ==='8/6/2022' || data[i].saledate ==='8/7/2022' || data[i].saledate ==='8/8/2022' || data[i].saledate ==='8/9/2022' || data[i].saledate ==='8/10/2022' || data[i].saledate ==='8/11/2022' || data[i].saledate ==='8/12/2022' || data[i].saledate ==='8/13/2022' || data[i].saledate ==='8/14/2022' || data[i].saledate ==='8/15/2022' || data[i].saledate ==='8/16/2022' || data[i].saledate ==='8/17/2022' || data[i].saledate ==='8/18/2022' || data[i].saledate ==='8/19/2022' || data[i].saledate ==='8/20/2022' || data[i].saledate ==='8/21/2022' || data[i].saledate ==='8/22/2022' || data[i].saledate ==='8/23/2022' || data[i].saledate ==='8/24/2022' || data[i].saledate ==='8/25/2022' || data[i].saledate ==='8/26/2022' || data[i].saledate ==='8/27/2022'|| data[i].saledate ==='8/28/2022'|| data[i].saledate ==='8/29/2022' || data[i].saledate ==='8/30/2022' 
                     || data[i].saledate === '5/1/2022' || data[i].saledate ==='5/2/2022' || data[i].saledate ==='5/3/2022' || data[i].saledate ==='5/4/2022' || data[i].saledate ==='5/5/2022' || data[i].saledate ==='5/6/2022' || data[i].saledate ==='5/7/2022' || data[i].saledate ==='5/8/2022' || data[i].saledate ==='5/9/2022' || data[i].saledate ==='5/10/2022' || data[i].saledate ==='5/11/2022' || data[i].saledate ==='5/12/2022' || data[i].saledate ==='5/13/2022' || data[i].saledate ==='5/14/2022' || data[i].saledate ==='5/15/2022'|| data[i].saledate ==='5/16/2022'|| data[i].saledate ==='5/17/2022' || data[i].saledate ==='5/18/2022' || data[i].saledate ==='5/19/2022' || data[i].saledate ==='5/20/2022' || data[i].saledate ==='5/21/2022' || data[i].saledate ==='5/22/2022' || data[i].saledate ==='5/23/2022' || data[i].saledate ==='5/24/2022' || data[i].saledate ==='5/25/2022' || data[i].saledate ==='5/26/2022'|| data[i].saledate ==='5/27/2022' || data[i].saledate ==='5/28/2022'
                     || data[i].saledate === '5/29/2022' || data[i].saledate === '5/30/2022' || data[i].saledate ==='5/31/2022') ){
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   async function populateQuote(e){ //this functions onClick...
     ...
     //if (data.status ==='ok'){
       ...
       for (let i = 0; i<data.length; i++){
         if (data[i].county ===`${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].listprice !=='AUCTION' && data[i].differenial !== "#VALUE!" && (data[i].saledate ==='1/1/2022' || data[i].saledate ==='1/2/2022' || data[i].saledate ==='1/3/2022' || data[i].saledate ==='1/4/2022' || data[i].saledate ==='1/5/2022' || data[i].saledate ==='1/6/2022' || data[i].saledate ==='1/7/2022' || data[i].saledate ==='1/8/2022' || data[i].saledate ==='1/9/2022' || data[i].saledate ==='1/10/2022' || data[i].saledate ==='1/11/2022' || data[i].saledate ==='1/12/2022' || data[i].saledate ==='1/13/2022' || data[i].saledate ==='1/14/2022' || data[i].saledate ==='1/15/2022' || data[i].saledate ==='1/16/2022' || data[i].saledate ==='1/17/2022' || data[i].saledate ==='1/18/2022' || data[i].saledate ==='1/19/2022' || data[i].saledate ==='1/20/2022' || data[i].saledate ==='1/21/2022' || data[i].saledate ==='1/22/2022' || data[i].saledate ==='1/23/2022' || data[i].saledate ==='1/24/2022' || data[i].saledate ==='1/25/2022' || data[i].saledate ==='1/26/2022' || data[i].saledate ==='1/27/2022'|| data[i].saledate ==='1/28/2022'|| data[i].saledate ==='1/29/2022' || data[i].saledate ==='1/30/2022' || data[i].saledate ==='1/31/2022'
         || data[i].saledate === '2/1/2022' || data[i].saledate ==='2/2/2022' || data[i].saledate ==='2/3/2022' || data[i].saledate ==='2/4/2022' || data[i].saledate ==='2/5/2022' || data[i].saledate ==='2/6/2022' || data[i].saledate ==='2/7/2022' || data[i].saledate ==='2/8/2022' || data[i].saledate ==='2/9/2022' || data[i].saledate ==='2/10/2022' || data[i].saledate ==='2/11/2022' || data[i].saledate ==='2/12/2022' || data[i].saledate ==='2/13/2022' || data[i].saledate ==='2/14/2022' || data[i].saledate ==='2/15/2022'|| data[i].saledate ==='2/16/2022'|| data[i].saledate ==='2/17/2022' || data[i].saledate ==='2/18/2022' || data[i].saledate ==='2/19/2022' || data[i].saledate ==='2/20/2022' || data[i].saledate ==='2/21/2022' || data[i].saledate ==='2/22/2022' || data[i].saledate ==='2/23/2022' || data[i].saledate ==='2/24/2022' || data[i].saledate ==='2/25/2022' || data[i].saledate ==='2/26/2022'|| data[i].saledate ==='2/27/2022' || data[i].saledate ==='2/28/2022'
         || data[i].saledate === '3/1/2022' || data[i].saledate ==='3/2/2022'|| data[i].saledate ==='3/3/2022' || data[i].saledate ==='3/4/2022' || data[i].saledate ==='3/5/2022' || data[i].saledate ==='3/6/2022' || data[i].saledate ==='3/7/2022' || data[i].saledate ==='3/8/2022' || data[i].saledate ==='3/9/2022'|| data[i].saledate ==='3/10/2022'|| data[i].saledate ==='3/11/2022' || data[i].saledate ==='3/12/2022'|| data[i].saledate === '3/13/2022'|| data[i].saledate ==='3/14/2022' || data[i].saledate ==='3/15/2022' || data[i].saledate ==='3/16/2022' || data[i].saledate ==='3/17/2022' || data[i].saledate ==='3/18/2022' || data[i].saledate ==='3/19/2022' || data[i].saledate ==='3/20/2022' || data[i].saledate ==='3/21/2022'|| data[i].saledate ==='3/22/2022' || data[i].saledate ==='3/23/2022' || data[i].saledate ==='3/24/2022' || data[i].saledate ==='3/25/2022' || data[i].saledate ==='3/26/2022' || data[i].saledate ==='3/27/2022'|| data[i].saledate ==='3/28/2022' || data[i].saledate ==='3/29/2022' || data[i].saledate ==='3/30/2022' || data[i].saledate ==='3/31/2022' || data[i].saledate ==='8/1/2022'|| data[i].saledate ==='8/2/2022' || data[i].saledate ==='8/3/2022' || data[i].saledate ==='8/4/2022' || data[i].saledate ==='8/5/2022' || data[i].saledate ==='8/6/2022' || data[i].saledate ==='8/7/2022' || data[i].saledate ==='8/8/2022' || data[i].saledate ==='8/9/2022' || data[i].saledate ==='8/10/2022' || data[i].saledate ==='8/11/2022' || data[i].saledate ==='8/12/2022' || data[i].saledate ==='8/13/2022' || data[i].saledate ==='8/14/2022' || data[i].saledate ==='8/15/2022' || data[i].saledate ==='8/16/2022' || data[i].saledate ==='8/17/2022' || data[i].saledate ==='8/18/2022' || data[i].saledate ==='8/19/2022' || data[i].saledate ==='8/20/2022' || data[i].saledate ==='8/21/2022' || data[i].saledate ==='8/22/2022' || data[i].saledate ==='8/23/2022' || data[i].saledate ==='8/24/2022' || data[i].saledate ==='8/25/2022' || data[i].saledate ==='8/26/2022' || data[i].saledate ==='8/27/2022'|| data[i].saledate ==='8/28/2022'|| data[i].saledate ==='8/29/2022' || data[i].saledate ==='8/30/2022' 
         || data[i].saledate === '5/1/2022' || data[i].saledate ==='5/2/2022' || data[i].saledate ==='5/3/2022' || data[i].saledate ==='5/4/2022' || data[i].saledate ==='5/5/2022' || data[i].saledate ==='5/6/2022' || data[i].saledate ==='5/7/2022' || data[i].saledate ==='5/8/2022' || data[i].saledate ==='5/9/2022' || data[i].saledate ==='5/10/2022' || data[i].saledate ==='5/11/2022' || data[i].saledate ==='5/12/2022' || data[i].saledate ==='5/13/2022' || data[i].saledate ==='5/14/2022' || data[i].saledate ==='5/15/2022'|| data[i].saledate ==='5/16/2022'|| data[i].saledate ==='5/17/2022' || data[i].saledate ==='5/18/2022' || data[i].saledate ==='5/19/2022' || data[i].saledate ==='5/20/2022' || data[i].saledate ==='5/21/2022' || data[i].saledate ==='5/22/2022' || data[i].saledate ==='5/23/2022' || data[i].saledate ==='5/24/2022' || data[i].saledate ==='5/25/2022' || data[i].saledate ==='5/26/2022'|| data[i].saledate ==='5/27/2022' || data[i].saledate ==='5/28/2022'
         || data[i].saledate === '5/29/2022' || data[i].saledate === '5/30/2022' || data[i].saledate ==='5/31/2022') ){
        ...
        setSalesalessale('Average Sale Price'); // title
           ...
           <div>
           <Popup trigger={<a id='sales45' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1725px' }}></a>}
              position='center'>
               <div></div>
              </Popup>
              </div>
     ...
     async function DOM85PopulateQuote(e){ //this functions onClick...
      ...
      //if (data.status ==='ok'){
        ...
        let twentyone = [
          ...
          '8/1/2021','8/2/2021','8/3/2021','8/4/2021','8/5/2021','8/6/2021','8/7/2021','8/8/2021','8/9/2021','8/10/2021','8/11/2021','8/12/2021','8/13/2021','8/14/2021','8/15/2021','8/16/2021','8/17/2021','8/18/2021','8/19/2021','8/20/2021','8/21/2021','8/22/2021','8/23/2021','8/24/2021','8/25/2021','8/26/2021','8/27/2021','8/28/2021','8/29/2021','8/30/2021',
   ...
   document.getElementById('DOM85populatequote').innerHTML = '85% of sales sold @ ' + `${DOMTotalsalesinnerElement}` + 'days of ' + `${TotalSalesamount}` + ' Total Sales'; // showing 80...
      ...
      console.log(index21);
          ...
          for (let i = 0; i<data.length; i++){
            if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= data[i].listprice && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}` && (data[i].saledate ==='1/1/2022' || data[i].saledate ==='1/2/2022' || data[i].saledate ==='1/3/2022' || data[i].saledate ==='1/4/2022' || data[i].saledate ==='1/5/2022' || data[i].saledate ==='1/6/2022' || data[i].saledate ==='1/7/2022' || data[i].saledate ==='1/8/2022' || data[i].saledate ==='1/9/2022' || data[i].saledate ==='1/10/2022' || data[i].saledate ==='1/11/2022' || data[i].saledate ==='1/12/2022' || data[i].saledate ==='1/13/2022' || data[i].saledate ==='1/14/2022' || data[i].saledate ==='1/15/2022' || data[i].saledate ==='1/16/2022' || data[i].saledate ==='1/17/2022' || data[i].saledate ==='1/18/2022' || data[i].saledate ==='1/19/2022' || data[i].saledate ==='1/20/2022' || data[i].saledate ==='1/21/2022' || data[i].saledate ==='1/22/2022' || data[i].saledate ==='1/23/2022' || data[i].saledate ==='1/24/2022' || data[i].saledate ==='1/25/2022' || data[i].saledate ==='1/26/2022' || data[i].saledate ==='1/27/2022'|| data[i].saledate ==='1/28/2022'|| data[i].saledate ==='1/29/2022' || data[i].saledate ==='1/30/2022' || data[i].saledate ==='1/31/2022'
            || data[i].saledate === '2/1/2022' || data[i].saledate ==='2/2/2022' || data[i].saledate ==='2/3/2022' || data[i].saledate ==='2/4/2022' || data[i].saledate ==='2/5/2022' || data[i].saledate ==='2/6/2022' || data[i].saledate ==='2/7/2022' || data[i].saledate ==='2/8/2022' || data[i].saledate ==='2/9/2022' || data[i].saledate ==='2/10/2022' || data[i].saledate ==='2/11/2022' || data[i].saledate ==='2/12/2022' || data[i].saledate ==='2/13/2022' || data[i].saledate ==='2/14/2022' || data[i].saledate ==='2/15/2022'|| data[i].saledate ==='2/16/2022'|| data[i].saledate ==='2/17/2022' || data[i].saledate ==='2/18/2022' || data[i].saledate ==='2/19/2022' || data[i].saledate ==='2/20/2022' || data[i].saledate ==='2/21/2022' || data[i].saledate ==='2/22/2022' || data[i].saledate ==='2/23/2022' || data[i].saledate ==='2/24/2022' || data[i].saledate ==='2/25/2022' || data[i].saledate ==='2/26/2022'|| data[i].saledate ==='2/27/2022' || data[i].saledate ==='2/28/2022'
            || data[i].saledate === '3/1/2022' || data[i].saledate ==='3/2/2022'|| data[i].saledate ==='3/3/2022' || data[i].saledate ==='3/4/2022' || data[i].saledate ==='3/5/2022' || data[i].saledate ==='3/6/2022' || data[i].saledate ==='3/7/2022' || data[i].saledate ==='3/8/2022' || data[i].saledate ==='3/9/2022'|| data[i].saledate ==='3/10/2022'|| data[i].saledate ==='3/11/2022' || data[i].saledate ==='3/12/2022'|| data[i].saledate === '3/13/2022'|| data[i].saledate ==='3/14/2022' || data[i].saledate ==='3/15/2022' || data[i].saledate ==='3/16/2022' || data[i].saledate ==='3/17/2022' || data[i].saledate ==='3/18/2022' || data[i].saledate ==='3/19/2022' || data[i].saledate ==='3/20/2022' || data[i].saledate ==='3/21/2022'|| data[i].saledate ==='3/22/2022' || data[i].saledate ==='3/23/2022' || data[i].saledate ==='3/24/2022' || data[i].saledate ==='3/25/2022' || data[i].saledate ==='3/26/2022' || data[i].saledate ==='3/27/2022'|| data[i].saledate ==='3/28/2022' || data[i].saledate ==='3/29/2022' || data[i].saledate ==='3/30/2022' || data[i].saledate ==='3/31/2022' || data[i].saledate ==='8/1/2022'|| data[i].saledate ==='8/2/2022' || data[i].saledate ==='8/3/2022' || data[i].saledate ==='8/4/2022' || data[i].saledate ==='8/5/2022' || data[i].saledate ==='8/6/2022' || data[i].saledate ==='8/7/2022' || data[i].saledate ==='8/8/2022' || data[i].saledate ==='8/9/2022' || data[i].saledate ==='8/10/2022' || data[i].saledate ==='8/11/2022' || data[i].saledate ==='8/12/2022' || data[i].saledate ==='8/13/2022' || data[i].saledate ==='8/14/2022' || data[i].saledate ==='8/15/2022' || data[i].saledate ==='8/16/2022' || data[i].saledate ==='8/17/2022' || data[i].saledate ==='8/18/2022' || data[i].saledate ==='8/19/2022' || data[i].saledate ==='8/20/2022' || data[i].saledate ==='8/21/2022' || data[i].saledate ==='8/22/2022' || data[i].saledate ==='8/23/2022' || data[i].saledate ==='8/24/2022' || data[i].saledate ==='8/25/2022' || data[i].saledate ==='8/26/2022' || data[i].saledate ==='8/27/2022'|| data[i].saledate ==='8/28/2022'|| data[i].saledate ==='8/29/2022' || data[i].saledate ==='8/30/2022' 
            || data[i].saledate === '5/1/2022' || data[i].saledate ==='5/2/2022' || data[i].saledate ==='5/3/2022' || data[i].saledate ==='5/4/2022' || data[i].saledate ==='5/5/2022' || data[i].saledate ==='5/6/2022' || data[i].saledate ==='5/7/2022' || data[i].saledate ==='5/8/2022' || data[i].saledate ==='5/9/2022' || data[i].saledate ==='5/10/2022' || data[i].saledate ==='5/11/2022' || data[i].saledate ==='5/12/2022' || data[i].saledate ==='5/13/2022' || data[i].saledate ==='5/14/2022' || data[i].saledate ==='5/15/2022'|| data[i].saledate ==='5/16/2022'|| data[i].saledate ==='5/17/2022' || data[i].saledate ==='5/18/2022' || data[i].saledate ==='5/19/2022' || data[i].saledate ==='5/20/2022' || data[i].saledate ==='5/21/2022' || data[i].saledate ==='5/22/2022' || data[i].saledate ==='5/23/2022' || data[i].saledate ==='5/24/2022' || data[i].saledate ==='5/25/2022' || data[i].saledate ==='5/26/2022'|| data[i].saledate ==='5/27/2022' || data[i].saledate ==='5/28/2022'
            || data[i].saledate === '5/29/2022' || data[i].saledate === '5/30/2022' || data[i].saledate ==='5/31/2022')){
   ...
   console.log(index21);
       ...
       for (let i = 0; i<data.length; i++){
         if (data[i].county === `${county4}` && data[i].townstate === `${town}` && data[i].listprice !=='AUCTION' && data[i].differenial !== "#VALUE!" ){
           ...
           data[i].saledate === '8/1/2021' || data[i].saledate === '8/2/2021' || data[i].saledate === '8/3/2021' || data[i].saledate === '8/4/2021' || data[i].saledate === '8/5/2021' || data[i].saledate === '8/6/2021' || data[i].saledate === '8/7/2021' || data[i].saledate === '8/8/2021' || data[i].saledate === '8/9/2021' || data[i].saledate === '8/10/2021' || data[i].saledate === '8/11/2021' || data[i].saledate === '8/12/2021' || data[i].saledate === '8/13/2021' || data[i].saledate === '8/14/2021' || data[i].saledate === '8/15/2021' || data[i].saledate === '8/16/2021' || data[i].saledate === '8/17/2021' || data[i].saledate === '8/18/2021' || data[i].saledate === '8/19/2021' || data[i].saledate === '8/20/2021' || data[i].saledate === '8/21/ || data[i].saledate === 021' || data[i].saledate === '8/22/2021' || data[i].saledate === '8/23/2021' || data[i].saledate === '8/24/2021' || data[i].saledate === '8/25/2021' || data[i].saledate === '8/26/2021' || data[i].saledate === '8/27/2021' || data[i].saledate === '8/28/2021' || data[i].saledate === '8/29/2021' || data[i].saledate === '8/30/2021' || 
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   var twenty = [
     ...
     '8/1/2020','8/2/2020','8/3/2020','8/4/2020','8/5/2020','8/6/2020','8/7/2020','8/8/2020','8/9/2020','8/10/2020','8/11/2020','8/12/2020','8/13/2020','8/14/2020','8/15/2020','8/16/2020','8/17/2020','8/18/2020','8/19/2020','8/20/2020','8/21/2020','8/22/2020','8/23/2020','8/24/2020','8/25/2020','8/26/2020','8/27/2020','8/28/2020','8/29/2020','8/30/2020',
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     async function marketflush21(e){ //this functions onClick...
      ...
      // React.useEffect(() => { //use the useEffect hook with useState to call that route and then update the UI
       // entireArrayIndex();
       // fetch('http://localhost:5000/prototypeJS')
       //  .then(response => response.json())
        // .then(data => {
         //  console.log(data) // all 15k objects...
          // let sales22 = [];
   ...
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={multifam} alt='math' />
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='/activesinglefamily#map'>MAP</a>
...
{close => (
   ...
   <br/>
     ...
     <br/>
     <br/>
     <Button className='button' style={{zIndex: '7', position: 'absolute', left: '860px', top: '885px' }}variant='dark' type="button" value='Submit' onClick={()=> {brucewayne22a(); brucewayne22b(); brucewayne21a(); brucewayne21b(); MissAmerica();}}>Apply Science</Button>
         <br/>
    ...
    <div className="modal" tabindex='0' >
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <Popup trigger={<a id='catchmaxmil' title={popquoteJan} href='#/catchmaxmil' className='awater' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1806px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0' >
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
  <Popup trigger={<a id ='s30' className='a1water' href='#/s30' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1075px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0' >
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
  <Popup trigger={<a id='r30' title={totallessdiff30} href='#/r30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1075px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0' >
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
   <Popup trigger={<a id ='s45' className='a1water' href='#/s45' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1150px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup trigger={<a id='r45' title={totallessdiff45} href='#/r45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1150px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup trigger={<a id ='s90' className='a1water' href='#/s90' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1225px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup trigger={<a id='r90' title={totallessdiff90} href='#/r90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1225px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup trigger={<a id ='s120' className='a1water' href='#/s120' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1300px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup trigger={<a id='r120' title={totallessdiff120} href='#/r120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1300px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup trigger={<a id ='s121' className='a1water' href='#/s121' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1375px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
  <Popup trigger={<a id='r121' title={totallessdiff121} href='#/r121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1375px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0' >
     <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0' >
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a> 
  <Popup trigger={<a id ='sales30' className='a1water' href='#/sales30' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1650px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0' >
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
   <Popup trigger={<a id='rates30' title={belowdiffrates30avg} href='#/rates30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1650px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>  
  <Popup trigger={<a id ='sales45' className='a1water' href='#/sales45' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1725px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0' >
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
  <Popup trigger={ <a id='rates45' title={belowdiffrates45avg} href='#/rates45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1725px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0' >
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>      
  <Popup trigger={<a id='sales90' className='awater' href='#/sales90' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1800px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0' >
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
   <Popup trigger={<a id='rates90' title={belowdiffrates90avg} href='#/rates90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1800px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
    <Popup trigger={<a id ='sales120' className='a1water' href='#/sales120' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1875px' }}></a>}
    position='center' modal nested>
  {close => (
     <div className="modal" tabindex='0' >
       <button className="close" onClick={close}>
       ...
       <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='rates120' title={belowdiffrates120avg} href='#/rates120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1875px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
  <Popup trigger={<a id ='sales121' className='a1water' href='#/sales121' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1950px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0' >
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>  
   <Popup trigger={<a id='rates121' title={belowdiffrates121avg} href='#/rates121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1950px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
   ...
   <div className="modal" tabindex='0' >
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
  <Popup trigger={<a id ='sales30flush' className='a1water' href='#/sales30flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3560px' }}></a> }
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0' >
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
        ...
        {close => (
         ...
         <a></a>
   <Popup trigger={<a id='sales45flush' className='a1water' href='#/sales45flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3610px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0' >
      <button className="close" onClick={close}>
