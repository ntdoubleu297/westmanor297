...
<div className='background64'>
  ...
  <select style={{zIndex: '7', position: 'absolute', left: '45px', top: '591px' }}
     ...
     <Button id='benjamin' className='button' style={{zIndex: '7', position: 'absolute', left: '948px', top: '595px'}} variant='dark' type="button" value='Submit' onClick={()=> {ActivePopulateQuote(); ActivePopulateQuoteBeds();}}>Apply Science</Button>
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData13}
                    ...
                    <Popup trigger={<a id ='onebed' href='#/onebed' className='awater' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '695px' }} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData14}
                 ...
                 <Popup trigger={<a id ='twobed' href='#/twobed' className='awater' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '784px' }}></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData15}
                 ...
                 <Popup trigger={ <a  id='threebed' href='#/threebed' className='awater' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '860px'}} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData16}
                 ...
                 <Popup trigger={<a id ='fourbed' href='#/fourbed' className='awater' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '935px'}} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData17}
                 ...
                 <Popup trigger={<a id ='fivebed' href='#/fivebed' className='awater' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '1010px'}} ></a>}
    position='center' modal nested>
{close => (
