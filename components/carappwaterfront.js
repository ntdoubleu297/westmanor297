...
<div className='innerelementback64'>
   ...
   <div className='hashh64w'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Buyer</div>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='/hactivewatercommercial#map'>MAP</a>
    ...
    <br/>
    <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/carapp'>Suburb</a>
