...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     async function sealteam2(e){ 
      ...
      let sevenfivek21 = [];
      for (let i = 0; i<data.length; i++){
        if (data[i].county === `${pricerangecounty1}`&& data[i].townstate === `${pricerangetown1}` && data[i].year === 2021 && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" ){
          sales21.push(data[i]);
          //console.log(sales);
...
const [onetwoonegreat121, setOnetwoonegreat121] = React.useState([]);
 ...
 const currentPageData24 = thirtygreat30
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  <div className='background'>
   ...
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={matheus} alt='math' />
     ...
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/activewatercommercial">Active</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '375px' }}href='/applysciencewaterfront'>Seller</a>
     <br/>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/applyscience'>Suburb</a>
...
{close => (
 ...
 {close => (
   ...
   <div id = 'statusx' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1500px' }}></div>
         ...
         <a></a>
         <div id='quarterly' className='awater' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1806px' }}></div>
         <a></a>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '310px', top: '1781px' }}>at/above rate</div>
         <div id='catchmaxmil' className='awater' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1806px' }}></div>
         <a></a>
        ...
        <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '75px', top: '1856px' }}>4/1/2021 - 6/30/2021:</div>
         <a></a>
         <div id='quarterly21' className='awater' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1856px' }}></div>
         <a></a>
         <div id='catchmaxmil21' className='awater' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1856px' }}></div>
         <a></a>
         ...
         <a></a>
         <div id='quarterly20' className='awater' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1906px' }}></div>
         <a></a>
         <div id='catchmaxmil20' className='awater' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1906px' }}></div>
         <a></a>
         ...
         <a></a>
         <div id='quarterly19' className='awater' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1956px' }}></div>
         <a></a>
         <div id='catchmaxmil19' className='awater' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1956px' }}></div>
         <a></a>
...
{close => (
   <div className="modal" tabindex='0'>
     ...
     <div id='DOM85populatequote' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '825px', top: '1515px'}}></div>
     <div id='DOM85abovepopulatequote' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '825px', top: '1530px'}}></div>
 ...
 {close => (
      ...
      {GLOBE1.states.map((value, key) => {
       ...
       <a id='mozart' className='hashh'  style={{zIndex: '7', position: 'absolute', left: '235px', top: '2025px' }} href='#ntdoubleu297'>Nav297</a>
        <a id='marketANThashh' className='hashh'  style={{zIndex: '7', position: 'absolute', left: '295px', top: '2025px' }} href='#townhash'>Town</a>
         ...
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2100px', width: '1100px', height: '300px', borderRadius: '0%', background: 'rgb(73, 73, 73)' }}></div>
   ...
   return (
     <option value={index}>
       ...
       <Button className='button' id='businessplanning11' style={{zIndex: '7', position: 'absolute', left: '510px', top: '2538px' }}variant='dark' type="button" value='Submit' onClick={()=> {businessplanning(); businessplanning21(); businessplanning20(); battingAvg5(); marketflush21();}}>Apply Science</Button>

       <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '75px', top: '2700px', width: '1181px', height: '1300px', borderRadius: '0%', background: 'rgb(73, 73, 73)' }}></div>
       ...
       <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2600px'}}>#APPLYSCIENCE - Seller Agency Residential - 
         ...
         <br/>
         <br/>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2750px', width: '530px', height: '300px', borderRadius: '31%', background: 'rgb(135, 135, 135)', border: '3.5px solid rgb(64, 64, 64)' }}></div>
         ...
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '2750px', width: '530px', height: '300px', borderRadius: '31%', background: 'rgb(135, 135, 135)', border: '3.5px solid rgb(64, 64, 64)' }}></div>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <br/>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '3095px', width: '530px', height: '300px', borderRadius: '31%', background: 'rgb(135, 135, 135)', border: '3.5px solid rgb(64, 64, 64)' }}></div>
         ...
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '3095px', width: '530px', height: '300px', borderRadius: '31%', background: 'rgb(135, 135, 135)', border: '3.5px solid rgb(64, 64, 64)' }}></div>
         <br/>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <br/>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '3440px', width: '530px', height: '300px', borderRadius: '31%', background: 'rgb(135, 135, 135)', border: '3.5px solid rgb(64, 64, 64)' }}></div>
         ...
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '3440px', width: '530px', height: '365px', borderRadius: '10%', background: 'rgb(135, 135, 135)', border: '3.5px solid rgb(64, 64, 64)' }}></div>
