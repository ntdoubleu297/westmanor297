 ...
 */
  ...
  console.log(index22);
       ...
       {name: 'Worcester', counties: [{name: 'MA', towns: ['Worcester, MA']}]},
...
map.loadImage(
  '/bankmapbox-32x32.png',
  (error, image) => {
  if (error) throw error;
  map.addImage('custom-marker', image);
  // Add a GeoJSON source with 2 points
  map.addSource('points', myGeoJSONData);
...
//////// popup on hover....
  ...
  background-color: rgb(175,175,175);'>
   ...
   max-height: 100px;' src=${marker.properties.photosMAIN}></img>
   <br/>
   <br/>
   <br/>
   <br/>
...
<div className='background'>
  ...
  <select style={{zIndex: '7', position: 'absolute', left: '45px', top: '591px' }}
      ...
      <input style={{zIndex: '7', position: 'absolute', left: '540px', top: '611px'}} type='number' onChange={(e)=> setPricevalue(e.target.value)}/> 
     <input style={{zIndex: '7', position: 'absolute', left: '740px', top: '611px'}}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
     <Button id='benjamin' className='button64' style={{zIndex: '7', position: 'absolute', left: '948px', top: '595px'}} variant='dark' type="button" value='Submit' onClick={()=> {ActivePopulateQuote(); ActivePopulateQuoteBeds();}}>Apply Science</Button>
   ...
   <Popup trigger={<a id ='threek' title={listratesPlanAavg} href='#/threek' className='awater64' style={{zIndex: '7', position: 'absolute', left: '185px', top: '720px' }}></a>}
 ...
 {close => (
   ...
   <Popup trigger={<a id ='fourk' title={listratesPlanBavg} href='#/fourk' className='awater64' style={{zIndex: '7', position: 'absolute', left: '185px', top: '796px' }}></a>}
   position='center' modal nested>
 {close => (
     ...
     <Popup trigger={<a id ='sevenk' title={listratesPlanCavg} className='awater64' href='#/sevenk' style={{zIndex: '7', position: 'absolute', left: '185px', top: '871px' }}></a>}
     position='center' modal nested>
   {close => (
   ...
   <Popup trigger={<a id ='sevenfivek' title={listratesPlanDavg} href='#/sevenfivek' className='awater64' style={{zIndex: '7', position: 'absolute', left: '185px', top: '946px'}} ></a>}
   position='center' modal nested>
 {close => (
      ...
      {GLOBE1.states.map((value, key) => {
       ...
       <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '663px', top: '642px' }}># Listings</div>
         <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '793px', top: '642px' }}>% Total Market</div>
                          ...
                          <a></a>                       
                           <Popup trigger={<a id='s14'  href='#/s14' title={belowdiffratesPlanAavg} className='a1water64' style={{zIndex: '7', position: 'absolute', left: '690px', top: '671px' }}></a>}
                           position='center' modal nested>
                         {close => (
                      ...
                      <a></a>
                          ...
                          <a></a>
   <Popup trigger={<a id='s30' title={belowdiffratesPlanBavg} href='#/s30' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '690px', top: '746px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData9}
                          ...
                          <a></a>
  <Popup trigger={<a id='s45' href='#/s45' title={belowdiffratesPlanCavg} className='a1water64' style={{zIndex: '7', position: 'absolute', left: '690px', top: '821px' }}></a>}
  position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData10}
                          ...
                          <a></a>
  <Popup trigger={<a id='s90' title={belowdiffratesPlanDavg} href='#/s90' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '690px', top: '896px' }}></a>}
  position='center' modal nested>
{close => (
         ...
         <ReactPaginate
           ...
           {currentPageData11}
                         ...
                         <a></a>
                          ...
                          <a></a>
   <Popup trigger={<a id='s120' href='#/s120' title={belowdiffratesPlanEavg} className='a1water64' style={{zIndex: '7', position: 'absolute', left: '690px', top: '971px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
           ...
           <a></a>
                          ...
                          <a></a>
   <Popup trigger={<a id='s121' title={belowdiffratesPlanFavg} href='#/s121' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '690px', top: '1046px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData13}
                    ...
                    <Popup trigger={<a id ='onebed' href='#/onebed' className='awater64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '695px' }} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData14}
                 ...
                 <Popup trigger={<a id ='twobed' href='#/twobed' className='awater64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '784px' }}></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData15}
                 ...
                 <Popup trigger={ <a  id='threebed' href='#/threebed' className='awater64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '860px'}} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData16}
                 ...
                 <Popup trigger={<a id ='fourbed' href='#/fourbed' className='awater64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '935px'}} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData17}
                 ...
                 <Popup trigger={<a id ='fivebed' href='#/fivebed' className='awater64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '1010px'}} ></a>}
    position='center' modal nested>
{close => (
         ...
         <ReactPaginate
           ...
           {currentPageData18}
                 ...
                 <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '1086px', top: '1026px' }}>______________</div>
                      ...
                      <img style={{height: '401px', width: '1350px', position: 'absolute', top: '2195px' }} src={ocean} alt='pixa'/>
  ...
  <div id='map' style={{left: '218px', top: '1185px', height: '79%', width: '71.3%', position: 'absolute' }} ref={mapContainer} />
  <div id="geocoder" style={{zIndex: '1', left: '600px', margin_left: '-25%', top: '1720px', position: 'absolute', width: '775px', height: '31px' }}></div>
  ...
  <a className='hashh64'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '532px' }} href='#geocoder'>Previous Market History</a>
   ...
   <br/>
   <br/>
   <Popup trigger={<a id ='inject' className='awater64' href='#/inject' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1894px' }}></a>}
   position='center' modal nested>
{close => (
   ...
   <div  className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '990px', top: '1984px' }}>Avg. List___________</div>
    <Popup trigger={<a id ='threebears'  title={titleavgdiff} className='awater64' href='#/threebears' style={{zIndex: '7', position: 'absolute', left: '820px', top: '2046px' }}></a>}
    position='center' modal nested>
 {close => (
  ...
  <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '2059px' }}>sale price rate_____________</div> 
   ...
   <br/>
   <br/>
   <Popup trigger={<a id='inject21' className='awater64' href='#/inject21' style={{zIndex: '7', position: 'absolute', left: '215px', top: '1894px' }}></a>}
   position='center' modal nested>
{close => (
  ...
  <Popup trigger={<a id ='threebears21' title={titleavgdiff2} href='#/threebears21' className='awater64' style={{zIndex: '7', position: 'absolute', left: '215px', top: '2046px' }}></a>}
    position='center' modal nested>
{close => (
