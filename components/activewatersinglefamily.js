 ...
 */
  ...
  console.log(index22);
        ...
        const GLOBE1 = {
         states: [
          {name: 'Orange', counties: [{name: 'CA', towns: ['Laguna Beach, CA']}]},
       ]
       };  
...
<div className='background'>
   ...
   <div className='hashh66'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Active</div>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/activesinglefamily'>Suburb</a>
