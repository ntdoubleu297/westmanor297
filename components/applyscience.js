...
<img style={{zIndex: '7', height: '375px', width: '715px'}} src={item.photos[2]}></img>
<img style={{zIndex: '7', height: '375px', width: '715px'}} src={item.photos[3]}></img>
<img style={{zIndex: '7', height: '375px', width: '715px'}} src={item.photos[4]}></img>
<img style={{zIndex: '7', height: '375px', width: '715px'}} src={item.photos[5]}></img>
   ...
   <td ref={(_subtitle) => (subtitle = _subtitle)}>County: {item.county}</td><br/>
   <td ref={(_subtitle) => (subtitle = _subtitle)}>Property Type: {item.propertytype}</td><br/>
   <td ref={(_subtitle) => (subtitle = _subtitle)}>Sale Date: {item.saledate}</td><br/>
  ...
  for (let i = 0; i<data.length; i++){
   ...
   || data[i].saledate === '5/29/2021' || data[i].saledate === '5/30/2021' || data[i].saledate ==='5/31/2021') ){
      ...
      if (data[i].saleprice > 749999){
        ...
        sevenfivek21.sort((a, b) => b.saleprice - a.saleprice);
...
const currentPageData25 = onetwoone12
       ...
       for (let i = 0; i<data.length; i++){
         if (data[i].county ===`${county3}` && data[i].townstate === `${town2}` && data[i].listprice !=='AUCTION' && data[i].differenial !== "#VALUE!" ){
          ...
          //
           ...
           averagesaleprice.forEach(add18);

           let differential19 = 0;
           function add19(item, counter, array){
            differential19+=(item.listprice);
           }
           averagelistprice.forEach(add19);
           ...
           let avgDOMpopulate = Math.round(differential17 / sales.length);
           let avgSalepopulate = formatter.format(Math.round(differential18 / averagesaleprice.length));
           let avgListpopulate = formatter.format(Math.round(differential19 / averagelistprice.length));
        ...
        // commercial render...
        setBelowdiffrates240avg(formatter.format(Math.round( differential15 / lengthgreat240 ))); // title
        setBelowdiffrates301avg(formatter.format(Math.round( differential16 / lengthgreat301 ))); // title
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   async function businessplanning(e){ 
     ...
     const req = await fetch('http://localhost:3000/singlefamily22')
       ...
       document.getElementById('date120').innerHTML = `${newArray[0][120]}` + ' - ' + `${newArray[0][179]}` + ' 121-180 days ';
         ...
         if (data[i].county === `${county2}` && data[i].townstate === `${town3}` && data[i].saleprice >= `${pricevalue3}` && data[i].saleprice < `${pricevalue4}` && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" && (data[i].saledate === newArray[0][0] || data[i].saledate === newArray[0][1] || data[i].saledate === newArray[0][2] || data[i].saledate === newArray[0][3] || data[i].saledate === newArray[0][4] || data[i].saledate === newArray[0][5] || data[i].saledate === newArray[0][6] || data[i].saledate === newArray[0][7] || data[i].saledate === newArray[0][8] || data[i].saledate === newArray[0][9] || data[i].saledate === newArray[0][10] || data[i].saledate === newArray[0][11] || data[i].saledate === newArray[0][12] || data[i].saledate === newArray[0][13] || data[i].saledate === newArray[0][14] || data[i].saledate === newArray[0][15] || data[i].saledate === newArray[0][16] || data[i].saledate === newArray[0][17] || data[i].saledate === newArray[0][18] || data[i].saledate === newArray[0][19] || data[i].saledate === newArray[0][20] || data[i].saledate === newArray[0][21] || data[i].saledate === newArray[0][22] || data[i].saledate === newArray[0][23] || data[i].saledate === newArray[0][24] || data[i].saledate === newArray[0][25] || data[i].saledate === newArray[0][26] || data[i].saledate === newArray[0][27] || data[i].saledate === newArray[0][28] || data[i].saledate === newArray[0][29] || data[i].saledate === newArray[0][30] || data[i].saledate === newArray[0][31] || data[i].saledate === newArray[0][32] || data[i].saledate === newArray[0][33] || data[i].saledate === newArray[0][34] || data[i].saledate === newArray[0][35] || data[i].saledate === newArray[0][36] || data[i].saledate === newArray[0][37] || data[i].saledate === newArray[0][38] || data[i].saledate === newArray[0][39] || data[i].saledate === newArray[0][40] || data[i].saledate === newArray[0][41] ||
           ...
           setPlanA22salelength(planAlength); 
            ...
            if (data[i].saleprice >= data[i].listprice && (data[i].saledate === newArray[0][30] || data[i].saledate === newArray[0][31] || data[i].saledate === newArray[0][32] || data[i].saledate === newArray[0][33] || data[i].saledate === newArray[0][34] || data[i].saledate === newArray[0][35] || data[i].saledate === newArray[0][36] || data[i].saledate === newArray[0][37] || data[i].saledate === newArray[0][38] || data[i].saledate === newArray[0][39] || data[i].saledate === newArray[0][40] || data[i].saledate === newArray[0][41] || data[i].saledate === newArray[0][42] ||data[i].saledate === newArray[0][43] || data[i].saledate === newArray[0][44] ||
             ...
             setPlanBatabovegreat(planBatabove);
           }
         ...
         if (data[i].county === `${county2}` && data[i].townstate === `${town3}` && data[i].saleprice >= `${pricevalue3}` && data[i].saleprice < `${pricevalue4}` && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" && (data[i].saledate === newArray[0][0] || data[i].saledate === newArray[0][1] || data[i].saledate === newArray[0][2] || data[i].saledate === newArray[0][3] || data[i].saledate === newArray[0][4] || data[i].saledate === newArray[0][5] || data[i].saledate === newArray[0][6] || data[i].saledate === newArray[0][7] || data[i].saledate === newArray[0][8] || data[i].saledate === newArray[0][9] || data[i].saledate === newArray[0][10] || data[i].saledate === newArray[0][11] || data[i].saledate === newArray[0][12] || data[i].saledate === newArray[0][13] || data[i].saledate === newArray[0][14] || data[i].saledate === newArray[0][15] || data[i].saledate === newArray[0][16] || data[i].saledate === newArray[0][17] || data[i].saledate === newArray[0][18] || data[i].saledate === newArray[0][19] || data[i].saledate === newArray[0][20] || data[i].saledate === newArray[0][21] || data[i].saledate === newArray[0][22] || data[i].saledate === newArray[0][23] || data[i].saledate === newArray[0][24] || data[i].saledate === newArray[0][25] || data[i].saledate === newArray[0][26] || data[i].saledate === newArray[0][27] || data[i].saledate === newArray[0][28] || data[i].saledate === newArray[0][29] || data[i].saledate === newArray[0][30] || data[i].saledate === newArray[0][31] || data[i].saledate === newArray[0][32] || data[i].saledate === newArray[0][33] || data[i].saledate === newArray[0][34] || data[i].saledate === newArray[0][35] || data[i].saledate === newArray[0][36] || data[i].saledate === newArray[0][37] || data[i].saledate === newArray[0][38] || data[i].saledate === newArray[0][39] || data[i].saledate === newArray[0][40] || data[i].saledate === newArray[0][41] ||
          ...
          ///////////////////////////////////////////////////
           ...
           function add(item, counter, array){
                  ...
                  setBelowdiffratesPlanA21avg(formatter.format(Math.round(differentialbelowA21 / planAatabovelength))); //title
                  setBelowdiffratesPlanB21avg(formatter.format(Math.round(differentialbelowB21 / planBatabovelength))); //title
                  setBelowdiffratesPlanC21avg(formatter.format(Math.round(differentialbelowC21 / planCatabovelength))); //title
                  setBelowdiffratesPlanD21avg(formatter.format(Math.round(differentialbelowD21 / planDatabovelength))); //title
                  setBelowdiffratesPlanE21avg(formatter.format(Math.round(differentialbelowE21 / planEatabovelength))); //title
         ...
         if (data[i].county === `${county2}` && data[i].townstate === `${town3}` && data[i].saleprice >= `${pricevalue3}` && data[i].saleprice < `${pricevalue4}` && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" && (data[i].saledate === newArray[0][0] || data[i].saledate === newArray[0][1] || data[i].saledate === newArray[0][2] || data[i].saledate === newArray[0][3] || data[i].saledate === newArray[0][4] || data[i].saledate === newArray[0][5] || data[i].saledate === newArray[0][6] || data[i].saledate === newArray[0][7] || data[i].saledate === newArray[0][8] || data[i].saledate === newArray[0][9] || data[i].saledate === newArray[0][10] || data[i].saledate === newArray[0][11] || data[i].saledate === newArray[0][12] || data[i].saledate === newArray[0][13] || data[i].saledate === newArray[0][14] || data[i].saledate === newArray[0][15] || data[i].saledate === newArray[0][16] || data[i].saledate === newArray[0][17] || data[i].saledate === newArray[0][18] || data[i].saledate === newArray[0][19] || data[i].saledate === newArray[0][20] || data[i].saledate === newArray[0][21] || data[i].saledate === newArray[0][22] || data[i].saledate === newArray[0][23] || data[i].saledate === newArray[0][24] || data[i].saledate === newArray[0][25] || data[i].saledate === newArray[0][26] || data[i].saledate === newArray[0][27] || data[i].saledate === newArray[0][28] || data[i].saledate === newArray[0][29] || data[i].saledate === newArray[0][30] || data[i].saledate === newArray[0][31] || data[i].saledate === newArray[0][32] || data[i].saledate === newArray[0][33] || data[i].saledate === newArray[0][34] || data[i].saledate === newArray[0][35] || data[i].saledate === newArray[0][36] || data[i].saledate === newArray[0][37] || data[i].saledate === newArray[0][38] || data[i].saledate === newArray[0][39] || data[i].saledate === newArray[0][40] || data[i].saledate === newArray[0][41] ||
          ...
          || data[i].saledate === newArray[0][234] || data[i].saledate === newArray[0][235] || data[i].saledate === newArray[0][236] || data[i].saledate === newArray[0][237] || data[i].saledate === newArray[0][238] || data[i].saledate === newArray[0][239])){
           ...
           function add(item, counter, array){
                  ...
                  setBelowdiffratesPlanA20avg(formatter.format(Math.round(differentialbelowA20 / planAatabovelength))); //title
                  setBelowdiffratesPlanB20avg(formatter.format(Math.round(differentialbelowB20 / planBatabovelength))); //title
                  setBelowdiffratesPlanC20avg(formatter.format(Math.round(differentialbelowC20 / planCatabovelength))); //title
                  setBelowdiffratesPlanD20avg(formatter.format(Math.round(differentialbelowD20 / planDatabovelength))); //title
                  setBelowdiffratesPlanE20avg(formatter.format(Math.round(differentialbelowE20 / planEatabovelength))); //title
...
<div className='innerelementback'>
   ...
   <div className='hashh66'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Seller</div>
    ...
    <br/>
    <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/applysciencewaterfront'>WaterFront</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '325px' }}href="#DKre">Female</a>
...
{close => (
  ...
  <Popup trigger={<a id ='threebears' title={titleavgdiff} href='#/threebears' className='awater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '755px' }}></a>}
  position='center' modal nested>
{close => (
 ...
 {close => (
   ...
   <br/>
       ...
       <Button className='button' style={{zIndex: '7', position: 'absolute', left: '860px', top: '885px' }}variant='dark' type="button" value='Submit' onClick={()=> {brucewayne22a(); brucewayne22b(); brucewayne21a(); brucewayne21b();}}>Apply Science</Button>
     <br/>
     <br/>
     <br/>
  ...
  <Popup trigger={<a id ='threek21' className='awater' href='#/threek21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1060px' }}></a>}
  position='center' modal nested>
{close => (
  ...
  <Popup trigger={<a id ='threek' className='awater' href='#/threek' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1060px' }}></a>}
  position='center' modal nested>
{close => (
  ...
  <Popup trigger={<a id ='fourk21' className='awater' href='#/fourk21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1135px' }}></a>}
  position='center' modal nested>
{close => (
  ...
  <Popup trigger={<a id ='fourk' className='awater' href='#/fourk' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1135px' }}></a>}
  position='center' modal nested>
{close => (
   ...
   <Popup trigger={<a id ='sevenk21' className='awater' href='#/sevenk21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1210px' }}></a>}
   position='center' modal nested>
 {close => (
...
<div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '205px', top: '1225px' }}>______________</div>
  <Popup trigger={<a id ='sevenk' className='awater' href='#/sevenk' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1210px' }}></a>}
  position='center' modal nested>
{close => (
  ...
  <Popup trigger={<a id ='sevenfivek21' className='awater' href='#/sevenfivek21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1285px' }}></a>}
  position='center' modal nested>
{close => (
   ...
   <Popup trigger={<a id ='sevenfivek' className='awater' href='#/sevenfivek' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1285px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <select style={{zIndex: '7', position: 'absolute', left: '75px', top: '1335px' }}
          ...
          >
      <option id='value' style={{zIndex: '7', position: 'absolute', left: '75px', top: '1325px' }}>---Choose County--</option>
      {GLOBE1.states.map((value, key) => {
        return(
          ...
          >
            <option style={{zIndex: '7', position: 'absolute', left: '75px', top: '1430px' }}>--Choose State--</option>
   ...
   <br/>
         ...
         <a></a>
         <Popup trigger={<a id='quarterly' className='awater' href='#/quarterly' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1806px' }} ></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <Popup trigger={<a id='catchmaxmil' className='awater' title={popquoteJan} href='#/catchmaxmil' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1806px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        ...
        <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '75px', top: '1856px' }}>4/1/2021 - 6/30/2021:</div>
         <a></a>
         <Popup trigger={<a id='quarterly21' className='awater' href='#/quarterly21' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1856px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <Popup trigger={<a id='catchmaxmil21' className='awater' title={popquoteApril} href='#/catchmaxmil21' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1856px' }} ></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <Popup trigger={<a id='quarterly20' className='awater' href='#/quarterly20' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1906px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <Popup trigger={<a id='catchmaxmil20' className='awater' title={popquoteJuly} href='#/catchmaxmil20' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1906px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <Popup trigger={<a id='quarterly19' className='awater' href='#/quarterly19' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1956px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <Popup trigger={<a id='catchmaxmil19' className='awater' title={popquoteOctober} href='#/catchmaxmil19' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1956px' }} ></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
     ...
     <h5 className='awater' style={{zIndex: '7', position: 'absolute', left: '731px', top: '915px'}}>Previous 5 Month Market Condition Sales 2022</h5>
         ...
         <a></a>
    <Popup trigger={<a id ='s14' className='a1water' href='#/s14' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1000px' }} ></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup trigger={<a id='r14' title={totallessdiff14} href='#/r14' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1000px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <br/>
         <br/>
   <Popup trigger={<a id ='s30' className='a1water' href='#/s30' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1050px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id='r30' title={totallessdiff30} href='#/r30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1050px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup trigger={<a id='s45' className='a1water' href='#/s45' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1100px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a> 
  <Popup trigger={<a id='r45' title={totallessdiff45} href='#/r45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1100px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
  <Popup trigger={<a id ='s90' className='a1water' href='#/s90' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1150px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id='r90' title={totallessdiff90} href='#/r90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1150px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup trigger={<a id ='s120' className='a1water' href='#/s120' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1200px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <Popup trigger={<a id='r120' title={totallessdiff120} href='#/r120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1200px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id ='s121' className='a1water' href='#/s121' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1250px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='r121' title={totallessdiff121} href='#/r121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1250px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id ='s240' className='a1water' href='#/s240' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1300px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup trigger={<a id='r240' title={totallessdiff240} href='#/r240' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1300px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id ='s301' className='a1water' href='#/s301' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1350px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='r301' title={totallessdiff301} href='#/r301' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1350px' }}></a>}
   position='center' modal nested>
 {close => (
     ...
     <div style={{zIndex: '7', position: 'absolute', left: '100px', top: '1400px' }}>----------------------------------------------</div>
      ...
      {GLOBE1.states.map((value, key) => {
       ...
       <br/>
       <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1045px', top: '1442.5px', width: '76px', height: '30.5px', borderRadius: '31%', background: 'rgb(135, 135, 135)', border: '3.5px solid rgb(64, 64, 64)' }}></div>
       <div id='avgDOMpopulate' className='a12water' title={avgsalesavg} style={{zIndex: '7', position: 'absolute', left: '1060px', top: '1450.5px' }}></div>
       <br/>
       <br/>
  ...
  <Popup trigger={<a id ='sales14' className='a1water' href='#/sales14' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1575px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
  <Popup trigger={<a id='rates14' title={belowdiffrates14avg} href='#/rates14' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1575px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
  <Popup trigger={<a id ='sales30' className='a1water' href='#/sales30' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1625px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
  <Popup trigger={<a id='rates30' title={belowdiffrates30avg} href='#/rates30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1625px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
  <Popup trigger={ <a id ='sales45' className='a1water' href='#/sales45' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1675px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='rates45' title={belowdiffrates45avg} href='#/rates45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1675px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id ='sales90' className='a1water' href='#/sales90' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1725px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id='rates90' title={belowdiffrates90avg} href='#/rates90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1725px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
    <Popup trigger={<a id ='sales120' className='a1water' href='#/sales120' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1775px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
    <Popup trigger={<a id='rates120' title={belowdiffrates120avg} href='#/rates120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1775px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup trigger={<a id ='sales121' className='a1water' href='#/sales121' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1825px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id='rates121' title={belowdiffrates121avg} href='#/rates121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1825px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
  <Popup trigger={<a id ='sales240' className='a1water' href='#/sales240' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1875px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='rates240' title={belowdiffrates240avg} className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1875px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id ='sales301' className='a1water' href='#/sales301' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1925px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
    <Popup trigger={<a id='rates301' title={belowdiffrates301avg} className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1925px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <select style={{zIndex: '7', position: 'absolute', left: '100px', top: '1985px' }}
          ...
          >
      <option id='value' style={{zIndex: '7', position: 'absolute', left: '100px', top: '1985px' }}>---Choose County--</option>
      {GLOBE1.states.map((value, key) => {
        return(
          ...
          >
            <option style={{zIndex: '7', position: 'absolute', left: '100px', top: '2045px' }}>--Choose State--</option>
     ...
     <option value={index}>
      ...
      <img style={{height: '1200px', width: '1180px', position: 'absolute', left: '75px', top: '2700px' }} src={capewater} alt='northcarolina'/>
       <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2600px'}}>#APPLYSCIENCE - Seller Agency Residential - 
         ...
         <a></a>
    <Popup trigger={<a id ='planAsales' className='a1water' href='#/planAsales' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2830px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup trigger={<a id='planArate' title={belowdiffratesPlanAavg} href='#/planArate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2830px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id ='planAsales21' className='a1water' href='#/planAsales21' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2880px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='planArate21' title={belowdiffratesPlanA21avg} href='#/planArate21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2880px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
  <Popup trigger={<a id ='planAsales20' className='a1water' href='#/planAsales20' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2930px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id='planArate20' title={belowdiffratesPlanA20avg} href='#/planArate20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2930px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup trigger={<a id ='planBsales' className='a1water' href='#/planBsales' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2830px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='planBrate' title={belowdiffratesPlanBavg} href='#/planBrate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2830px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id ='planBsales21' className='a1water' href='#/planBsales21' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2880px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup trigger={<a id='planBrate21' title={belowdiffratesPlanB21avg} href='#/planBrate21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2880px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id ='planBsales20' className='a1water' href='#/planBsales20' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2930px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup trigger={<a  id='planBrate20' title={belowdiffratesPlanB20avg} href='#/planBrate20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2930px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='planCsales' className='a1water' href='#/planCsales' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3175px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='planCrate' title={belowdiffratesPlanCavg} href='#/planCrate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3175px' }} ></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id ='planCsales21' className='a1water' href='#/planCsales21' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3225px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
  <Popup trigger={<a id='planCrate21' title={belowdiffratesPlanC21avg} href='#/planCrate21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3225px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id ='planCsales20' className='a1water' href='#/planCsales20' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3275px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='planCrate20' title={belowdiffratesPlanC20avg} href='#/planCrate20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3275px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id ='planDsales' className='a1water' href='#/planDsales' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3175px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div ></div>
   <Popup trigger={<a id='planDrate' title={belowdiffratesPlanDavg} href='#/planDrate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3175px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id ='planDsales21' className='a1water' href='#/planDsales21' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3225px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id='planDrate21' title={belowdiffratesPlanD21avg} href='#/planDrate21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3225px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup trigger={<a id ='planDsales20' className='a1water' href='#/planDsales20' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3275px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
  <Popup trigger={<a id='planDrate20' title={belowdiffratesPlanD20avg} href='#/planDrate20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3275px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
  <Popup trigger={<a id ='planEsales' className='a1water' href='#/planEsales' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3515px' }}></a>}
  position='center' modal nested>
{close => (
   ...
   <Popup trigger={<a id='planErate' title={belowdiffratesPlanEavg} href='#/planErate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3515px' }} ></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id ='planEsales21' className='a1water' href='#/planEsales21' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3565px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
  <Popup trigger={<a id='planErate21' title={belowdiffratesPlanE21avg} href='#/planErate21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3565px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
  <Popup trigger={<a id ='planEsales20' className='a1water' href='#/planEsales20'  style={{zIndex: '7', position: 'absolute', left: '225px', top: '3615px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='planErate20' title={belowdiffratesPlanE20avg} href='#/planErate20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3615px' }}></a>}
   position='center' modal nested>
 {close => (
     ...
     <br/>
         ...
         <a></a>
  <Popup trigger={<a id ='sales14flush' className='a1water' href='#/sales14flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3510px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
  <Popup trigger={<a id='rates14flush' title={belowdiffratesMF14avg} href='#/rates14flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3510px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id ='sales30flush' className='a1water' href='#/sales90flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3560px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id='rates30flush' title={belowdiffratesMF30avg} href='#/rates30flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3560px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
    <Popup trigger={<a id ='sales45flush' className='fontwater' href='#/sales45flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3610px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
    <Popup trigger={<a id='rates45flush' title={belowdiffratesMF45avg} href='#/rates45flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3610px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup trigger={<a id ='sales90flush' className='a1water' href='#/sales90flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3660px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup trigger={<a id='rates90flush' title={belowdiffratesMF90avg} href='#/rates90flush'  className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3660px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup trigger={<a id ='sales120flush' className='a1water' href='#/sales120flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3710px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='rates120flush' title={belowdiffratesMF120avg} href='#/rates120flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3710px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id ='sales121flush' className='a1water' href='#/sales121flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3760px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup trigger={<a id='rates121flush' title={belowdiffratesMF121avg} href='#/rates121flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3760px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <br/>
         <img style={{height: '400px', width: '1500px', position: 'absolute', top: '4100px' }} src={vegas} alt='pixa'/>
