...
function firstdateIndex(e){
 ...
 .map((item, index) => (
   ...
   <img style={{zIndex: '7', height: '500px', width: '700px'}} src={item.photos[5]}></img>
    ...
    <td ref={(_subtitle) => (subtitle = _subtitle)}>Price Differential: {item.bedrooms}</td><br/>
    ...
    <td className='inborder' ref={(_subtitle) => (subtitle = _subtitle)}>Price Differential: {item.bedrooms}</td>
