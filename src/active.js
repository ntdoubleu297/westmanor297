...
<div className='background64'>
   ...
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={multifam} alt='math' />
     ...
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/multifamily">Seller</a>
   ...
   position='center' modal nested>
     ...
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/activewatermulti'>WaterFront</a>
     ...
     <div id='imme' className='activetitle' style={{zIndex: '7', position: 'absolute', left: '395px', top: '511px' }}>Active Multi-Family</div>
