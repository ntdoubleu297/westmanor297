...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-51px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
...
const [averageSP54, setAverageSP54] = React.useState(0);
      ...
      // React.useEffect(() => { //use the useEffect hook with useState to call that route and then update the UI
       ...
       return (show) ? ( 
         ...
         <div id='DKre' className='background64ctg'>
                <a className='fontnav64ctg' style={{zIndex: '7', position: 'absolute', left: '75px', top: '45px' }}href='/' {...buttonDHoverProps}>{buttonDIsHovering ? 'Click here to applyscience' : 'Single Family'}</a>
   ...
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={multifam} alt='math' />
     ...
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/singlefamilybuyer">Suburb</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '375px' }}href='/singlefamily'>Seller</a>
   ...
   position='center' modal nested>
     ...
     <br/>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/alldatasinglefamilybuyer'>WaterFront</a>
     ...
     <div style={{zIndex: '7', position: 'absolute', left: '100px', top: '1400px' }}>----------------------------------------------</div>
      ...
      {GLOBE1.states.map((value, key) => {
        return(
          ...
          >
            <option style={{zIndex: '7', position: 'absolute', left: '900px', top: '1470px' }}>--Choose County
            --</option>
