...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   <div className='innerelementbackctg'>
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={multifam} alt='math' />
     ...
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/activesinglefamilyctg">Active</a>
     ...
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '325px' }}href="/singlefamilybuyer">Suburb</a>
     <div>
          <ul>
     ...
     <div className='waterbackgroundctg'></div>
...
{close => (
   ...
   <br/>
     ...
     <br/>
     <Button className='buttonctg' style={{zIndex: '7', position: 'absolute', left: '860px', top: '885px' }}variant='dark' type="button" value='Submit' onClick={()=> {brucewayne22a(); brucewayne22b(); brucewayne21a(); brucewayne21b();}}>Apply Science</Button>
         <br/>
