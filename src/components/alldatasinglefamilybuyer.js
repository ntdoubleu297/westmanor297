...
<a className='fontnav' style={{zIndex: '7', position: 'absolute', left: '75px', top: '45px' }}href='/' {...buttonDHoverProps}>{buttonDIsHovering ? 'Click here to applyscience' : 'Single Family'}</a>
  ...
  <a className='fontnav' style={{zIndex: '7', position: 'absolute', left: '1050px', top: '45px' }}href='/activecommercial' {...buttonCHoverProps}>{buttonCIsHovering ? 'Click here to applyscience' : 'Commercial'}</a>
   ...
   <div className='hashh65'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Buyer</div>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='/activewatersinglefamily#map'>MAP</a>
   ...
   position='center' modal nested>
     ...
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '325px' }}href="/activesinglefamilyctg">Female ACT</a>
     <div>
          <ul>
