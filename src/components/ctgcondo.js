...
import {render} from 'react-dom';
 ...
 import chicagowheel from './chicagowheel.jpg';
...
//import mfsan from './mfsan.jpg';
import mfsan from './sanfrancom.jpg';
...
//useEffect(() => {
  ...
  {name: 'CT', counties: [{name: 'Hartford', towns: ['West Hartford, CT']}]}
]
  };  
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-201px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-261px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-80px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-155px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
...
<br/>
     ...
     async function sealteam3(e){ 
      ...
      for (let i = 0; i<data.length; i++){
        ...
        || data[i].saledate === '5/29/2022' || data[i].saledate === '5/30/2022' || data[i].saledate ==='5/31/2022')){
          ...
          let sortTotalsales = sales85.sort(function(a,b){
            return a.DOM - b.DOM;
          })
  ...
  let TotalSalesamount = sales85.length;
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-201px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-265px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
...
<br/>
 ...
 const [averageSP, setAverageSP ] = React.useState();
 const [averageSP2, setAverageSP2 ] = React.useState(0);
 const [averageSP3, setAverageSP3 ] = React.useState(0);
 const [averageSP4, setAverageSP4 ] = React.useState(0);
 const [averageSP5, setAverageSP5 ] = React.useState(0);
 const [averageSP6, setAverageSP6 ] = React.useState(0);
                   ...
                   for (let i = 0; i<data.length; i++){
                    ...
                    || data[i].saledate === '5/29/2022' || data[i].saledate === '5/30/2022' || data[i].saledate ==='5/31/2022')){
                      sales.push(data[i]);
                       ...
                       setAverageSP(formatter.format(Math.round(differential23 / sale14)));
                       ...
                       setAverageSP2(formatter.format(Math.round(differential24 / sale30)));
                       ...
                       setAverageSP3(formatter.format(Math.round(differential25 / sale45)));
                       ...
                       setAverageSP4(formatter.format(Math.round(differential26 / sale90)));
                       ...
                       setAverageSP5(formatter.format(Math.round(differential27 / sale120)));
                       ...
                       setAverageSP6(formatter.format(Math.round(differential28 / sale121)));
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-205px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-265px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-181px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-241px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-191px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-251px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
...
const [averageSP16, setAverageSP16] = React.useState(0);
const [averageSP17, setAverageSP17] = React.useState(0);
const [averageSP18, setAverageSP18] = React.useState(0);
const [averageSP19, setAverageSP19] = React.useState(0);
const [averageSP20, setAverageSP20] = React.useState(0);
const [averageSP21, setAverageSP21] = React.useState(0);
   ...
   async function populateQuote(e){ //this functions onClick...
     ...
     //if (data.status ==='ok'){
       ...
       for (let i = 0; i<data.length; i++){
        if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" && (data[i].saledate ==='1/1/2022' || data[i].saledate ==='1/2/2022' || data[i].saledate ==='1/3/2022' || data[i].saledate ==='1/4/2022' || data[i].saledate ==='1/5/2022' || data[i].saledate ==='1/6/2022' || data[i].saledate ==='1/7/2022' || data[i].saledate ==='1/8/2022' || data[i].saledate ==='1/9/2022' || data[i].saledate ==='1/10/2022' || data[i].saledate ==='1/11/2022' || data[i].saledate ==='1/12/2022' || data[i].saledate ==='1/13/2022' || data[i].saledate ==='1/14/2022' || data[i].saledate ==='1/15/2022' || data[i].saledate ==='1/16/2022' || data[i].saledate ==='1/17/2022' || data[i].saledate ==='1/18/2022' || data[i].saledate ==='1/19/2022' || data[i].saledate ==='1/20/2022' || data[i].saledate ==='1/21/2022' || data[i].saledate ==='1/22/2022' || data[i].saledate ==='1/23/2022' || data[i].saledate ==='1/24/2022' || data[i].saledate ==='1/25/2022' || data[i].saledate ==='1/26/2022' || data[i].saledate ==='1/27/2022'|| data[i].saledate ==='1/28/2022'|| data[i].saledate ==='1/29/2022' || data[i].saledate ==='1/30/2022' || data[i].saledate ==='1/31/2022'
        || data[i].saledate === '2/1/2022' || data[i].saledate ==='2/2/2022' || data[i].saledate ==='2/3/2022' || data[i].saledate ==='2/4/2022' || data[i].saledate ==='2/5/2022' || data[i].saledate ==='2/6/2022' || data[i].saledate ==='2/7/2022' || data[i].saledate ==='2/8/2022' || data[i].saledate ==='2/9/2022' || data[i].saledate ==='2/10/2022' || data[i].saledate ==='2/11/2022' || data[i].saledate ==='2/12/2022' || data[i].saledate ==='2/13/2022' || data[i].saledate ==='2/14/2022' || data[i].saledate ==='2/15/2022'|| data[i].saledate ==='2/16/2022'|| data[i].saledate ==='2/17/2022' || data[i].saledate ==='2/18/2022' || data[i].saledate ==='2/19/2022' || data[i].saledate ==='2/20/2022' || data[i].saledate ==='2/21/2022' || data[i].saledate ==='2/22/2022' || data[i].saledate ==='2/23/2022' || data[i].saledate ==='2/24/2022' || data[i].saledate ==='2/25/2022' || data[i].saledate ==='2/26/2022'|| data[i].saledate ==='2/27/2022' || data[i].saledate ==='2/28/2022'
        || data[i].saledate === '3/1/2022' || data[i].saledate ==='3/2/2022'|| data[i].saledate ==='3/3/2022' || data[i].saledate ==='3/4/2022' || data[i].saledate ==='3/5/2022' || data[i].saledate ==='3/6/2022' || data[i].saledate ==='3/7/2022' || data[i].saledate ==='3/8/2022' || data[i].saledate ==='3/9/2022'|| data[i].saledate ==='3/10/2022'|| data[i].saledate ==='3/11/2022' || data[i].saledate ==='3/12/2022'|| data[i].saledate === '3/13/2022'|| data[i].saledate ==='3/14/2022' || data[i].saledate ==='3/15/2022' || data[i].saledate ==='3/16/2022' || data[i].saledate ==='3/17/2022' || data[i].saledate ==='3/18/2022' || data[i].saledate ==='3/19/2022' || data[i].saledate ==='3/20/2022' || data[i].saledate ==='3/21/2022'|| data[i].saledate ==='3/22/2022' || data[i].saledate ==='3/23/2022' || data[i].saledate ==='3/24/2022' || data[i].saledate ==='3/25/2022' || data[i].saledate ==='3/26/2022' || data[i].saledate ==='3/27/2022'|| data[i].saledate ==='3/28/2022' || data[i].saledate ==='3/29/2022' || data[i].saledate ==='3/30/2022' || data[i].saledate ==='3/31/2022' || data[i].saledate ==='4/1/2022'|| data[i].saledate ==='4/2/2022' || data[i].saledate ==='4/3/2022' || data[i].saledate ==='4/4/2022' || data[i].saledate ==='4/5/2022' || data[i].saledate ==='4/6/2022' || data[i].saledate ==='4/7/2022' || data[i].saledate ==='4/8/2022' || data[i].saledate ==='4/9/2022' || data[i].saledate ==='4/10/2022' || data[i].saledate ==='4/11/2022' || data[i].saledate ==='4/12/2022' || data[i].saledate ==='4/13/2022' || data[i].saledate ==='4/14/2022' || data[i].saledate ==='4/15/2022' || data[i].saledate ==='4/16/2022' || data[i].saledate ==='4/17/2022' || data[i].saledate ==='4/18/2022' || data[i].saledate ==='4/19/2022' || data[i].saledate ==='4/20/2022' || data[i].saledate ==='4/21/2022' || data[i].saledate ==='4/22/2022' || data[i].saledate ==='4/23/2022' || data[i].saledate ==='4/24/2022' || data[i].saledate ==='4/25/2022' || data[i].saledate ==='4/26/2022' || data[i].saledate ==='4/27/2022'|| data[i].saledate ==='4/28/2022'|| data[i].saledate ==='4/29/2022' || data[i].saledate ==='4/30/2022' 
        || data[i].saledate === '5/1/2022' || data[i].saledate ==='5/2/2022' || data[i].saledate ==='5/3/2022' || data[i].saledate ==='5/4/2022' || data[i].saledate ==='5/5/2022' || data[i].saledate ==='5/6/2022' || data[i].saledate ==='5/7/2022' || data[i].saledate ==='5/8/2022' || data[i].saledate ==='5/9/2022' || data[i].saledate ==='5/10/2022' || data[i].saledate ==='5/11/2022' || data[i].saledate ==='5/12/2022' || data[i].saledate ==='5/13/2022' || data[i].saledate ==='5/14/2022' || data[i].saledate ==='5/15/2022'|| data[i].saledate ==='5/16/2022'|| data[i].saledate ==='5/17/2022' || data[i].saledate ==='5/18/2022' || data[i].saledate ==='5/19/2022' || data[i].saledate ==='5/20/2022' || data[i].saledate ==='5/21/2022' || data[i].saledate ==='5/22/2022' || data[i].saledate ==='5/23/2022' || data[i].saledate ==='5/24/2022' || data[i].saledate ==='5/25/2022' || data[i].saledate ==='5/26/2022'|| data[i].saledate ==='5/27/2022' || data[i].saledate ==='5/28/2022'
        || data[i].saledate === '5/29/2022' || data[i].saledate === '5/30/2022' || data[i].saledate ==='5/31/2022')){
       ...
       setAverageSP16(formatter.format(Math.round( differential16 / sale14 ) || 0));
       setAverageSP17(formatter.format(Math.round( differential17 / sale30 ) || 0));
       setAverageSP18(formatter.format(Math.round( differential18 / sale45 ) || 0));
       setAverageSP19(formatter.format(Math.round( differential19 / sale90 ) || 0));
       setAverageSP20(formatter.format(Math.round( differential20 / sale120 ) || 0));
       setAverageSP21(formatter.format(Math.round( differential21 / sale121 ) || 0));
           ...
           <div>
           <Popup lockScroll={true} trigger={<a id='sales45' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1725px' }}></a>}
              position='center'>
               <div></div>
              </Popup>
              </div>
    ...
    console.log(index21); 
        ...
        for (let i = 0; i<data.length; i++){
          if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}` && (data[i].saledate ==='1/1/2022' || data[i].saledate ==='1/2/2022' || data[i].saledate ==='1/3/2022' || data[i].saledate ==='1/4/2022' || data[i].saledate ==='1/5/2022' || data[i].saledate ==='1/6/2022' || data[i].saledate ==='1/7/2022' || data[i].saledate ==='1/8/2022' || data[i].saledate ==='1/9/2022' || data[i].saledate ==='1/10/2022' || data[i].saledate ==='1/11/2022' || data[i].saledate ==='1/12/2022' || data[i].saledate ==='1/13/2022' || data[i].saledate ==='1/14/2022' || data[i].saledate ==='1/15/2022' || data[i].saledate ==='1/16/2022' || data[i].saledate ==='1/17/2022' || data[i].saledate ==='1/18/2022' || data[i].saledate ==='1/19/2022' || data[i].saledate ==='1/20/2022' || data[i].saledate ==='1/21/2022' || data[i].saledate ==='1/22/2022' || data[i].saledate ==='1/23/2022' || data[i].saledate ==='1/24/2022' || data[i].saledate ==='1/25/2022' || data[i].saledate ==='1/26/2022' || data[i].saledate ==='1/27/2022'|| data[i].saledate ==='1/28/2022'|| data[i].saledate ==='1/29/2022' || data[i].saledate ==='1/30/2022' || data[i].saledate ==='1/31/2022'
          || data[i].saledate === '2/1/2022' || data[i].saledate ==='2/2/2022' || data[i].saledate ==='2/3/2022' || data[i].saledate ==='2/4/2022' || data[i].saledate ==='2/5/2022' || data[i].saledate ==='2/6/2022' || data[i].saledate ==='2/7/2022' || data[i].saledate ==='2/8/2022' || data[i].saledate ==='2/9/2022' || data[i].saledate ==='2/10/2022' || data[i].saledate ==='2/11/2022' || data[i].saledate ==='2/12/2022' || data[i].saledate ==='2/13/2022' || data[i].saledate ==='2/14/2022' || data[i].saledate ==='2/15/2022'|| data[i].saledate ==='2/16/2022'|| data[i].saledate ==='2/17/2022' || data[i].saledate ==='2/18/2022' || data[i].saledate ==='2/19/2022' || data[i].saledate ==='2/20/2022' || data[i].saledate ==='2/21/2022' || data[i].saledate ==='2/22/2022' || data[i].saledate ==='2/23/2022' || data[i].saledate ==='2/24/2022' || data[i].saledate ==='2/25/2022' || data[i].saledate ==='2/26/2022'|| data[i].saledate ==='2/27/2022' || data[i].saledate ==='2/28/2022'
          || data[i].saledate === '3/1/2022' || data[i].saledate ==='3/2/2022'|| data[i].saledate ==='3/3/2022' || data[i].saledate ==='3/4/2022' || data[i].saledate ==='3/5/2022' || data[i].saledate ==='3/6/2022' || data[i].saledate ==='3/7/2022' || data[i].saledate ==='3/8/2022' || data[i].saledate ==='3/9/2022'|| data[i].saledate ==='3/10/2022'|| data[i].saledate ==='3/11/2022' || data[i].saledate ==='3/12/2022'|| data[i].saledate === '3/13/2022'|| data[i].saledate ==='3/14/2022' || data[i].saledate ==='3/15/2022' || data[i].saledate ==='3/16/2022' || data[i].saledate ==='3/17/2022' || data[i].saledate ==='3/18/2022' || data[i].saledate ==='3/19/2022' || data[i].saledate ==='3/20/2022' || data[i].saledate ==='3/21/2022'|| data[i].saledate ==='3/22/2022' || data[i].saledate ==='3/23/2022' || data[i].saledate ==='3/24/2022' || data[i].saledate ==='3/25/2022' || data[i].saledate ==='3/26/2022' || data[i].saledate ==='3/27/2022'|| data[i].saledate ==='3/28/2022' || data[i].saledate ==='3/29/2022' || data[i].saledate ==='3/30/2022' || data[i].saledate ==='3/31/2022' || data[i].saledate ==='4/1/2022'|| data[i].saledate ==='4/2/2022' || data[i].saledate ==='4/3/2022' || data[i].saledate ==='4/4/2022' || data[i].saledate ==='4/5/2022' || data[i].saledate ==='4/6/2022' || data[i].saledate ==='4/7/2022' || data[i].saledate ==='4/8/2022' || data[i].saledate ==='4/9/2022' || data[i].saledate ==='4/10/2022' || data[i].saledate ==='4/11/2022' || data[i].saledate ==='4/12/2022' || data[i].saledate ==='4/13/2022' || data[i].saledate ==='4/14/2022' || data[i].saledate ==='4/15/2022' || data[i].saledate ==='4/16/2022' || data[i].saledate ==='4/17/2022' || data[i].saledate ==='4/18/2022' || data[i].saledate ==='4/19/2022' || data[i].saledate ==='4/20/2022' || data[i].saledate ==='4/21/2022' || data[i].saledate ==='4/22/2022' || data[i].saledate ==='4/23/2022' || data[i].saledate ==='4/24/2022' || data[i].saledate ==='4/25/2022' || data[i].saledate ==='4/26/2022' || data[i].saledate ==='4/27/2022'|| data[i].saledate ==='4/28/2022'|| data[i].saledate ==='4/29/2022' || data[i].saledate ==='4/30/2022' 
          || data[i].saledate === '5/1/2022' || data[i].saledate ==='5/2/2022' || data[i].saledate ==='5/3/2022' || data[i].saledate ==='5/4/2022' || data[i].saledate ==='5/5/2022' || data[i].saledate ==='5/6/2022' || data[i].saledate ==='5/7/2022' || data[i].saledate ==='5/8/2022' || data[i].saledate ==='5/9/2022' || data[i].saledate ==='5/10/2022' || data[i].saledate ==='5/11/2022' || data[i].saledate ==='5/12/2022' || data[i].saledate ==='5/13/2022' || data[i].saledate ==='5/14/2022' || data[i].saledate ==='5/15/2022'|| data[i].saledate ==='5/16/2022'|| data[i].saledate ==='5/17/2022' || data[i].saledate ==='5/18/2022' || data[i].saledate ==='5/19/2022' || data[i].saledate ==='5/20/2022' || data[i].saledate ==='5/21/2022' || data[i].saledate ==='5/22/2022' || data[i].saledate ==='5/23/2022' || data[i].saledate ==='5/24/2022' || data[i].saledate ==='5/25/2022' || data[i].saledate ==='5/26/2022'|| data[i].saledate ==='5/27/2022' || data[i].saledate ==='5/28/2022'
          || data[i].saledate === '5/29/2022' || data[i].saledate === '5/30/2022' || data[i].saledate ==='5/31/2022')){
   ...
   let sortTotalsales = TotalSales.sort(function(a,b){
    return a.DOM - b.DOM;
  })
   ...
   document.getElementById('DOM85populatequote').innerHTML = '85% of sales sold @ ' + `${DOMTotalsalesinnerElement}` + 'days of ' + `${TotalSalesamount}` + ' Total Sales'; // showing 80...
      ...
      console.log(index21);
          ...
          for (let i = 0; i<data.length; i++){
            if (data[i].saleprice >= data[i].listprice && data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}` && (data[i].saledate ==='1/1/2022' || data[i].saledate ==='1/2/2022' || data[i].saledate ==='1/3/2022' || data[i].saledate ==='1/4/2022' || data[i].saledate ==='1/5/2022' || data[i].saledate ==='1/6/2022' || data[i].saledate ==='1/7/2022' || data[i].saledate ==='1/8/2022' || data[i].saledate ==='1/9/2022' || data[i].saledate ==='1/10/2022' || data[i].saledate ==='1/11/2022' || data[i].saledate ==='1/12/2022' || data[i].saledate ==='1/13/2022' || data[i].saledate ==='1/14/2022' || data[i].saledate ==='1/15/2022' || data[i].saledate ==='1/16/2022' || data[i].saledate ==='1/17/2022' || data[i].saledate ==='1/18/2022' || data[i].saledate ==='1/19/2022' || data[i].saledate ==='1/20/2022' || data[i].saledate ==='1/21/2022' || data[i].saledate ==='1/22/2022' || data[i].saledate ==='1/23/2022' || data[i].saledate ==='1/24/2022' || data[i].saledate ==='1/25/2022' || data[i].saledate ==='1/26/2022' || data[i].saledate ==='1/27/2022'|| data[i].saledate ==='1/28/2022'|| data[i].saledate ==='1/29/2022' || data[i].saledate ==='1/30/2022' || data[i].saledate ==='1/31/2022'
        || data[i].saledate === '2/1/2022' || data[i].saledate ==='2/2/2022' || data[i].saledate ==='2/3/2022' || data[i].saledate ==='2/4/2022' || data[i].saledate ==='2/5/2022' || data[i].saledate ==='2/6/2022' || data[i].saledate ==='2/7/2022' || data[i].saledate ==='2/8/2022' || data[i].saledate ==='2/9/2022' || data[i].saledate ==='2/10/2022' || data[i].saledate ==='2/11/2022' || data[i].saledate ==='2/12/2022' || data[i].saledate ==='2/13/2022' || data[i].saledate ==='2/14/2022' || data[i].saledate ==='2/15/2022'|| data[i].saledate ==='2/16/2022'|| data[i].saledate ==='2/17/2022' || data[i].saledate ==='2/18/2022' || data[i].saledate ==='2/19/2022' || data[i].saledate ==='2/20/2022' || data[i].saledate ==='2/21/2022' || data[i].saledate ==='2/22/2022' || data[i].saledate ==='2/23/2022' || data[i].saledate ==='2/24/2022' || data[i].saledate ==='2/25/2022' || data[i].saledate ==='2/26/2022'|| data[i].saledate ==='2/27/2022' || data[i].saledate ==='2/28/2022'
        || data[i].saledate === '3/1/2022' || data[i].saledate ==='3/2/2022'|| data[i].saledate ==='3/3/2022' || data[i].saledate ==='3/4/2022' || data[i].saledate ==='3/5/2022' || data[i].saledate ==='3/6/2022' || data[i].saledate ==='3/7/2022' || data[i].saledate ==='3/8/2022' || data[i].saledate ==='3/9/2022'|| data[i].saledate ==='3/10/2022'|| data[i].saledate ==='3/11/2022' || data[i].saledate ==='3/12/2022'|| data[i].saledate === '3/13/2022'|| data[i].saledate ==='3/14/2022' || data[i].saledate ==='3/15/2022' || data[i].saledate ==='3/16/2022' || data[i].saledate ==='3/17/2022' || data[i].saledate ==='3/18/2022' || data[i].saledate ==='3/19/2022' || data[i].saledate ==='3/20/2022' || data[i].saledate ==='3/21/2022'|| data[i].saledate ==='3/22/2022' || data[i].saledate ==='3/23/2022' || data[i].saledate ==='3/24/2022' || data[i].saledate ==='3/25/2022' || data[i].saledate ==='3/26/2022' || data[i].saledate ==='3/27/2022'|| data[i].saledate ==='3/28/2022' || data[i].saledate ==='3/29/2022' || data[i].saledate ==='3/30/2022' || data[i].saledate ==='3/31/2022' || data[i].saledate ==='4/1/2022'|| data[i].saledate ==='4/2/2022' || data[i].saledate ==='4/3/2022' || data[i].saledate ==='4/4/2022' || data[i].saledate ==='4/5/2022' || data[i].saledate ==='4/6/2022' || data[i].saledate ==='4/7/2022' || data[i].saledate ==='4/8/2022' || data[i].saledate ==='4/9/2022' || data[i].saledate ==='4/10/2022' || data[i].saledate ==='4/11/2022' || data[i].saledate ==='4/12/2022' || data[i].saledate ==='4/13/2022' || data[i].saledate ==='4/14/2022' || data[i].saledate ==='4/15/2022' || data[i].saledate ==='4/16/2022' || data[i].saledate ==='4/17/2022' || data[i].saledate ==='4/18/2022' || data[i].saledate ==='4/19/2022' || data[i].saledate ==='4/20/2022' || data[i].saledate ==='4/21/2022' || data[i].saledate ==='4/22/2022' || data[i].saledate ==='4/23/2022' || data[i].saledate ==='4/24/2022' || data[i].saledate ==='4/25/2022' || data[i].saledate ==='4/26/2022' || data[i].saledate ==='4/27/2022'|| data[i].saledate ==='4/28/2022'|| data[i].saledate ==='4/29/2022' || data[i].saledate ==='4/30/2022' 
        || data[i].saledate === '5/1/2022' || data[i].saledate ==='5/2/2022' || data[i].saledate ==='5/3/2022' || data[i].saledate ==='5/4/2022' || data[i].saledate ==='5/5/2022' || data[i].saledate ==='5/6/2022' || data[i].saledate ==='5/7/2022' || data[i].saledate ==='5/8/2022' || data[i].saledate ==='5/9/2022' || data[i].saledate ==='5/10/2022' || data[i].saledate ==='5/11/2022' || data[i].saledate ==='5/12/2022' || data[i].saledate ==='5/13/2022' || data[i].saledate ==='5/14/2022' || data[i].saledate ==='5/15/2022'|| data[i].saledate ==='5/16/2022'|| data[i].saledate ==='5/17/2022' || data[i].saledate ==='5/18/2022' || data[i].saledate ==='5/19/2022' || data[i].saledate ==='5/20/2022' || data[i].saledate ==='5/21/2022' || data[i].saledate ==='5/22/2022' || data[i].saledate ==='5/23/2022' || data[i].saledate ==='5/24/2022' || data[i].saledate ==='5/25/2022' || data[i].saledate ==='5/26/2022'|| data[i].saledate ==='5/27/2022' || data[i].saledate ==='5/28/2022'
        || data[i].saledate === '5/29/2022' || data[i].saledate === '5/30/2022' || data[i].saledate ==='5/31/2022')){
   ...
   let sortTotalSales2 = TotalSales2.sort(function(a,b){
    return a.DOM - b.DOM;
  })
   ...
   console.log(index22.indexOf(index22[i]));
   openarray.unshift(index22.splice(index22.indexOf(index22[i]), 120));
   return openarray;
...
const [averageSP54, setAverageSP54] = React.useState(0);
     ...
     async function marketflush21(e){ //this functions onClick...
       ...
       //if (data.status ==='ok'){
         ...
         for (let i = 0; i<data.length; i++){
           ...
           if (data[i].county === `${county2}` && data[i].townstate === `${town3}` && data[i].saleprice >= `${pricevalue3}` && data[i].saleprice < `${pricevalue4}` && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" && (data[i].saledate === newArray[0][0] || data[i].saledate === newArray[0][1] || data[i].saledate === newArray[0][2] || data[i].saledate === newArray[0][3] || data[i].saledate === newArray[0][4] || data[i].saledate === newArray[0][5] || data[i].saledate === newArray[0][6] || data[i].saledate === newArray[0][7] || data[i].saledate === newArray[0][8] || data[i].saledate === newArray[0][9] || data[i].saledate === newArray[0][10] || data[i].saledate === newArray[0][11] || data[i].saledate === newArray[0][12] || data[i].saledate === newArray[0][13] || data[i].saledate === newArray[0][14] || data[i].saledate === newArray[0][15] || data[i].saledate === newArray[0][16] || data[i].saledate === newArray[0][17] || data[i].saledate === newArray[0][18] || data[i].saledate === newArray[0][19] || data[i].saledate === newArray[0][20] || data[i].saledate === newArray[0][21] || data[i].saledate === newArray[0][22] || data[i].saledate === newArray[0][23] || data[i].saledate === newArray[0][24] || data[i].saledate === newArray[0][25] || data[i].saledate === newArray[0][26] || data[i].saledate === newArray[0][27] || data[i].saledate === newArray[0][28] || data[i].saledate === newArray[0][29] || data[i].saledate === newArray[0][30] || data[i].saledate === newArray[0][31] || data[i].saledate === newArray[0][32] || data[i].saledate === newArray[0][33] || data[i].saledate === newArray[0][34] || data[i].saledate === newArray[0][35] || data[i].saledate === newArray[0][36] || data[i].saledate === newArray[0][37] || data[i].saledate === newArray[0][38] || data[i].saledate === newArray[0][39] || data[i].saledate === newArray[0][40] || data[i].saledate === newArray[0][41] ||
             ...
             let differential13 = 0;
             function add13(item, counter, array){
               differential13+=(item.saleprice);
             }
     
             fourteenAP.forEach(add13); 
             ...
             thirtyAP.forEach(add14); 

             let differential15 = 0;
             function add15(item, counter, array){
               differential15+=(item.saleprice);
             }
     
             fortyfiveAP.forEach(add15); 
             ...
             setAverageSP49(formatter.format(Math.round(differential13 / sale14)) || 0);
             setAverageSP50(formatter.format(Math.round(differential14 / sale30)) || 0)
             setAverageSP51(formatter.format(Math.round(differential15 / sale45)) || 0);
             setAverageSP52(formatter.format(Math.round(differential16 / sale90)) || 0)
             setAverageSP53(formatter.format(Math.round(differential17 / sale120)) || 0);
             setAverageSP54(formatter.format(Math.round(differential18 / sale121)) || 0)
      ...
      // React.useEffect(() => { //use the useEffect hook with useState to call that route and then update the UI
       // entireArrayIndex();
       // fetch('https://jungleebook297-e68d158789dd.herokuapp.com/prototypejs')
       //  .then(response => response.json())
        // .then(data => {
         //  console.log(data) // all 15k objects...
          // let sales22 = [];
       ...
       //  }, [pricerangecounty1, pricerangetown1]); 
         ...
         async function PopUp(e, props){ //this functions onClick...
          ...
          //if (data.status ==='ok'){
            ...
            let sales22 = [];
            for (let i = 0; i<data.length; i++){ //death/no.mz//
              if (data[i].county === `${pricerangecounty1}` && data[i].townstate === `${pricerangetown1}` && data[i].year === 2022 && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" ){
                sales22.push(data[i]);
                //console.log(sales);
       ...
       return (show) ? ( 
         <>
          <div id='DKre' className='background64ctg'>
   ...
   <div className='hashh666'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Seller</div>
   <div className='backctg'>
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={multifam} alt='math' />
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='/activecondoctg#map'>MAP</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/condo">Suburb</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '375px' }}href='/condobuyer'>Buyer</a>
     <Popup lockScroll={true} trigger={<a id='mortgagecalcreact' className='innerelementwater642' style={{zIndex: '7', position: 'absolute', left: '45px', top: '425px' }} href="#batsymbol">Mortgage Calculator</a>}
   position='center' modal nested>
     ...
     <br/>
     <br/>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/alldatacondo'>WaterFront</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '325px' }}href="/activecondoctg">Female ACT</a>
     <div>
          <ul>
        <li style={{zIndex: '7', position: 'absolute', left: '1175px', top: '370px' }}>
         ...
         <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '475px' }} href='#populatequote11'>Price Range</a>
     <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '501px' }} href='#marketANThashh'>Market ANT</a>
     <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '526px' }} href='#mozart'>Business Planning</a>
     <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '552px' }} href='#townhash'>Town</a>
   
   <h5 id='headerstatetop22' style={{zIndex: '7', position: 'absolute', left: '820px', top: '425px' }}></h5>
   <div className='seperator'></div>

   <div style={{zIndex: '7', position: 'absolute', left: '530px', top: '485px'}}>
...
<div className='autoy' itemsPerRow={3} style={{ marginTop: 20 }}>
                    ...
                    filteredResults.map((item) => {
                        return (
                            <div>
                                ...
                                <Popup
      trigger={<div className='inputactives'>{item.streetAddress}</div>}
      position="center"
      modal
      nested       
      >
      ...
      <div className="modalpopactive" tabindex='0'>
         ...
         <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>List Price: {item.listprice}</td><br/>
   <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.streetAddress} </td>
   <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.townstate} {item.zipcode}</td><br/>
  ...
  <div className='awater' style={{zIndex: '7', position: 'absolute', left: '430px', top: '531px' }}>Previous 5 Month Market Condition Sales</div>
   ...
   <br/>
   <br/>
   <Popup lockScroll={true} trigger={<a id ='inject' className='awater' href='#/inject' style={{zIndex: '7', position: 'absolute', left: '820px', top: '605px' }}></a>}
   position='center' modal nested>
{close => (
   ...
   <div  className='fontwater' style={{zIndex: '7', position: 'absolute', left: '990px', top: '695px' }}>Avg. List___________</div>
    <Popup lockScroll={true} trigger={<a id ='threebears'  title={titleavgdiff} className='awater' href='#/threebears' style={{zIndex: '7', position: 'absolute', left: '820px', top: '755px' }}></a>}
    position='center' modal nested>
 {close => (
  ...
  <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '770px' }}>sale price rate_____________</div> 
   ...
   <br/>
   <br/>
   <Popup lockScroll={true} trigger={<a id='inject21' className='awater' href='#/inject21' style={{zIndex: '7', position: 'absolute', left: '215px', top: '605px' }}></a>}
   position='center' modal nested>
{close => (
...
{close => (
   ...
   <br/>
       <input className='input' style={{zIndex: '7', position: 'absolute', left: '990px', top: '800px' }}type='number' onChange={(e)=> setPrice1(e.target.value)}/>
       <input className='input' style={{zIndex: '7', position: 'absolute', left: '990px', top: '825px' }}type='number' onChange={(e)=> setPrice2(e.target.value)}/>
     ...
     <br/>
     <Button className='buttonctg' style={{zIndex: '7', position: 'absolute', left: '855px', top: '870px' }}variant='dark' type="button" value='Submit' onClick={()=> {brucewayne22a(); brucewayne22b(); brucewayne21a(); brucewayne21b();}}>Apply Science</Button>
         <br/>
   ...
   <Popup lockScroll={true} trigger={<a id ='threek21' title={averageSP26} className='awater' href='#/threek21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1060px' }}></a>}
   position='center' modal nested>
{close => (
  ...
  <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '205px', top: '1075px' }}>______________</div>     
  <Popup lockScroll={true} trigger={<a id ='threek' title={averageSP30} className='awater' href='#/threek' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1060px' }}></a>}
    position='center' modal nested>
 {close => (
   ...
   <Popup lockScroll={true} trigger={<a id ='fourk' title={averageSP31} className='awater' href='#/fourk' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1135px' }}></a>}
   position='center' modal nested>
{close => (
  ...
  <Popup lockScroll={true} trigger={<a id ='fourk21' title={averageSP27} className='awater' href='#/fourk21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1135px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
   ...
   <Popup lockScroll={true} trigger={<a id='sevenk21' title={averageSP28} className='awater' href='#/sevenk21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1210px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
   ...
   <Popup lockScroll={true} trigger={<a id ='sevenk' title={averageSP32} className='awater' href='#/sevenk' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1210px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
  ...
  <Popup lockScroll={true} trigger={<a id ='sevenfivek21' title={averageSP29} className='awater' href='#/sevenfivek21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1285px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
   ...
   <Popup lockScroll={true} trigger={<a id ='sevenfivek' title={averageSP33} className='awater' href='#/sevenfivek' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1285px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <select style={{zIndex: '7', position: 'absolute', left: '75px', top: '1335px' }}
          ...
          >
      <option id='value' style={{zIndex: '7', position: 'absolute', left: '75px', top: '1335px' }}>---Choose State--</option>
      {GLOBE1.states.map((value, key) => {
        return(
          ...
          >
            <option style={{zIndex: '7', position: 'absolute', left: '75px', top: '1355px' }}>--Choose County--</option>
        ...
        <select style={{zIndex: '7', position: 'absolute', left: '225px', top: '1335px' }}
         ...
         <br/>
         <br/>
         <Button className='buttonctg' style={{zIndex: '7', position: 'absolute', left: '217px', top: '1357px' }}variant='dark' type="button" value='Submit' onClick={()=> {sealteam1(); sealteam2(); sealteam3(); sealteam4(); straitofhormuz5();}}>Apply Science</Button>
   <br/>
   <br/>
   <img style={{height: '360px', width: '570px', left: '55px', top: '1415px', position: 'absolute' }}  src={mfsan} alt='chicagowheel' />
   <br/>
   <br/>
   <div id = 'statusx' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1500px' }}></div>
         ...
         <a></a>
         <Popup lockScroll={true} trigger={<a id='quarterly' title={averageSP22} className='awater' href='#/quarterly' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1806px' }} ></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '310px', top: '1781px' }}>at/above rate</div>
         <Popup lockScroll={true} trigger={<a id='catchmaxmil' title={popquoteJan} href='#/catchmaxmil' className='awater' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1806px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        ...
        <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '75px', top: '1856px' }}>4/1/2021 - 6/30/2021:</div>
         <a></a>
         <Popup lockScroll={true} trigger={<a id='quarterly21' title={averageSP23} className='awater' href='#/quarterly21' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1856px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <Popup lockScroll={true} trigger={<a id='quarterly20' title={averageSP24} className='awater' href='#/quarterly20' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1906px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <Popup lockScroll={true} trigger={<a id='quarterly19' title={averageSP25} className='awater' href='#/quarterly19' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1956px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <br/>
         <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '41px', top: '915px' }} href='#mozart'>Business Planning</a>
         <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '41px', top: '935px' }} href='#marketANThashh'>Market ANT</a>
         <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '41px', top: '955px' }} href='#populatequote11'>Price Range</a>
         <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '41px', top: '975px' }} href='#DKre'>Nav297</a>
     ...
     <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '820px', top: '977px' }}>sales</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '936px', top: '977px' }}>at/above rate</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '1115px', top: '977px' }}>differential</div>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1000px' }}>0-14 days</a>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='s14' title={averageSP} className='a1water' href='#/s14' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1000px' }}></a>}
    position='center' modal nested>
  {close => (
     <div className="modal" tabindex='0'>
       <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1075px' }}>15-30 days</a>
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='s30' title={averageSP2} className='a1water' href='#/s30' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1075px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
         <div id='fr30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1075px' }}></div>
         <a></a>
  <Popup lockScroll={true} trigger={<a id='r30' title={totallessdiff30} href='#/r30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1075px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
         <div id='d30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1075px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1150px' }}>31-45 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s45' title={averageSP3} className='a1water' href='#/s45' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1150px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div id='fr45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1150px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r45' title={totallessdiff45} href='#/r45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1150px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div id='d45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1150px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1225px' }}>46-90 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s90' title={averageSP4} className='a1water' href='#/s90' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1225px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div id='fr90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1225px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r90' title={totallessdiff90} href='#/r90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1225px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div id='d90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1225px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1300px' }}>91-120 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s120' title={averageSP5} className='a1water' href='#/s120' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1300px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div id='fr120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1300px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r120' title={totallessdiff120} href='#/r120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1300px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div id='d120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1300px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1375px' }}>121+ days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s121' title={averageSP5} className='a1water' href='#/s121' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1375px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div id='fr121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1375px' }}></div>
         <a></a>
  <Popup lockScroll={true} trigger={<a id='r121' title={totallessdiff121} href='#/r121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1375px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
         <div id='d121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1375px' }}></div>
         <br/>
     <br/>
     ...
     <div style={{zIndex: '7', position: 'absolute', left: '100px', top: '1400px' }}>----------------------------------------------</div>
      ...
      {GLOBE1.states.map((value, key) => {
       ...
       <input className='input' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1450px'}} type='number' onChange={(e)=> setPricevalue(e.target.value)}/>
     <input className='input' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1470px'}}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
     <Button id='benjamin' className='buttonctg' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1500px'}} variant='dark' type="button" value='Submit' onClick={() => {populateQuote(); DOM85PopulateQuote(); DOM85AbovePopulateQuote(); sealteam5(); sealteam6(); zerodark30(); jack10suit();}}>Apply Science</Button>
     ...
     <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1575px' }}>0-14 days</a>
         ...
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '936px', top: '1550px' }}>at/above rate</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '1115px', top: '1550px' }}>differential</div>
  <Popup lockScroll={true} trigger={<a id ='sales14' title={averageSP16} className='a1water' href='#/sales14' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1575px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1650px' }}>15-30 days</a>
         <a></a> 
  <Popup lockScroll={true} trigger={<a id ='sales30' title={averageSP17} className='a1water' href='#/sales30' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1650px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
         <div id='fraction30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1650px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates30' title={belowdiffrates30avg} href='#/rates30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1650px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div id='duff30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1650px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1725px' }}>31-45 days</a>
         <a></a>  
  <Popup lockScroll={true} trigger={<a id ='sales45' title={averageSP18} className='a1water' href='#/sales45' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1725px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
         <div id='fraction45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1725px' }}></div> 
         <a></a>
  <Popup lockScroll={true} trigger={ <a id='rates45' title={belowdiffrates45avg} href='#/rates45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1725px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
         <div id='duff45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1725px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1800px' }}>46-90 days</a>
         <a></a>      
  <Popup lockScroll={true} trigger={<a id='sales90' title={averageSP19} className='awater' href='#/sales90' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1800px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
         <div id='fraction90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1800px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates90' title={belowdiffrates90avg} href='#/rates90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1800px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div id='duff90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1800px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1875px' }}>91-120 days</a>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='sales120' title={averageSP20} className='a1water' href='#/sales120' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1875px' }}></a>}
    position='center' modal nested>
  {close => (
     <div className="modal" tabindex='0'>
       <button className="close" onClick={close}>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fraction120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1875px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates120' title={belowdiffrates120avg} href='#/rates120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1875px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div id='duff120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1875px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1950px' }}>121+ days</a>
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='sales121' title={averageSP21} className='a1water' href='#/sales121' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1950px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
         <div id='fraction121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1950px' }}></div>
         <a></a>  
   <Popup lockScroll={true} trigger={<a id='rates121' title={belowdiffrates121avg} href='#/rates121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1950px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div id='duff121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1950px' }}></div>
         <br/>
         <br/> 
         <br/>
       <select style={{zIndex: '7', position: 'absolute', left: '100px', top: '1975px' }}
          ...
          >
      <option id='value' style={{zIndex: '7', position: 'absolute', left: '100px', top: '1975px' }}>---Choose State--</option>
      {GLOBE1.states.map((value, key) => {
        return(
          ...
          >
            <option style={{zIndex: '7', position: 'absolute', left: '100px', top: '2000px' }}>--Choose County--</option>
       ...
       <br/>
       <br/>
       <input className='input' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2050px' }}type='number' onChange={(e)=> setPricevalue(e.target.value)}/>
       <input className='input' style={{zIndex: '7', position: 'absolute', left: '305px', top: '2050px' }}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
       <Button className='buttonctg' style={{zIndex: '7', position: 'absolute', left: '510px', top: '2040px' }}variant='dark' type="button" value='Submit' onClick={marketANT}>Apply Science</Button>
       <a id='mozart' className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '235px', top: '2025px' }} href='#DKre'>Nav297</a>
        <a id='marketANThashh' className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '295px', top: '2025px' }} href='#townhash'>Town</a>
         <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '345px', top: '2025px' }} href='#mozart'>Business Planning</a>
         <br/>
         ...
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2100px', width: '1100px', height: '300px', borderRadius: '0%', background: 'rgb(13, 13, 13)' }}></div>
         ...
         <br/>
         <br/>
         <a id='mozart' className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '100px', top: '2450px' }} href='#DKre'>Nav297</a>
         <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '170px', top: '2450px' }} href='#townhash'>Town</a>
         <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '240px', top: '2450px' }} href='#populatequote11'>Price Point</a>
   ...
   return (
     <option value={index}>
       ...
       <input className='input' id='inputback1' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2550px' }}type='number' onChange={(e)=> setPricevalue3(e.target.value)}/>
       <input className='input' id='inputback2' style={{zIndex: '7', position: 'absolute', left: '305px', top: '2550px' }}type='number' onChange={(e)=> setPricevalue4(e.target.value)}/>
       <Button className='buttonctg' id='businessplanning11' style={{zIndex: '7', position: 'absolute', left: '510px', top: '2538px' }}variant='dark' type="button" value='Submit' onClick={()=> {businessplanning(); businessplanning21(); businessplanning20(); clearAvg5(); marketflush21();}}>Apply Science</Button>
       ...
       <img style={{height: '1200px', width: '1180px', position: 'absolute', left: '75px', top: '2700px' }} src={northcarolina} alt='northcarolina'/>
       <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2600px'}}>#APPLYSCIENCE - Seller Agency Residential - 
         ...
         <br/>
         <br/>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2750px', width: '530px', height: '300px', borderRadius: '31%', background: 'rgb(24, 24, 24)', border: '3.5px solid rgb(13, 13, 13)' }}></div>
         ...
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '2750px', width: '530px', height: '300px', borderRadius: '31%', background: 'rgb(24, 24, 24)', border: '3.5px solid rgb(13, 13, 13)' }}></div>
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='planAsales' title={averageSP34} className='a1water' href='#/planAsales' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2830px' }}></a>}
    position='center' modal nested>
  {close => (
     <div className="modal" tabindex='0'>
       <button className="close" onClick={close}>
  ...
  {close => (
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <br/>
         <a></a>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '120px', top: '2880px' }}>$2021:</div>
         <a></a> 
     <Popup lockScroll={true} trigger={<a id ='planAsales21' title={averageSP39} className='a1water' href='#/planAsales21' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2880px' }}></a>}
     position='center' modal nested>
   {close => (
      <div className="modal" tabindex='0'>
        <button className="close" onClick={close}>
  ...
  {close => (
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planAsales20' title={averageSP44} className='a1water' href='#/planAsales20' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2930px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
        ...
        <div id ='avgAsales' className='a1water' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2990px' }}></div>
         ...
         <a></a>  
  <Popup lockScroll={true} trigger={<a id ='planBsales' title={averageSP35} className='a1water' href='#/planBsales' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2830px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
   ...
   <div className="modal" tabindex='0'>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>  
  <Popup lockScroll={true} trigger={<a id ='planBsales21' title={averageSP40} className='a1water' href='#/planBsales21' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2880px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planBsales20' title={averageSP45} className='a1water' href='#/planBsales20' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2930px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <br/>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '3095px', width: '530px', height: '300px', borderRadius: '31%', background: 'rgb(24, 24, 24)', border: '3.5px solid rgb(13, 13, 13)' }}></div>
         ...
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '3095px', width: '530px', height: '300px', borderRadius: '31%', background: 'rgb(24, 24, 24)', border: '3.5px solid rgb(13, 13, 13)' }}></div>
         <br/>
         ...
         <a></a>  
   <Popup lockScroll={true} trigger={<a id ='planCsales' title={averageSP36} className='a1water' href='#/planCsales' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3175px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
     <Popup lockScroll={true} trigger={<a id ='planCsales21' title={averageSP41} className='a1water' href='#/planCsales21' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3225px' }}></a>}
     position='center' modal nested>
   {close => (
      <div className="modal" tabindex='0'>
        <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>   
   <Popup lockScroll={true} trigger={<a id='planCsales20' title={averageSP46} className='a1water' href='#/planCsales20' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3275px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
  ...
  {close => (
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planDsales' title={averageSP37} className='a1water' href='#/planDsales' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3175px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id='planDsales21' title={averageSP42} className='a1water' href='#/planDsales21' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3225px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planDsales20' title={averageSP47} className='a1water' href='#/planDsales20' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3275px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <br/>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '3440px', width: '530px', height: '300px', borderRadius: '31%', background: 'rgb(24, 24, 24)', border: '3.5px solid rgb(13, 13, 13)' }}></div>
         ...
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '3440px', width: '530px', height: '365px', borderRadius: '10%', background: 'rgb(24, 24, 24)', border: '3.5px solid rgb(13, 13, 13)' }}></div>
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planEsales' title={averageSP38} className='a1water' href='#/planEsales' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3515px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
   ...
   <div className="modal" tabindex='0'>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planEsales21' title={averageSP43} className='a1water' href='#/planEsales21' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3565px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id='planEsales20' title={averageSP48} className='a1water' href='#/planEsales20' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3615px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
  ...
  {close => (
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <br/>
     <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '890px', top: '3435px'}}>[Timeframe 2021 Sales]</h5>
     <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3510px' }}>0-14 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales14flush' title={averageSP49} className='a1water' href='#/sales14flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3510px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
   ...
   <div className="modal" tabindex='0'>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3560px' }}>15-30 days</a>
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='sales30flush' title={averageSP50} className='a1water' href='#/sales30flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3560px' }}></a> }
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
        ...
        {close => (
         ...
         <a></a>
         <div id='duff30flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '3560px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3610px' }}>31-45 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='sales45flush' title={averageSP51} className='a1water' href='#/sales45flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3610px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3660px' }}>46-90 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales90flush' title={averageSP52} className='a1water' href='#/sales90flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3660px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3710px' }}>91-120 days</a>
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='sales120flush' title={averageSP53} className='a1water' href='#/sales120flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3710px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3760px' }}>121+ days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales121flush' title={averageSP54} className='a1water' href='#/sales121flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3760px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <img style={{height: '375px', width: '1295px', position: 'absolute', top: '4100px' }} src={pixa} alt='pixa'/>
         </div>
...
<br/>
<div>WITHDRAW</div>
<input className='input' type='text' placeholder='Enter Withdrawal' style={{ width: '13rem' }} name="mode" id="mode-select"/><br/>
