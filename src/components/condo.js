...
const [averageSP54, setAverageSP54] = React.useState(0);
   ...
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={multifam} alt='math' />
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='/activecondo#map'>MAP</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/activecondo">Active</a>
   ...
   position='center' modal nested>
     ...
     <br/>
     <br/>
     <div className='hashh66'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '250px' }}>Condominium</div>
...
{close => (
 ...
 {close => (
   ...
   <br/>
   <br/>
   <img style={{height: '360px', width: '570px', left: '55px', top: '1415px', position: 'absolute' }}  src={titanic} alt='chicagowheel' />
   <br/>
   <br/>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <br/>
         <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '41px', top: '915px' }} href='#mozart'>Business Planning</a>
         ...
         <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '41px', top: '975px' }} href='#DKre'>Nav297</a>
...
{close => (
   <div className="modal" tabindex='0'>
     ...
     <div id='DOM85populatequote' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '833px', top: '1515px'}}></div>
     <div id='DOM85abovepopulatequote' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '833px', top: '1530px'}}></div>
 ...
 {close => (
   ...
   onChange={(e) => setSelectedState4(e.target.value)}
      ...
      {GLOBE1.states.map((value, key) => {
       ...
       <br/>
       <br/>
       <input className='inputbat' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2050px' }}type='number' onChange={(e)=> setPricevalue(e.target.value)}/>
       <input className='inputbat' style={{zIndex: '7', position: 'absolute', left: '305px', top: '2050px' }}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
       ...
       <a id='mozart' className='hashh'  style={{zIndex: '7', position: 'absolute', left: '235px', top: '2025px' }} href='#DKre'>Nav297</a>
        <a id='marketANThashh' className='hashh'  style={{zIndex: '7', position: 'absolute', left: '295px', top: '2025px' }} href='#townhash'>Town</a>
         ...
         <br/>
         <br/>
         <a id='mozart' className='hashh'  style={{zIndex: '7', position: 'absolute', left: '100px', top: '2450px' }} href='#DKre'>Nav297</a>
   ...
   return (
     <option value={index}>
       ...
       <input className='inputbat' id='inputback1' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2550px' }}type='number' onChange={(e)=> setPricevalue3(e.target.value)}/>
       <input className='inputbat' id='inputback2' style={{zIndex: '7', position: 'absolute', left: '305px', top: '2550px' }}type='number' onChange={(e)=> setPricevalue4(e.target.value)}/>
       <Button className='button' id='businessplanning11' style={{zIndex: '7', position: 'absolute', left: '510px', top: '2538px' }}variant='dark' type="button" value='Submit' onClick={()=> {businessplanning(); businessplanning21(); businessplanning20(); clearAvg5(); marketflush21();}}>Apply Science</Button>
...
<br/>
<div>WITHDRAW</div>
<input className='inputbat' type='text' placeholder='Enter Withdrawal' style={{ width: '13rem' }} name="mode" id="mode-select"/><br/>
