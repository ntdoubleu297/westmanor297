...
const [averageSP54, setAverageSP54] = React.useState(0);
   ...
   <div className='hashh666'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Buyer</div>
   ...
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={multifam} alt='math' />
     ...
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/condobuyer">Suburb</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '375px' }}href='/condo'>Seller</a>
   ...
   position='center' modal nested>
     ...
     <br/>
     <br/>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/alldatacondobuyer'>WaterFront</a>
 ...
 {close => (
    <div className="modal" tabindex='0'>
     ...
     <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '820px', top: '977px' }}>sales</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '936px', top: '977px' }}>belowList rate</div>
