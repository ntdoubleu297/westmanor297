import React from "react";
  ...
  // import'./alldata.css';
   ...
   function ApplyScienceWaterFront(){
...
/////////////// commercial render UP... 16-23
         ...
         ///////////////////////////////////////////////////////
           ...
           let salesTpopulate = averagesaleprice.length;
           ...
           document.getElementById('salesTpopulate').innerHTML = `${salesTpopulate} Sales`;
...
<div className='back64'>
   ...
   <div className='hashh64w'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Seller</div>
 ...
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <br/>
         <img style={{height: '440px', width: '1292px', position: 'absolute', top: '4100px' }} src={vegas} alt='pixa'/>
     ...
     export default ApplyScienceWaterFront;
