 ...
 */
     ...
     function ActiveWaterSingleFamily() {
...
<div className='background'>
   ...
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={matheus} alt='math' />
     ...
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/alldatasinglefamily">Seller</a>
   ...
   <div className='hashh65'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Active</div>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/'>Suburb</a>
     ...
     <div id='imme' className='activetitle64' style={{zIndex: '7', position: 'absolute', left: '395px', top: '511px' }}>Active Single Family</div>
...
{close => (
   ...
   <br/>
     ...
     <br/>
            ...
            export default ActiveWaterSingleFamily; 
