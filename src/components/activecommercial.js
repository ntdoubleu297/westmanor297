...
<br/>
 ...
 React.useEffect(() => { //
  ...
  const searchItems = (searchValue) => {
    ...
    <td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
            <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-125px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
            <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-240px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
    <br/>
         <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
...
<div className='background64'>
                <a className='fontnav64' style={{zIndex: '7', position: 'absolute', left: '75px', top: '45px' }}href='/activesinglefamily' {...buttonDHoverProps}>{buttonDIsHovering ? 'Click here to applyscience' : 'Single Family'}</a>
                  ...
                  <a className='fontnav64ctg' style={{zIndex: '7', position: 'absolute', left: '75px', top: '181px' }}href='/createaccount' {...buttonBHoverProps}>{buttonBIsHovering ? 'Click here to create account' : 'Create Account'}</a>
   ...
   <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='#map'>MAP</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/applyscience">Seller</a>
   ...
   <div className='hashh66'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Active</div>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/activewatercommercial'>WaterFront</a>
         <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '1780px' }} href='#imme'>Active Listings Search</a>
     <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '1800px' }} href='#map'>Mapping</a>
     <div id='imme' className='activetitle' style={{zIndex: '7', position: 'absolute', left: '395px', top: '511px' }}>Active Commercial</div>
      ...
      {GLOBE1.states.map((value, key) => {
       ...
       <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '663px', top: '642px' }}># Listings</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '793px', top: '642px' }}>% Total Market</div>
                          ...
                          <a></a>                       
                           <Popup lockScroll={true} trigger={<a id='s14'  href='#/s14' title={belowdiffratesPlanAavg} className='a1water' style={{zIndex: '7', position: 'absolute', left: '690px', top: '671px' }}></a>}
                           position='center' modal nested>
                         {close => (
                      ...
                      <a></a>
                          ...
                          <a></a>
   <Popup lockScroll={true} trigger={<a id='s30' title={belowdiffratesPlanBavg} href='#/s30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '690px', top: '746px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData9}
                          ...
                          <a></a>
  <Popup lockScroll={true} trigger={<a id='s45' href='#/s45' title={belowdiffratesPlanCavg} className='a1water' style={{zIndex: '7', position: 'absolute', left: '690px', top: '821px' }}></a>}
  position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData10}
                          ...
                          <a></a>
  <Popup lockScroll={true} trigger={<a id='s90' title={belowdiffratesPlanDavg} href='#/s90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '690px', top: '896px' }}></a>}
  position='center' modal nested>
{close => (
         ...
         <ReactPaginate
           ...
           {currentPageData11}
                         ...
                         <a></a>
                          ...
                          <a></a>
   <Popup lockScroll={true} trigger={<a id='s120' href='#/s120' title={belowdiffratesPlanEavg} className='a1water' style={{zIndex: '7', position: 'absolute', left: '690px', top: '971px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
           ...
           <a></a>
                          ...
                          <a></a>
   <Popup lockScroll={true} trigger={<a id='s121' title={belowdiffratesPlanFavg} href='#/s121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '690px', top: '1046px' }}></a>}
   position='center' modal nested>
 {close => (
...
{close => (
     ...
     <br/>
         ...
         <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '1125px' }} href='#geocoder'>Previous Market History</a>
...
<div itemsPerRow={3} style={{ marginTop: 20 }}>
  ...
  <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '532px' }} href='#geocoder'>Previous Market History</a>
     <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '552px' }} href='#map'>Mapping</a>
     </div>
