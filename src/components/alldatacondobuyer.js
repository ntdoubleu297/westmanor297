...
const [averageSP54, setAverageSP54] = React.useState(0);
     ...
     async function marketflush21(e){ //this functions onClick...
      ...
      // React.useEffect(() => { //use the useEffect hook with useState to call that route and then update the UI
       ...
       return (show) ? ( 
         <>
  <div id='DKre' className='background'>
<a className='fontnav' style={{zIndex: '7', position: 'absolute', left: '75px', top: '45px' }}href='/activesinglefamily' {...buttonDHoverProps}>{buttonDIsHovering ? 'Click here to applyscience' : 'Single Family'}</a>
  ...
  <a className='fontnav' style={{zIndex: '7', position: 'absolute', left: '1050px', top: '45px' }}href='/activecommercial' {...buttonCHoverProps}>{buttonCIsHovering ? 'Click here to applyscience' : 'Commercial'}</a>
   ...
   <div className='hashh65'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '250px' }}>Condominium</div>
   <div className='hashh65'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Buyer</div>
   <Popup lockScroll={true} trigger={<a id='mortgagecalcreact' className='innerelementwater642mtg' style={{zIndex: '7', position: 'absolute', left: '45px', top: '425px' }} href="#batsymbol">Mortgage Calculator</a>}
   position='center' modal nested>
     ...
     <br/>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='/activewatercondo#map'>MAP</a>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/activewatercondo">Active</a>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '375px' }}href='/alldatacondo'>Seller</a>
     <br/>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/condobuyer'>Suburb</a>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '325px' }}href="/activecondoctg">Female ACT</a>
     <div>
          <ul>
        <li style={{zIndex: '7', position: 'absolute', left: '1175px', top: '370px' }}>
          <a className='innerelementwater64sm' href="/ctgcondo">Female Seller</a>
          </li>
          <li style={{zIndex: '7', position: 'absolute', left: '1175px', top: '395px' }}>
          <a className='innerelementwater64sm' href="/ctgcondobuyer">Female Buyer</a>
        </li>
         </ul>
         </div>
...
<div className='autoy' itemsPerRow={3} style={{ marginTop: 20 }}>
                    ...
                    filteredResults.map((item) => {
                        return (
                            <div>
                                ...
                                <Popup
      trigger={<div className='inputbatactiveswawa'>{item.streetAddress}</div>}
      position="center"
      modal
      nested       
      >
   ...
   <br/>
   <br/>
   <Popup lockScroll={true} trigger={<a id ='inject' className='awater64' href='#/inject' style={{zIndex: '7', position: 'absolute', left: '820px', top: '605px' }}></a>}
   position='center' modal nested>
{close => (
   ...
   <div  className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '990px', top: '695px' }}>Avg. List___________</div>
    <Popup lockScroll={true} trigger={<a id ='threebears'  title={titleavgdiff} className='awater64' href='#/threebears' style={{zIndex: '7', position: 'absolute', left: '820px', top: '755px' }}></a>}
    position='center' modal nested>
 {close => (
  ...
  <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '770px' }}>sale price rate_____________</div> 
   ...
   <br/>
   <br/>
   <Popup lockScroll={true} trigger={<a id='inject21' className='awater64' href='#/inject21' style={{zIndex: '7', position: 'absolute', left: '215px', top: '605px' }}></a>}
   position='center' modal nested>
{close => (
...
{close => (
   ...
   <br/>
     ...
     <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '51px', top: '999px', width: '580px', height: '322px', borderRadius: '10%', background: 'rgb(170, 170, 170)', border: '3.5px solid rgb(101, 101, 101)' }}></div>
         <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '680px', top: '978px', width: '570px', height: '426px', borderRadius: '10%', background: 'rgb(170, 170, 170)', border: '3.5px solid rgb(101, 101, 101)' }}></div>
         <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '680px', top: '1551px', width: '570px', height: '426px', borderRadius: '10%', background: 'rgb(170, 170, 170)', border: '3.5px solid rgb(101, 101, 101)' }}></div>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a className='hashh64'  style={{zIndex: '7', position: 'absolute', left: '41px', top: '975px' }} href='#DKre'>Nav297</a>
     ...
     <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '820px', top: '977px' }}>sales</div>
         <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '936px', top: '977px' }}>belowList rate</div>
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='s14' title={averageSP} className='a1water64' href='#/s14' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1000px' }}></a>}
    position='center' modal nested>
  {close => (
     <div className="modal" tabindex='0'>
       <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='s30' title={averageSP2} className='a1water64' href='#/s30' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1075px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id='r30' title={totallessdiff30} href='#/r30' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1075px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s45' title={averageSP3} className='a1water64' href='#/s45' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1150px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r45' title={totallessdiff45} href='#/r45' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1150px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s90' title={averageSP4} className='a1water64' href='#/s90' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1225px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r90' title={totallessdiff90} href='#/r90' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1225px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s120' title={averageSP5} className='a1water64' href='#/s120' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1300px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r120' title={totallessdiff120} href='#/r120' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1300px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s121' title={averageSP5} className='a1water64' href='#/s121' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1375px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id='r121' title={totallessdiff121} href='#/r121' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1375px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <Button id='benjamin' className='button64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1496px'}} variant='dark' type="button" value='Submit' onClick={() => {populateQuote(); DOM85PopulateQuote(); DOM85AbovePopulateQuote(); sealteam5(); sealteam6(); zerodark30(); jack10suit();}}>Apply Science</Button>
  ...
  <Popup lockScroll={true} trigger={<a id ='sales14' title={averageSP16} className='a1water64' href='#/sales14' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1575px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a> 
  <Popup lockScroll={true} trigger={<a id ='sales30' title={averageSP17} className='a1water64' href='#/sales30' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1650px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates30' title={belowdiffrates30avg} href='#/rates30' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1650px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>  
  <Popup lockScroll={true} trigger={<a id ='sales45' title={averageSP18} className='a1water64' href='#/sales45' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1725px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
  <Popup lockScroll={true} trigger={ <a id='rates45' title={belowdiffrates45avg} href='#/rates45' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1725px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>      
  <Popup lockScroll={true} trigger={<a id='sales90' title={averageSP19} className='awater64' href='#/sales90' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1800px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates90' title={belowdiffrates90avg} href='#/rates90' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1800px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='sales120' title={averageSP20} className='a1water64' href='#/sales120' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1875px' }}></a>}
    position='center' modal nested>
  {close => (
     <div className="modal" tabindex='0'>
       <button className="close" onClick={close}>
       ...
       <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates120' title={belowdiffrates120avg} href='#/rates120' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1875px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='sales121' title={averageSP21} className='a1water64' href='#/sales121' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1950px' }}></a>}
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>  
         <Popup lockScroll={true} trigger={<a id='rates121' title={belowdiffrates121avg} href='#/rates121' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1950px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      {GLOBE1.states.map((value, key) => {
       ...
       <a id='mozart' className='hashh64'  style={{zIndex: '7', position: 'absolute', left: '235px', top: '2025px' }} href='#DKre'>Nav297</a>
        <a id='marketANThashh' className='hashh64'  style={{zIndex: '7', position: 'absolute', left: '295px', top: '2025px' }} href='#townhash'>Town</a>
         ...
         <br/>
         <br/>
         <a id='mozart' className='hashh64'  style={{zIndex: '7', position: 'absolute', left: '100px', top: '2450px' }} href='#DKre'>Nav297</a>
   ...
   return (
     <option value={index}>
       ...
       <h5 className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2600px'}}>#APPLYSCIENCE - Seller Agency Residential - 
         ...
         <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '336px', top: '2794px' }}>belowList rate</div>
         ...
         <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '946px', top: '2794px' }}>belowList rate</div>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '336px', top: '3139px' }}>belowList rate</div>
         ...
         <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '946px', top: '3139px' }}>belowList rate</div>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '336px', top: '3488px' }}>belowList rate</div>
         ...
         <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '946px', top: '3486px' }}>belowList rate</div>
   ...
   <div className="modal" tabindex='0'>
     ...
     <div className="actions">
       <ReactPaginate
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='sales30flush' title={averageSP50} className='a1water64' href='#/sales30flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3560px' }}></a> }
  position='center' modal nested>
{close => (
   <div className="modal" tabindex='0'>
     <button className="close" onClick={close}>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <img style={{height: '375px', width: '1295px', position: 'absolute', top: '4100px' }} src={ocean} alt='pixa'/>
...
<Button onClick={showBack} variant='dark' type="button" value='Submit'>Deposit</Button> <br/>
     ...
     export default AllDataCondoBuyer;