...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-26px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-91px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
...
.map((item, index) => (
   ...
   <ul data-index={index}>
    ...
    <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>List Price: {formatter.format(item.listprice)}</td>
    <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>Sale Price: {formatter.format(item.saleprice)}</td> 
     <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>Differential: {formatter.format(item.differential)}</td> <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>Sale Price: {item.saleprice}</td> 
     <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>Differential: {item.differential}</td><br/>
 <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.streetAddress} </td>
 <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.townstate} {item.zipcode}</td><br/>
...
const [averageSP54, setAverageSP54] = React.useState(0);
       ...
       return (show) ? ( 
         ...
         <div id='DKre' className='background64ctg'>
                <a className='fontnav64ctg' style={{zIndex: '7', position: 'absolute', left: '75px', top: '45px' }}href='/activesinglefamily' {...buttonDHoverProps}>{buttonDIsHovering ? 'Click here to applyscience' : 'Single Family'}</a>
                  ...
                  <div className='hashh666'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '250px' }}>Single Family</div>
   ...
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={multifam} alt='math' />
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='/activesinglefamilyctg#map'>MAP</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/singlefamily">Suburb</a>
     ...
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '325px' }}href="/activesinglefamilyctg">Female ACT</a>
     <div>
          <ul>
        <li style={{zIndex: '7', position: 'absolute', left: '1175px', top: '370px' }}>
          <a className='innerelementwater642' href="/ctgsinglefamily">Female Seller</a>
          </li>
          <li style={{zIndex: '7', position: 'absolute', left: '1175px', top: '395px' }}>
          <a className='innerelementwater642' href="/ctg">Female Buyer</a>
        </li>
         </ul>
         </div>
    ...
    <div className="modal" tabindex='0'>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <br/>
         <img style={{height: '375px', width: '1294px', position: 'absolute', top: '4100px' }} src={pixa} alt='pixa'/>
         </div>
...
<Button onClick={showBack} variant='dark' type="button" value='Submit'>Deposit</Button> <br/>
     ...
     export default CtgSingleFamily;
