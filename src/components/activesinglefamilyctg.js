 ...
 */
     ...
     function ActiveSingleFamilyCtg() {
...
<div className='background64ctg'>
                <a className='fontnav64ctg' style={{zIndex: '7', position: 'absolute', left: '75px', top: '45px' }} href='/' {...buttonDHoverProps}>{buttonDIsHovering ? 'Click here to applyscience' : 'Single Family'}</a>
                  ...
                  <a className='fontnav64ctg' style={{zIndex: '7', position: 'absolute', left: '1050px', top: '45px' }}href='/applysciencewaterfront' {...buttonCHoverProps}>{buttonCIsHovering ? 'Click here to applyscience' : 'Commercial'}</a>
                  </div>    
   ...
   <div className='hashh666'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Active</div>
     ...
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '325px' }}href="/activesinglefamily">Suburb</a>
     <div>
          <ul>
     ...
     <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '1800px' }} href='#benjamin2'>Mapping</a>
     ...
     <select style={{zIndex: '7', position: 'absolute', left: '45px', top: '591px' }}
      ...
      <input className='input' value={pricevalue} style={{zIndex: '7', position: 'absolute', left: '540px', top: '611px'}} type='number' onChange={(e)=> setPricevalue(e.target.value)}/> 
     <input className='input' value={pricevalue2} style={{zIndex: '7', position: 'absolute', left: '740px', top: '611px'}}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
...
{close => (
         ...
         <ReactPaginate
           ...
           {currentPageData18}
                 ...
                 <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1086px', top: '1026px' }}>______________</div>
                      ...
                      <img style={{height: '375px', width: '1296px', position: 'absolute', top: '2195px' }} src={hottubbubblezzz} alt='pixa'/>
     ...
     <br/>
         ...
         <input className='input' value={pricevalue} style={{zIndex: '7', position: 'absolute', left: '325px', top: '1150px'}} type='number' onChange={(e)=> setPricevalue(e.target.value)}/> 
         <input className='input' value={pricevalue2} style={{zIndex: '7', position: 'absolute', left: '780px', top: '1150px'}}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
...
<div className='autoy' itemsPerRow={3} style={{ marginTop: 20 }}>
  ...
  <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '532px' }} href='#geocoder'>Previous Market History</a>
     <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '552px' }} href='#benjamin2'>Mapping</a>
     </div>
...
{close => (
   ...
   <br/>
     ...
     <br/>
            ...
            export default ActiveSingleFamilyCtg; 
