...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-31px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-121x', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
...
<div className='background'>
                <a className='fontnav' style={{zIndex: '7', position: 'absolute', left: '75px', top: '45px' }}href='/activesinglefamily' {...buttonDHoverProps}>{buttonDIsHovering ? 'Click here to applyscience' : 'Single Family'}</a>
                  ...
                  <img id='DKre' src={NeilWhite} width={255} height={350} style={{zIndex: '7', position: 'absolute', left: '500px', top: '54px' }} />
...
<div className='back64'>
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={timessquare} alt='math' />
   <div className='hashh64w'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '250px' }}>Commercial</div>
   <div className='hashh64w'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Buyer</div>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='/activewatercommercial#map'>MAP</a>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/activewatercommercial">Active</a>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '375px' }}href='/applysciencewaterfront'>Seller</a>
      <Popup lockScroll={true} trigger={<a id='mortgagecalcreact' className='innerelementwater642' style={{zIndex: '7', position: 'absolute', left: '45px', top: '425px' }} href="#DKre">Mortgage Calculator</a>}
   position='center' modal nested>
     ...
     <br/>
    <br/>
    <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/applyscience'>Suburb</a>
...
<div className='autoy' itemsPerRow={3} style={{ marginTop: 20 }}>
   ...
   <br/>
   <br/>
  <Popup lockScroll={true} trigger={<a id ='inject' title={titleavgdiff} className='awater64' href='#/inject' style={{zIndex: '7', position: 'absolute', left: '820px', top: '605px' }}></a>}
  position='center' modal nested>
{close => (
   ...
   <a id ='harley' href='#' className='awater64' style={{zIndex: '7', position: 'absolute', left: '1065px', top: '605px' }}></a>
   ...
   <a id ='oj' href='#' className='awater64' style={{zIndex: '7', position: 'absolute', left: '1065px', top: '680px' }}></a>
   <div  className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '990px', top: '695px' }}>Avg. List___________</div>
  <Popup lockScroll={true} trigger={<a id ='threebears' title={titleavgdiff} href='#/threebears' className='awater64' style={{zIndex: '7', position: 'absolute', left: '820px', top: '755px' }}></a>}
  position='center' modal nested>
{close => (
   ...
   <a id ='lordof' href='#' className='awater64' style={{zIndex: '7', position: 'absolute', left: '1105px', top: '755px' }}></a>
   <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '990px', top: '770px' }}>Avg. Differential___________</div>
   <a id ='min' href='#' className='awater64HL' style={{zIndex: '7', position: 'absolute', left: '770px', top: '830px' }}></a>
   <a id ='max' href='#' className='awater64HL' style={{zIndex: '7', position: 'absolute', left: '870px', top: '830px' }}></a>
   ...
   <br/>
   <br/>
    <Popup lockScroll={true} trigger={<a id ='inject21' title={titleavgdiff2} className='awater64' href='#/inject21' style={{zIndex: '7', position: 'absolute', left: '215px', top: '605px' }}></a>}
    position='center' modal nested>
  {close => (
   ...
   <a id ='oj21' href='#' className='awater64' style={{zIndex: '7', position: 'absolute', left: '460px', top: '680px' }}></a>
   <div  className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '385px', top: '695px' }}>Avg. List_____________</div>
   <Popup lockScroll={true} trigger={<a id ='threebears21' title={titleavgdiff2} href='#/threebears21' className='awater64' style={{zIndex: '7', position: 'absolute', left: '215px', top: '755px' }}></a>}
   position='center' modal nested>
 {close => (
   ...
   <a id ='min21' href='#' className='awater64HL' style={{zIndex: '7', position: 'absolute', left: '150px', top: '830px' }}></a>
   <a id ='max21' href='#' className='awater64HL' style={{zIndex: '7', position: 'absolute', left: '260px', top: '830px' }}></a>
...
>
  ...
  {GLOBE1.states.map((value, key) => {
   ...
   <br/>
       ...
       <Button className='button64' style={{zIndex: '7', position: 'absolute', left: '855px', top: '870px' }}variant='dark' type="button" value='Submit' onClick={()=> {brucewayne22a(); brucewayne22b(); brucewayne21a(); brucewayne21b();}}>Apply Science</Button>
     <br/>
     <br/>
     <br/>
  ...
  <Popup lockScroll={true} trigger={<a id ='threek21' title={averageSP26} className='awater64' href='#/threek21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1060px' }}></a>}
  position='center' modal nested>
{close => (
  ...
  <Popup lockScroll={true} trigger={<a id ='threek' title={averageSP30} className='awater64' href='#/threek' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1060px' }}></a>}
  position='center' modal nested>
{close => (
  ...
  <Popup lockScroll={true} trigger={<a id ='fourk21' title={averageSP27} className='awater64' href='#/fourk21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1135px' }}></a>}
  position='center' modal nested>
{close => (
  ...
  <Popup lockScroll={true} trigger={<a id ='fourk' title={averageSP31} className='awater64' href='#/fourk' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1135px' }}></a>}
  position='center' modal nested>
{close => (
   ...
   <Popup lockScroll={true} trigger={<a id ='sevenk21' title={averageSP28} className='awater64' href='#/sevenk21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1210px' }}></a>}
   position='center' modal nested>
 {close => (
...
<div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '205px', top: '1225px' }}>______________</div>
  <Popup lockScroll={true} trigger={<a id ='sevenk' title={averageSP32} className='awater64' href='#/sevenk' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1210px' }}></a>}
  position='center' modal nested>
{close => (
  ...
  <Popup lockScroll={true} trigger={<a id ='sevenfivek21' title={averageSP29} className='awater64' href='#/sevenfivek21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1285px' }}></a>}
  position='center' modal nested>
{close => (
   ...
   <Popup lockScroll={true} trigger={<a id ='sevenfivek' title={averageSP33} className='awater64' href='#/sevenfivek' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1285px' }}></a>}
   position='center' modal nested>
 {close => (
...
onChange={(e) => setPricerangetown1(e.target.value)}>
  ...
  {availableTowns2?.towns.map((e, key) => {
   ...
   <br/>
         ...
         <a></a>
         <Popup lockScroll={true} trigger={<a id='quarterly' title={averageSP22} className='awater64' href='#/quarterly' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1806px' }} ></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '310px', top: '1781px' }}>belowList rate</div>
         <Popup lockScroll={true} trigger={<a id='catchmaxmil' className='awater64' title={popquoteJan} href='#/catchmaxmil' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1806px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <div id='lordof2' title={averageSP22} className='awater64' style={{zIndex: '7', position: 'absolute', left: '450px', top: '1806px' }}></div>
        ...
        <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '75px', top: '1856px' }}>4/1/2021 - 6/30/2021:</div>
         <a></a>
         <Popup lockScroll={true} trigger={<a id='quarterly21' title={averageSP23} className='awater64' href='#/quarterly21' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1856px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <Popup lockScroll={true} trigger={<a id='catchmaxmil21' className='awater64' title={popquoteApril} href='#/catchmaxmil21'  style={{zIndex: '7', position: 'absolute', left: '350px', top: '1856px' }} ></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <Popup lockScroll={true} trigger={<a id='quarterly20' title={averageSP24} className='awater64' href='#/quarterly20' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1906px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <Popup lockScroll={true} trigger={<a id='catchmaxmil20' className='awater64' title={popquoteJuly} href='#/catchmaxmil20' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1906px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <div ></div>
         <a></a>
         <div id='lordof20' title={averageSP24} className='awater64' style={{zIndex: '7', position: 'absolute', left: '450px', top: '1906px' }}></div>
         ...
         <a></a>
         <Popup lockScroll={true} trigger={<a id='quarterly19' title={averageSP25} className='awater64' href='#/quarterly19' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1956px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <Popup lockScroll={true} trigger={<a id='catchmaxmil19' className='awater64' title={popquoteOctober} href='#/catchmaxmil19' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1956px' }} ></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
         ...
         <a></a>
         <div id='lordof211' title={averageSP25} className='awater64' style={{zIndex: '7', position: 'absolute', left: '450px', top: '1956px' }}></div>
         <div id='sultan211' className='awater64' style={{zIndex: '7', position: 'absolute', left: '550px', top: '1956px' }}></div>
         <br/>
         <br/>
         <br/>

         <a id='townhash' className='hashh64'  style={{zIndex: '7', position: 'absolute', left: '41px', top: '915px' }} href='#mozart'>Business Planning</a>
     ...
     <h5 className='awater64' style={{zIndex: '7', position: 'absolute', left: '731px', top: '915px'}}>Previous 5 Month Market Condition Sales 2022</h5>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1000px' }}>0-30 days</a>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='s14' title={averageSPfm} className='a1water64' href='#/s14' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1000px' }} ></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r14' title={totallessdiff14} href='#/r14' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1000px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <br/>
         <br/>
   <Popup lockScroll={true} trigger={<a id ='s30' title={averageSP2fm} className='a1water64' href='#/s30' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1050px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1050px' }}>31-60 days</a>
         <a></a>
          <a></a>
         <div id='fr30' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1050px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='r30' title={totallessdiff30} href='#/r30' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1050px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='d30' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1050px' }}></div>
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1100px' }}>61-90 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='s45' title={averageSP3fm} className='a1water64' href='#/s45' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1100px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fr45' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1100px' }}></div>
         <a></a> 
  <Popup lockScroll={true} trigger={<a id='r45' title={totallessdiff45} href='#/r45' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1100px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='d45' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1100px' }}></div>
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1150px' }}>91-120 days</a>
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='s90' title={averageSP4fm} className='a1water64' href='#/s90' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1150px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fr90' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1150px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='r90' title={totallessdiff90} href='#/r90' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1150px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='d90' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1150px' }}></div>
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1200px' }}>121-180 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s120' title={averageSP5fm} className='a1water64' href='#/s120' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1200px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fr120' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1200px' }}></div>
         <a></a>
         <Popup lockScroll={true} trigger={<a id='r120' title={totallessdiff120} href='#/r120' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1200px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='d120' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1200px' }}></div>
         <br/>
         <br/>
         <a className='fontwater64' id='matchesmaloneinf' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1250px' }}>181-240 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s121' title={averageSP6fm} className='a1water64' href='#/s121' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1250px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fr121' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1250px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r121' title={totallessdiff121} href='#/r121' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1250px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='d121' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1250px' }}></div>
         <br/>
         <a className='fontwater64' id='matchesmaloneinf' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1300px' }}>241-300 days</a>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='s240' title={averageSP7fm} className='a1water64' href='#/s240' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1300px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fr240' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1300px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r240' title={totallessdiff240} href='#/r240' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1300px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='d240' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1300px' }}></div>
         <br/>
         <a className='fontwater64' id='matchesmaloneinf' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1350px' }}>301+ days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s301' title={averageSP8fm} className='a1water64' href='#/s301' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1350px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fr301' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1350px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r301' title={totallessdiff301} href='#/r301' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1350px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='d301' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1350px' }}></div>
         <br/>
     <br/>
  ...
  {availableTowns3?.towns.map((e, key) => {
    return (
     ...
     <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1575px' }}>0-14 days</a>
         ...
         <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '936px', top: '1550px' }}>belowList rate</div>
         <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1115px', top: '1550px' }}>differential</div>
  <Popup lockScroll={true} trigger={<a id ='sales14' title={averageSP16am} className='a1water64' href='#/sales14' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1575px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id='rates14' title={belowdiffrates14avg} href='#/rates14' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1575px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1625px' }}>31-60 days</a>
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='sales30' title={averageSP17am} className='a1water64' href='#/sales30' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1625px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fraction30' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1625px' }}></div>
         <a></a>
  <Popup lockScroll={true} trigger={<a id='rates30' title={belowdiffrates30avg} href='#/rates30' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1625px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='duff30' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1625px' }}></div>
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1675px' }}>61-90 days</a>
         <a></a>
  <Popup lockScroll={true} trigger={ <a id ='sales45' title={averageSP18am} className='a1water64' href='#/sales45' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1675px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fraction45' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1675px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates45' title={belowdiffrates45avg} href='#/rates45' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1675px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='duff45' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1675px' }}></div>
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1725px' }}>91-120 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales90' title={averageSP19am} className='a1water64' href='#/sales90' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1725px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fraction90' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1725px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates90' title={belowdiffrates90avg} href='#/rates90' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1725px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='duff90' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1725px' }}></div>
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1775px' }}>121-180 days</a>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='sales120' title={averageSP20am} className='a1water64' href='#/sales120' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1775px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fraction120' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1775px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates120' title={belowdiffrates120avg} href='#/rates120' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1775px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='duff120' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1775px' }}></div>
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1825px' }}>181-240</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales121' title={averageSP21am} className='a1water64' href='#/sales121' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1825px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fraction121' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1825px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates121' title={belowdiffrates121avg} href='#/rates121' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1825px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='duff121' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1825px' }}></div>
         <br/>
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1875px' }}>241-300</a>
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='sales240' title={averageSP22am} className='a1water64' href='#/sales240' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1875px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fraction240' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1875px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates240' title={belowdiffrates240avg} href='#/rates240' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1875px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='duff240' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1875px' }}></div>
         <br/> 
         <br/>
         <br/>
         <a id='matchesmaloneinfin' className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1925px' }}>301+</a>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='sales301' title={averageSP23am} className='a1water64' href='#/sales301' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1925px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fraction301' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1925px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates301' title={belowdiffrates301avg} href='#/rates301' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1925px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='duff301' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1925px' }}></div>
         <br/>
  ...
  {availableTowns4?.towns.map((e, key) => {
    return (
      ...
      {e}
       ...
       <input style={{zIndex: '7', position: 'absolute', left: '100px', top: '2065px' }}type='number' onChange={(e)=> setPricevalue(e.target.value)}/>
       <input style={{zIndex: '7', position: 'absolute', left: '305px', top: '2065px' }}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
       <Button className='button64' style={{zIndex: '7', position: 'absolute', left: '510px', top: '2040px' }}variant='dark' type="button" value='Submit' onClick={marketANT}>Apply Science</Button>
         ...
         <div id='currentmonth1' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '300px', top: '2200px' }}></div>
         <div id='month1' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '300px', top: '2300px' }}></div>
         <h5 className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '500px', top: '2100px'}}>$July</h5>
         <div id='currentmonth2' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '500px', top: '2200px' }}></div>
         <div id='month2' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '500px', top: '2300px' }}></div>
         <h5 className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '2100px'}}>$August</h5>
         <div id='currentmonth3' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '2200px' }}></div>
         <div id='month3' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '700px', top: '2300px' }}></div>
         <h5 className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '900px', top: '2100px'}}>$September</h5>
         <div id='currentmonth4' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '900px', top: '2200px' }}></div>
         <div id='month4' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '900px', top: '2300px' }}></div>
   ...
   return (
     <option value={index}>
       ...
       <input style={{zIndex: '7', position: 'absolute', left: '305px', top: '2550px' }}type='number' onChange={(e)=> setPricevalue4(e.target.value)}/>
       <Button className='button64' style={{zIndex: '7', position: 'absolute', left: '510px', top: '2538px' }}variant='dark' type="button" value='Submit' onClick={()=> {businessplanning(); businessplanning21(); businessplanning20(); clearAvg5(); marketflush21();}}>Apply Science</Button>
       <Button className='buttonAVG' id='businessplanningavgs' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2650px' }} variant='dark' type="button" value='Submit' onClick={()=> {battingAvg5();}}>Show Averages</Button>
      <br/>
      <br/>
      <br/>
      <img style={{height: '1200px', width: '1180px', position: 'absolute', left: '75px', top: '2700px' }} src={capewater} alt='northcarolina'/>
       <h5 className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2600px'}}>#APPLYSCIENCE - Seller Agency Residential - 
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='planAsales' title={averageSP34} className='a1water64' href='#/planAsales' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2830px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planArate' title={belowdiffratesPlanAavg} href='/#planArate' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2830px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <br/>
         <a></a>
         <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '120px', top: '2880px' }}>$2021:</div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planAsales21' title={averageSP39} className='a1water64' href='#/planAsales21' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2880px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planArate21' title={belowdiffratesPlanA21avg} href='/#planArate21' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2880px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='planAsales20' title={averageSP44} className='a1water64' href='#/planAsales20' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2930px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id='planArate20' title={belowdiffratesPlanA20avg} href='/#planArate20' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2930px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planBsales' title={averageSP35} className='a1water64' href='#/planBsales' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2830px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planBrate' title={belowdiffratesPlanBavg} href='/#planBrate' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2830px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='planBsales21' title={averageSP40} className='a1water64' href='#/planBsales21' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2880px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planBrate21' title={belowdiffratesPlanB21avg} href='/#planBrate21' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2880px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='planBsales20' title={averageSP45} className='a1water64' href='#/planBsales20' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2930px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a  id='planBrate20' title={belowdiffratesPlanB20avg} href='/#planBrate20' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2930px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planCsales' title={averageSP36} className='a1water64' href='#/planCsales' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3175px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planCrate' title={belowdiffratesPlanCavg} href='/#planCrate' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3175px' }} ></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='planCsales21' title={averageSP41} className='a1water64' href='#/planCsales21' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3225px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id='planCrate21' title={belowdiffratesPlanC21avg} href='/#planCrate21' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3225px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planCsales20' title={averageSP46} className='a1water64' href='#/planCsales20' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3275px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planCrate20' title={belowdiffratesPlanC20avg} href='/#planCrate20' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3275px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='planDsales' title={averageSP37} className='a1water64' href='#/planDsales' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3175px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div ></div>
   <Popup lockScroll={true} trigger={<a id='planDrate' title={belowdiffratesPlanDavg} href='/#planDrate' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3175px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planDsales21' title={averageSP42} className='a1water64' href='#/planDsales21' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3225px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id='planDrate21' title={belowdiffratesPlanD21avg} href='/#planDrate21' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3225px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planDsales20' title={averageSP47} className='a1water64' href='#/planDsales20' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3275px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id='planDrate20' title={belowdiffratesPlanD20avg} href='/#planDrate20' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3275px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='planEsales' title={averageSP38} className='a1water64' href='#/planEsales' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3515px' }}></a>}
  position='center' modal nested>
{close => (
   ...
   <Popup lockScroll={true} trigger={<a id='planErate' title={belowdiffratesPlanEavg}  href='/#planErate'className='a1water64' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3515px' }} ></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planEsales21' title={averageSP43} className='a1water64' href='#/planEsales21' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3565px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id='planErate21' title={belowdiffratesPlanE21avg} href='/#planErate21' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3565px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='planEsales20' title={averageSP48} className='a1water64' href='#/planEsales20'  style={{zIndex: '7', position: 'absolute', left: '225px', top: '3615px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planErate20' title={belowdiffratesPlanE20avg} href='/#planErate20' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3615px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <br/>
         <br/>
     <h5 className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '880px', top: '3450px'}}>[180days 2021 bp]</h5>
     <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3510px' }}>0-30 days</a>
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='sales14flush' title={averageSP49} className='a1water64' href='#/sales14flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3510px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id='rates14flush' title={belowdiffratesMF14avg} href='/#rates14flush' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3510px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3560px' }}>31-60 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales30flush' title={averageSP50} className='a1water64' href='#/sales90flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3560px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates30flush' title={belowdiffratesMF30avg} href='/#rates30flush' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3560px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3610px' }}>61-90 days</a>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='sales45flush' title={averageSP51} className='a1water64' href='#/sales45flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3610px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates45flush' title={belowdiffratesMF45avg} href='/#rates45flush' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3610px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3660px' }}>91-120 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales90flush' title={averageSP52} className='a1water64' href='#/sales90flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3660px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates90flush' title={belowdiffratesMF90avg} href='/#rates90flush' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3660px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3710px' }}>121-180 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales120flush' title={averageSP53} className='a1water64' href='#/sales120flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3710px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates120flush' title={belowdiffratesMF120avg} href='/#rates120flush' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3710px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <br/>
         <br/>
         <a className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3760px' }}>181-240 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales121flush' title={averageSP54} className='a1water64' href='#/sales121flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3760px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates121flush' title={belowdiffratesMF121avg} href='/#rates121flush' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3760px' }}></a>}
   position='center' modal nested>
 {close => (
     ...
     export default CarappWaterFront;
