 ...
 */
  ...
  console.log(index22);
        ...
        const GLOBE1 = {
         states: [
          {name: 'FL', counties: [{name: 'Monroe', towns: ['Key West, FL', 'East']}, 
          {name: 'Newton', towns: [' West, FL', 'North']}]},
...
<div className='background64'>
   ...
   position='center' modal nested>
      ...
      <div className='bordermtgcalc'>
       ...
       <div className='divmtgcalc' style={{zIndex: '7', position: 'absolute', left: '6px', top: '150px' }}>
      <span className='spanmtgcalc'>Home Value $</span>
       ...
       <br/>
       <div style={{zIndex: '7', position: 'absolute', left: '6px', top: '200px' }}>
      <span className='spanmtgcalc' >Down Payments $</span>
       ...
       <br/>
       <div style={{zIndex: '7', position: 'absolute', left: '6px', top: '250px' }}>
      <span className='spanmtgcalc'>Loan Amount $</span>
       ...
       <br/>
       <div style={{zIndex: '7', position: 'absolute', left: '6px', top: '300px' }}>
      <span className='spanmtgcalc'>Interest Rate %</span>
       ...
       <br/>
       <div style={{zIndex: '7', position: 'absolute', left: '6px', top: '350px' }}>
       ...
       <input className='inputmtgcalc' style={{zIndex: '7', position: 'absolute', left: '150px'}} placeholder="Enter loan duration (yrs)" type='number' value={loanDuration} onInput={(e) => setLoanDuration(e.target.value)} />
        ...
        <h4 className='hmtgcalc' style={{zIndex: '7', position: 'absolute', left: '6px', top: '415px' }}>Monthy Payment: ${parseFloat(monthlyPayment.toFixed(2))}</h4>
        <button
   ...
   <div className='hashh66'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Active</div>
     ...
     <select style={{zIndex: '7', position: 'absolute', left: '45px', top: '591px' }}
                 ...
                 <select style={{zIndex: '7', position: 'absolute', left: '45px', top: '631px' }}
                  ...
                  <input value={pricevalue} className='inputbat' style={{zIndex: '7', position: 'absolute', left: '540px', top: '611px'}} type='number' onChange={(e)=> setPricevalue(e.target.value)}/> 
     <input value={pricevalue2} className='inputbat' style={{zIndex: '7', position: 'absolute', left: '740px', top: '611px'}}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
     <Button id='benjamin' className='button' style={{zIndex: '7', position: 'absolute', left: '948px', top: '595px'}} variant='dark' type="button" value='Submit' onClick={()=> {ActivePopulateQuote();  ActivePopulateQuoteBeds(); NoPlaceLikeHome(); Toto(); brucewayne21a(); brucewayne21b();}}>Apply Science</Button>
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData7}
                 ...
                 <Button id='benjamin' className='button' style={{zIndex: '7', position: 'absolute', left: '199px', top: '595px'}} variant='dark' type="button" value='Submit' onClick={()=> {ghostreconcampaign(); brucewayne22a(); brucewayne22b(); }}>Apply Science</Button>
...
{close => (
         ...
         <ReactPaginate
           ...
           {currentPageData18}
                 ...
                 <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1086px', top: '1026px' }}>______________</div>
                      ...
                      <img style={{height: '390px', width: '1294px', position: 'absolute', top: '2195px' }} src={pixa} alt='pixa'/>
     ...
     <br/>
         ...
         <input value={pricevalue} className='inputbat' style={{zIndex: '7', position: 'absolute', left: '325px', top: '1150px'}} type='number' onChange={(e)=> setPricevalue(e.target.value)}/> 
         <input value={pricevalue2} className='inputbat' style={{zIndex: '7', position: 'absolute', left: '780px', top: '1150px'}}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
         <Button id='benjamin2' className='buttonAVGsuburb' style={{zIndex: '7', position: 'absolute', left: '1010px', top: '1125px'}} variant='dark' type="button" value='Submit' onClick={()=> {ActivePopulateQuote();  ActivePopulateQuoteBeds(); NoPlaceLikeHome(); Toto(); brucewayne21a(); brucewayne21b();}}>Apply Science</Button>
     ...
     <div id='noplacelikehome' onClick={() => freezeBackground} className='listpricediv' style={{zIndex: '7', position: 'absolute', left: '8px', top: '1171px' }}>
     {julius.map((item) => 
...
<a id='toggle' className='listpricetext64'>{formatter.format(item.listprice)}</a> 
  ...
  <td>{item.bedrooms} bds {item.bathrooms} ba  {item.livingArea} sqft</td>
     ...
     <div id='toto' onClick={() => freezeBackground} className='listpricediv' style={{zIndex: '7', position: 'absolute', left: '1005px', top: '1171px' }}>
     {caesar.map((item) => 
