...
//import WindowReactApp from './WindowReactApp.png';
...
//import htmlContent from './profile.html';
 ...
 */
  ...
  console.log(index22);
        ...
        {name: 'CA', counties: [{name: 'Orange', towns: ['Laguna Beach, CA']}]},
              ...
              //   propertyT.push(data[i]);
               //  console.log(propertyT)
                ...
                // console.log(a);
                 ...
                 // console.log(a);
                  for (let i = 0; i < data.length; i++) {
                   if (data[i].propertytype === 'SINGLE_FAMILY'){
                    propertyT.push(data[i]);
                    console.log(propertyT)
                   } 
                  }
   ...
   const popup = new mapboxgl.Popup({
     ...
     closeOnClick: false
         ...
         for (const marker of myGeoJSONData.features) {
           ...
           const height = '30px';
           el.className = 'marker';
           el.innerHTML = `<div style={{background-color: rgb(106,106,106)}}>${marker.properties.listprice}</div>`
           el.style.backgroundImage = `${marker.properties.listprice}`;
           el.style.width = `${width}px`;
           el.style.height = `${height}px`;
           el.style.color = 'rgb(106,106,106)';
 ...
 React.useEffect(() => { //
  ...
  .then(data => {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      const spread = [...data];
      console.log(a);
      if (data[i].status === 'FOR_SALE' && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" && data[i].propertytype === 'SINGLE_FAMILY'){
        sales.push(data[i]);
        //console.log(sales);
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
          <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-125px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
          <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-220px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>  
<br/>
       <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
...
<br/>
  ...
  // <label style={{zIndex: '7', position: 'absolute', left: '1150px', top: '1125px'}}><input type='checkbox' checked={checked} />Pool </label> 
  ...
  for (let i = 0; i<data.length; i++){
    if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].listprice >= `${pricevalue}` && data[i].listprice < `${pricevalue2}` && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" ){
      sales.push(data[i]);
          ...
          setChecked(!checked);
          if(checked){
            sales.filter((sales) => sales.description.match('pool') || sales.description.match('Panoramic'));
            setJulius([...sales]); 
     ...
     /// setJulius(filters.indexOf(document.getElementById('toggle')).splice(filters.indexOf(document.getElementById('toggle')),1));
      ...
      const variable3 = variable1.filter((variable1) => variable1.description.match('pool') || variable1.description.match('Panoramic'));
...
async function Toto(e){ //this functions onClick...
 ...
 //const status  = document.getElementById('toto');
   ...
   /////////////////////////////////hover functionality////////////////////////////////////////////////
       ...
       return (<>
<body id='activebody'onClick={UNfreezeBackground}>
<div id='DKre' className='background64'>
   ...
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={multifam} alt='math' />
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='#benjamin2'>MAP</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/singlefamily">Seller</a>
   ...
   <div className='hashh66'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Active</div>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/activewatersinglefamily'>WaterFront</a>
     ...
     <div>
        ...
        <li style={{zIndex: '7', position: 'absolute', left: '1175px', top: '410px' }}>       
        </li>
        
         </ul>
         </div>
        
     <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '1780px' }} href='#imme'>Active Listings Search</a>
     <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '1800px' }} href='#benjamin2'>Mapping</a>
     <div id='imme' className='activetitle' style={{zIndex: '7', position: 'absolute', left: '395px', top: '511px' }}>Active Single Family</div>
     <div className='hashh' style={{zIndex: '7', position: 'absolute', left: '995px', top: '545px' }}>***Click numbers to view Listings</div>
  <select style={{zIndex: '7', position: 'absolute', left: '45px', top: '591px' }}
                 ...
                 <select style={{zIndex: '7', position: 'absolute', left: '45px', top: '631px' }}
                  ...
                  <input className='inputbat' value={pricevalue} style={{zIndex: '7', position: 'absolute', left: '540px', top: '611px'}} type='number' onChange={(e)=> setPricevalue(e.target.value)}/> 
     <input className='inputbat' value={pricevalue2} style={{zIndex: '7', position: 'absolute', left: '740px', top: '611px'}}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
   ...
   <Popup lockScroll={true} trigger={<a id ='threek' title={listratesPlanAavg} href='#/threek' className='awater' style={{zIndex: '7', position: 'absolute', left: '185px', top: '720px' }}></a>}
   position='center' modal nested>
 {close => (
   ...
   <Popup lockScroll={true} trigger={<a id ='fourk' title={listratesPlanBavg} href='#/fourk' className='awater' style={{zIndex: '7', position: 'absolute', left: '185px', top: '796px' }}></a>}
   position='center' modal nested>
 {close => (
     ...
     <Popup lockScroll={true} trigger={<a id ='sevenk' title={listratesPlanCavg} className='awater' href='#/sevenk' style={{zIndex: '7', position: 'absolute', left: '185px', top: '871px' }}></a>}
     position='center' modal nested>
   {close => (
   ...
   <Popup lockScroll={true} trigger={<a id ='sevenfivek' title={listratesPlanDavg} href='#/sevenfivek' className='awater' style={{zIndex: '7', position: 'absolute', left: '185px', top: '946px'}} ></a>}
   position='center' modal nested>
 {close => (
...
{GLOBE1.states.map((value, key) => {
       ...
       <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '663px', top: '642px' }}># Listings</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '793px', top: '642px' }}>% Total Market</div>
                          ...
                          <a></a>                       
                           <Popup lockScroll={true} trigger={<a id='s14'  href='#/s14' title={avgdomPlanAavg} className='a1water' style={{zIndex: '7', position: 'absolute', left: '690px', top: '671px' }}></a>}
                           position='center' modal nested>
                         {close => (
                      ...
                      <a></a>
                          ...
                          <Popup lockScroll={true} trigger={ <a id='r14' title={belowdiffratesPlanAavg}  href='#/r14' className='a1water' style={{zIndex: '7', position: 'absolute', left: '842px', top: '671px' }}></a>}
                           position='center' modal nested>
                         {close => (
                          ...
                          <a></a>
   <Popup lockScroll={true} trigger={<a id='s30' title={avgdomPlanBavg} href='#/s30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '690px', top: '746px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData9}
                          ...
                          <Popup lockScroll={true} trigger={ <a id='r30' title={belowdiffratesPlanBavg}  href='#/r30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '842px', top: '746px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData9}
                          ...
                          <a></a>
  <Popup lockScroll={true} trigger={<a id='s45' href='#/s45' title={avgdomPlanCavg} className='a1water' style={{zIndex: '7', position: 'absolute', left: '690px', top: '821px' }}></a>}
  position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData10}
                          ...
                          <Popup lockScroll={true} trigger={<a id='r45' title={belowdiffratesPlanCavg}  href='#/r45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '842px', top: '821px' }}></a>  }
  position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData10}
                          ...
                          <a></a>
  <Popup lockScroll={true} trigger={<a id='s90' title={avgdomPlanDavg} href='#/s90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '690px', top: '896px' }}></a>}
  position='center' modal nested>
{close => (
         ...
         <ReactPaginate
           ...
           {currentPageData11}
                         ...
                         <a></a>
                          ...
                          <Popup lockScroll={true} trigger={ <a id='r90' title={belowdiffratesPlanDavg}  href='#/r90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '842px', top: '896px' }}></a>}
  position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData11}
                          ...
                          <a></a>
   <Popup lockScroll={true} trigger={<a id='s120' href='#/s120' title={avgdomPlanEavg} className='a1water' style={{zIndex: '7', position: 'absolute', left: '690px', top: '971px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
           ...
           <a></a>
                          ...
                          <Popup lockScroll={true} trigger={ <a id='r120' title={belowdiffratesPlanEavg}  href='#/r120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '842px', top: '971px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData12}
                          ...
                          <a></a>
   <Popup lockScroll={true} trigger={<a id='s121' title={avgdomPlanFavg} href='#/s121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '690px', top: '1046px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData13}
                          ...
                          <Popup lockScroll={true} trigger={ <a id='r121' title={belowdiffratesPlanFavg}  href='#/r121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '842px', top: '1046px' }}></a>}
   position='center' modal nested>
 {close => (
...
{close => (
         ...
         <ReactPaginate
           ...
           {currentPageData18}
                 ...
                 <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1086px', top: '1026px' }}>______________</div>
                      ...
                      <img style={{height: '390px', width: '1283px', position: 'absolute', top: '2195px' }} src={pixa} alt='pixa'/>
     ...
     <br/>
         ...
         <input className='inputbat' value={pricevalue} style={{zIndex: '7', position: 'absolute', left: '325px', top: '1150px'}} type='number' onChange={(e)=> setPricevalue(e.target.value)}/>  
         <input className='inputbat' value={pricevalue2} style={{zIndex: '7', position: 'absolute', left: '780px', top: '1150px'}}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
         <Button id='benjamin2' className='buttonAVGsuburb' style={{zIndex: '7', position: 'absolute', left: '1010px', top: '1125px'}} variant='dark' type="button" value='Submit' onClick={()=> {ActivePopulateQuote();  ActivePopulateQuoteBeds(); NoPlaceLikeHome(); Toto();}}>Apply Science</Button>
        
         <a className='hashh'  id='prevmrkthist' style={{zIndex: '7', position: 'absolute', left: '72px', top: '1125px' }} href='#geocoder'>Previous Market History</a>
     <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '1145px' }} href='#imme'>Active Listings Search</a>
...
<div id='noplacelikehome' onClick={() => freezeBackground} className='listpricediv' style={{zIndex: '7', position: 'absolute', left: '15px', top: '1171px' }}>
     {julius.map((item) => 
      
     

<div className='listprice64' tabindex='0'>  
...
<a id='toggle' className='listpricetext64'>{formatter.format(item.listprice)}</a> 
  <td>{item.streetAddress}</td> 
  <br/>
  <td>{item.townstate} {item.zipcode}</td><br/>
  <td>{item.bedrooms} bds {item.bathrooms} ba  {item.livingArea} sqft</td>
     ...
     <div id='toto' onClick={() => freezeBackground} className='listpricediv' style={{zIndex: '7', position: 'absolute', left: '998px', top: '1171px' }}>
     {caesar.map((item) => 
...
<div itemsPerRow={3} className='autoy' style={{ marginTop: 20 }}>
                    ...
                    filteredResults.map((item) => {
                        return (
                            <div>
                                ...
                                <Popup
      trigger={<div className='inputbatactives'>{item.streetAddress}, {item.townstate}, {item.zipcode} </div>}
      position="center"
      modal
      nested 
      lockScroll={true}    
  ...
  <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '532px' }} href='#geocoder'>Previous Market History</a>
     <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '552px' }} href='#benjamin2'>Mapping</a>
     </div>
     <div className='waterbackgroundactive'></div>
   ...
   <br/>
   <br/>
   <Popup lockScroll={true} trigger={<a id ='inject' className='awater' href='#/inject' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1894px' }}></a>}
   position='center' modal nested>
{close => (
   ...
   <div  className='fontwater' style={{zIndex: '7', position: 'absolute', left: '990px', top: '1984px' }}>Avg. List___________</div>
    <Popup lockScroll={true} trigger={<a id ='threebears'  title={titleavgdiff} className='awater' href='#/threebears' style={{zIndex: '7', position: 'absolute', left: '820px', top: '2046px' }}></a>}
    position='center' modal nested>
 {close => (
  ...
  <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '2059px' }}>sale price rate_____________</div> 
   ...
   <br/>
   <br/>
   <Popup lockScroll={true} trigger={<a id='inject21' className='awater' href='#/inject21' style={{zIndex: '7', position: 'absolute', left: '215px', top: '1894px' }}></a>}
   position='center' modal nested>
{close => (
  ...
  <Popup lockScroll={true} trigger={<a id ='threebears21' title={titleavgdiff2} href='#/threebears21' className='awater' style={{zIndex: '7', position: 'absolute', left: '215px', top: '2046px' }}></a>}
    position='center' modal nested>
{close => (
