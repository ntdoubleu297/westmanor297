...
<div className='background64ctg'>
  ...
  <select style={{zIndex: '7', position: 'absolute', left: '45px', top: '591px' }}
      ...
      <input value={pricevalue} className='input' style={{zIndex: '7', position: 'absolute', left: '540px', top: '611px'}} type='number' onChange={(e)=> setPricevalue(e.target.value)}/> 
     <input value={pricevalue2} className='input' style={{zIndex: '7', position: 'absolute', left: '740px', top: '611px'}}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
...
{close => (
         ...
         <ReactPaginate
           ...
           {currentPageData18}
                 ...
                 <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1086px', top: '1026px' }}>______________</div>
                      ...
                      <img style={{height: '375px', width: '1294px', position: 'absolute', top: '2195px' }} src={hottubbubblezzz} alt='pixa'/>
     ...
     <br/>
         ...
         <input value={pricevalue} className='input' style={{zIndex: '7', position: 'absolute', left: '325px', top: '1150px'}} type='number' onChange={(e)=> setPricevalue(e.target.value)}/> 
         <input value={pricevalue2} className='input' style={{zIndex: '7', position: 'absolute', left: '780px', top: '1150px'}}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
