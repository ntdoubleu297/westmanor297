import React from "react";
  ...
  // import'./alldata.css';
   ...
   import sanfran from './sanfrancom.jpg';
   import northcarolina from './MIT.png';
...
import capesub from './capesub.png';
   ...
   function ApplyScience(){
    ...
    {name: 'Worcester', 
    towns: ['Ashburnham, MA', 'Athol, MA',  'Auburn, MA',  'Barre, MA',  'Berlin, MA', 'Blackstone, MA',  'Bolton, MA', 'Boylston, MA',  'Brookfield, MA', 'Charlton, MA', 'Clinton, MA', 'Devens, MA', 'Douglas, MA',  'Dudley, MA', 'East Brookfield, MA', 'Fitchburg, MA', 'Gardner, MA', 'Grafton, MA',  'Hardwick, MA', 'Harvard, MA', 'Holden, MA', 'Hopedale, MA', 'Hubbardston, MA', 'Lancaster, MA', 'Leicester, MA',  'Leominster, MA',  'Lunenburg, MA', 'Mendon, MA', 'Milford, MA',  'Millbury, MA', 'Millville, MA', 'New Braintree, MA', 'North Brookfield, MA', 'Northborough, MA',  'Northbridge, MA', 'Oakham, MA',  'Oxford, MA', 'Paxton, MA', 'Petersham, MA', 'Phillipston, MA',  'Princeton, MA',  'Royalston, MA',  'Rutland, MA',  'Shrewsbury, MA',  'Southborough, MA', 'Southbridge, MA', 'Spencer, MA', 'Sterling, MA', 'Sturbridge, MA',  'Sutton, MA',  'Templeton, MA', 'Upton, MA',  'Uxbridge, MA',  'Warren, MA',  'Webster, MA',  'West Boylston, MA', 'West Brookfield, MA', 'Westborough, MA', 'Westminster, MA',  'Winchendon, MA', 'Worcester, MA']
    },
    {name: 'Plymouth', 
    towns: ['Abington, MA', 'Bridgewater, MA', 'Brockton, MA', 'Carver, MA',  'Duxbury, MA',  'East Bridgewater, MA', 'Halifax, MA',  'Hanover, MA', 'Hanson, MA', 'Hingham, MA',  'Hull, MA', 'Kingston, MA',  'Lakeville, MA',  'Marion, MA',  'Marshfield, MA', 'Mattapoisett, MA', 'Middleboro, MA',  'Norwell, MA',  'Pembroke, MA', 'Plymouth, MA',  'Plympton, MA', 'Rochester, MA', 'Rockland, MA', 'Scituate, MA', 'Wareham, MA', 'West Bridgewater, MA', 'Whitman, MA']
    },
    {name: 'Suffolk', 
    towns: ['Boston, MA', 'Chelsea, MA', 'Revere, MA', 'Winthrop, MA']
    },
    {name: 'Bristol', 
    towns: ['Acushnet, MA', 'Attleboro, MA', 'Berkley, MA', 'Dartmouth, MA',  'Dighton, MA',  'Easton, MA', 'Fairhaven, MA', 'Fall River, MA', 'Freetown, MA', 'Mansfield, MA', 'New Bedford, MA', 'North Attleboro, MA', 'Norton, MA', 'Raynham, MA', 'Rehoboth, MA', 'Seekonk, MA', 'Somerset, MA',  'Swansea, MA', 'Taunton, MA', 'Westport, MA']
    },
    {name: 'Barnstable', 
    towns: ['Barnstable, MA',  'Bourne, MA', 'Brewster, MA',  'Chatham, MA',  'Dennis, MA',  'Eastham, MA',  'Falmouth, MA', 'Harwich, MA',  'Mashpee, MA', 'Orleans, MA', 'Provincetown, MA', 'Sandwich, MA',  'Truro, MA', 'Wellfleet, MA',  'Yarmouth, MA']
    },
    {name: 'Hampden', 
    towns: ['Agawam, MA',  'Blandford, MA', 'Brimfield, MA', 'Chester, MA',  'Chicopee, MA',  'East Longmeadow, MA', 'Granville, MA', 'Hampden, MA', 'Holland, MA', 'Holyoke, MA', 'Longmeadow, MA', 'Ludlow, MA',  'Monson, MA',  'Montgomery, MA', 'Palmer, MA', 'Russell, MA', 'Southwick, MA', 'Springfield, MA', 'Westfield, MA', 'Wilbraham, MA']
    },
    {name: 'Hampshire', 
    towns: ['Amherst, MA',  'Belchertown, MA',  'Chesterfield, MA', 'Cummington, MA', 'Easthampton, MA',  'Goshen, MA', 'Granby, MA',  'Hadley, MA',  'Hatfield, MA', 'Huntington, MA',  'Middlefield, MA', 'Northampton, MA', 'Pelham, MA',  'Plainfield, MA',  'South Hadley, MA', 'Southampton, MA', 'Ware, MA', 'Westhampton, MA', 'Williamsburg, MA', 'Worthington, MA']
    },
    {name: 'Dukes', 
    towns: ['Aquinnah, MA',  'Chilmark, MA',  'Edgartown, MA', 'Gosnold, MA',  'Oak Bluffs, MA', 'Tisbury, MA']
    },
    {name: 'Franklin', 
    towns: ['Ashfield, MA', 'Bernardston, MA', 'Buckland, MA', 'Charlemont, MA', 'Colrain, MA', 'Conway, MA', 'Deerfield, MA', 'Erving, MA; Gill, MA',  'Greenfield, MA',  'Hawley, MA',  'Heath, MA',  'Leverett, MA', 'Leyden, MA',  'Monroe, MA',  'Montague, MA',  'New Salem, MA', 'Northfield, MA', 'Orange, MA', 'Rowe, MA',  'Shelburne, MA', 'Shutesbury, MA',  'Sunderland, MA',  'Warwick, MA',  'Wendell, MA', 'Whately, MA']
    }
...
const availableState = GLOBE.states.find((s) => s.name === selectedState); // that is what this says...
const availableTowns = availableState?.counties?.find( //
  (c) => c.name === selectedCounty //
   ...
   firstopenarray.unshift(index22.splice(index22.indexOf(index22[i]), 153));
  ...
  {name: 'FL', counties: [{name: 'Hillsborough', towns: ['Tampa, FL']}]},
  {name: 'HI', counties: [{name: 'Kauai', towns: ['Kalaheo, HI']}]}
]
  };  
...
const availableState1 = GLOBE1.states.find((s) => s.name === selectedState1); // that is what this says...
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
      <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-31px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
      <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-96px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
...
const currentPageData2 = norfolkcountygreat22
...
<br/>
 ...
 const pageCount2 = Math.ceil(norfolkcountygreat22.length / PER_PAGE);  
...
//  firstdateIndex();
  ...
  //[[h'ttps://serverwestdeploy.herokuapp.com/prototypeJS
  ...
  const req = await fetch('https://jungleebook297-e68d158789dd.herokuapp.com/prototypeJS', {mode: 'cors'})
   ...
   // let newArray = [...firstopenarray];
    ...
    for (let i = 0; i<data.length; i++){
      if ((data[i].year === 2022 && data[i].county === `${county}` && data[i].townstate === `${towntop}` && data[i].saleprice > `${price1}` && data[i].saleprice < `${price2}`) && data[i].listprice !=='AUCTION' && data[i].differenial !== "#VALUE!" && (data[i].saledate ==='1/1/2022' || data[i].saledate ==='1/2/2022' || data[i].saledate ==='1/3/2022' || data[i].saledate ==='1/4/2022' || data[i].saledate ==='1/5/2022' || data[i].saledate ==='1/6/2022' || data[i].saledate ==='1/7/2022' || data[i].saledate ==='1/8/2022' || data[i].saledate ==='1/9/2022' || data[i].saledate ==='1/10/2022' || data[i].saledate ==='1/11/2022' || data[i].saledate ==='1/12/2022' || data[i].saledate ==='1/13/2022' || data[i].saledate ==='1/14/2022' || data[i].saledate ==='1/15/2022' || data[i].saledate ==='1/16/2022' || data[i].saledate ==='1/17/2022' || data[i].saledate ==='1/18/2022' || data[i].saledate ==='1/19/2022' || data[i].saledate ==='1/20/2022' || data[i].saledate ==='1/21/2022' || data[i].saledate ==='1/22/2022' || data[i].saledate ==='1/23/2022' || data[i].saledate ==='1/24/2022' || data[i].saledate ==='1/25/2022' || data[i].saledate ==='1/26/2022' || data[i].saledate ==='1/27/2022'|| data[i].saledate ==='1/28/2022'|| data[i].saledate ==='1/29/2022' || data[i].saledate ==='1/30/2022' || data[i].saledate ==='1/31/2022'
      ...
      || data[i].saledate === '5/29/2022' || data[i].saledate === '5/30/2022' || data[i].saledate ==='5/31/2022') ){
       ...
       norfolkcounty.sort((a, b) => b.saleprice - a.saleprice);
       setWestmanor(norfolkcounty);

       if (data[i].saleprice >= data[i].listprice){
        norfolkcountygreat.push(data[i]);
        norfolkcountygreat.sort((a, b) => b.saleprice - a.saleprice);
 ...
 const currentPageData4 = norfolkcountygreat21
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-60px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-135px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
  ...
  const pageCount4 = Math.ceil(norfolkcountygreat21.length / PER_PAGE);  
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   // firstdateIndex21();
    ...
    const req = await fetch('https://jungleebook297-e68d158789dd.herokuapp.com/prototypeJS', {mode: 'cors'})
     ...
     // let newArray = [...openarraytop21];
      ...
      let norfolkcountygreat = [];
      for (let i = 0; i<data.length; i++){
        if ((data[i].year === 2021 && data[i].county === `${county}` && data[i].townstate === `${towntop}` && data[i].saleprice > `${price1}` && data[i].saleprice < `${price2}`) && data[i].listprice !=='AUCTION' && data[i].differenial !== "#VALUE!" && (data[i].saledate ==='1/1/2021' || data[i].saledate ==='1/2/2021' || data[i].saledate ==='1/3/2021' || data[i].saledate ==='1/4/2021' || data[i].saledate ==='1/5/2021' || data[i].saledate ==='1/6/2021' || data[i].saledate ==='1/7/2021' || data[i].saledate ==='1/8/2021' || data[i].saledate ==='1/9/2021' || data[i].saledate ==='1/10/2021' || data[i].saledate ==='1/11/2021' || data[i].saledate ==='1/12/2021' || data[i].saledate ==='1/13/2021' || data[i].saledate ==='1/14/2021' || data[i].saledate ==='1/15/2021' || data[i].saledate ==='1/16/2021' || data[i].saledate ==='1/17/2021' || data[i].saledate ==='1/18/2021' || data[i].saledate ==='1/19/2021' || data[i].saledate ==='1/20/2021' || data[i].saledate ==='1/21/2021' || data[i].saledate ==='1/22/2021' || data[i].saledate ==='1/23/2021' || data[i].saledate ==='1/24/2021' || data[i].saledate ==='1/25/2021' || data[i].saledate ==='1/26/2021' || data[i].saledate ==='1/27/2021'|| data[i].saledate ==='1/28/2021'|| data[i].saledate ==='1/29/2021' || data[i].saledate ==='1/30/2021' || data[i].saledate ==='1/31/2021'
   ...
   const [threek13, setThreek13] = React.useState([]);
    ...
    const currentPageData6 = threek13
  ...
  <br/>
     ...
     const pageCount6 = Math.ceil(threek13.length / PER_PAGE);  
...
const currentPageData8 = fourk13
...
<br/>
 ...
 const pageCount8 = Math.ceil(fourk13.length / PER_PAGE);  
...
const currentPageData10 = sevenk13
...
<br/>
 ...
 const pageCount10 = Math.ceil(sevenk13.length / PER_PAGE);  
...
const currentPageData12 = sevenfivek13
...
<br/>
 ...
 const pageCount12 = Math.ceil(sevenfivek13.length / PER_PAGE);  


////////////////////////////////////////////////////////////////////////////////////////////////////////////


const [averageSP30, setAverageSP30] = React.useState(0);
const [averageSP31, setAverageSP31] = React.useState(0);
const [averageSP32, setAverageSP32] = React.useState(0);
const [averageSP33, setAverageSP33] = React.useState(0);
...
async function sealteam1(e){ 
  ...
  || data[i].saledate === '5/29/2022' || data[i].saledate === '5/30/2022' || data[i].saledate ==='5/31/2022') ){
       ...
       if (data[i].saleprice > 100000 && data[i].saleprice <= 349999){
         threek.push(data[i]);
         threek.sort((a, b) => b.saleprice - a.saleprice);
         setThreek13(threek);
         threekAP.push(data[i]);
       }
       if (data[i].saleprice > 349999 && data[i].saleprice <= 499999){
         fourk.push(data[i]);
         fourk.sort((a, b) => b.saleprice - a.saleprice);
         setFourk13(fourk);
         fourkAP.push(data[i]);
       }
       if (data[i].saleprice > 499999 && data[i].saleprice <= 749999){
         sevenk.push(data[i]);
         sevenk.sort((a, b) => b.saleprice - a.saleprice);
         setSevenk13(sevenk);
         sevenkAP.push(data[i]);
       }
       if (data[i].saleprice > 749999){
         sevenfivek.push(data[i]);
         sevenfivek.sort((a, b) => b.saleprice - a.saleprice);
         setSevenfivek13(sevenfivek);
         sevenfivekAP.push(data[i]);
       }
       ...
       function add5(item, counter, array){
        differential+=(item.saleprice);
       }
       
      threekAP.forEach(add5);

       let differential2 = 0
       function add6(item, counter, array){
        differential2+=(item.saleprice);
       }
       
       fourkAP.forEach(add6);

       let differential3 = 0
       function add7(item, counter, array){
        differential3+=(item.saleprice);
       }
       
       sevenkAP.forEach(add7);

       let differential4 = 0
       function add8(item, counter, array){
        differential4+=(item.saleprice);
       }
       
       sevenfivekAP.forEach(add8);
    ...
    setAverageSP30(formatter.format(Math.round( differential / sales3k ))); // title
    setAverageSP31(formatter.format(Math.round( differential2 / sales4k ))); // title
    setAverageSP32(formatter.format(Math.round( differential3 / sales7k ))); // title
    setAverageSP33(formatter.format(Math.round( differential4 / sales75k ))); // title
      ...
      function add4(item, counter, array){
        DOM4+=(item.DOM);//spot on excel
       }
      sevenfivek.forEach(add4);
...
const currentPageData9 = sevenk14
...
<br/>
 ...
 const pageCount9 = Math.ceil(sevenk14.length / PER_PAGE);  
...
const currentPageData11 = sevenfivek14
...
<br/>
 ...
 const pageCount11 = Math.ceil(sevenfivek14.length / PER_PAGE);  
...
const [averageSP26, setAverageSP26] = React.useState(0);
const [averageSP27, setAverageSP27] = React.useState(0);
const [averageSP28, setAverageSP28] = React.useState(0);
const [averageSP29, setAverageSP29] = React.useState(0);
 ...
 for (let i = 0; i<data.length; i++){
  ...
  || data[i].saledate === '5/29/2021' || data[i].saledate === '5/30/2021' || data[i].saledate ==='5/31/2021') ){
     ...
     if (data[i].saleprice > 100000 && data[i].saleprice <= 349999){
       ...
       threek21.sort((a, b) => b.saleprice - a.saleprice);
       setThreek14(threek21);
       threek21AP.push(data[i]);
     }
     if (data[i].saleprice > 349999 && data[i].saleprice <= 499999){
       fourk21.push(data[i]);
       fourk21.sort((a, b) => b.saleprice - a.saleprice);
       setFourk14(fourk21);
       fourk21AP.push(data[i]);
     }
     if (data[i].saleprice > 499999 && data[i].saleprice <= 749999){
       sevenk21.push(data[i]);
       sevenk21.sort((a, b) => b.saleprice - a.saleprice);
       setSevenk14(sevenk21);
       sevenk21AP.push(data[i]);
     }
     if (data[i].saleprice > 749999){
       sevenfivek21.push(data[i]);
       setSevenfivek14(sevenfivek21);
       sevenfivek21AP.push(data[i]);
     }
     ...
     let differential = 0
       ...
       threek21AP.forEach(add);
        ...
        document.getElementById('salesTpopulate21').innerHTML = `2021: ${sales21.length} Total Sales`;
     ...
     setAverageSP26(formatter.format(Math.round( differential / sales3k21 ))); // title
     setAverageSP27(formatter.format(Math.round( differential2 / sales4k21 ))); // title
     setAverageSP28(formatter.format(Math.round( differential3 / sales7k21 ))); // title
     setAverageSP29(formatter.format(Math.round( differential4 / sales75k21 ))); // title
...
const [currentPage90, setCurrentPage90] = React.useState(0);


function handlePageClick90({ selected: selectedPage}){
setCurrentPage90(selectedPage);
}




const offset90 = currentPage90 * PER_PAGE;

const currentPageData90 = lastyear
.slice(offset90, offset90 + PER_PAGE)
.map((item, index) => (
...
const pageCount90 = Math.ceil(lastyear.length / PER_PAGE); 
...
const [currentPage91, setCurrentPage91] = React.useState(0);


function handlePageClick91({ selected: selectedPage}){
setCurrentPage91(selectedPage);
}




const offset91 = currentPage91 * PER_PAGE;

const currentPageData91 = lastyear2
.slice(offset91, offset91 + PER_PAGE)
.map((item, index) => (
...
const pageCount91 = Math.ceil(lastyear2.length / PER_PAGE); 
 ...
 //  var [pricevalue, setPricevalue] = React.useState(0);
  // var [pricevalue2, setPricevalue2] = React.useState(0); 
   ...
   function entireArrayIndex(e){
    ...
    if (document.getElementById('datetopvalue').value === index22[i]){
    console.log(index22.indexOf(index22[i]));
    firstentirearray.unshift(index22.splice(index22.indexOf(index22[i]), 365));
    ...
    const [popquoteJan, setPopquoteJan] = React.useState(0);
        const [averageSP22, setAverageSP22] = React.useState(0);
         ...
         // entireArrayIndex(); // dont need
          ...
          for (let i = 0; i<data.length; i++){
            ...
            || data[i].saledate === '3/1/2021' || data[i].saledate ==='3/2/2021'|| data[i].saledate ==='3/3/2021' || data[i].saledate ==='3/4/2021' || data[i].saledate ==='3/5/2021' || data[i].saledate ==='3/6/2021' || data[i].saledate ==='3/7/2021' || data[i].saledate ==='3/8/2021' || data[i].saledate ==='3/9/2021'|| data[i].saledate ==='3/10/2021'|| data[i].saledate ==='3/11/2021' || data[i].saledate ==='3/12/2021'|| data[i].saledate === '3/13/2021'|| data[i].saledate ==='3/14/2021' || data[i].saledate ==='3/15/2021' || data[i].saledate ==='3/16/2021' || data[i].saledate ==='3/17/2021' || data[i].saledate ==='3/18/2021' || data[i].saledate ==='3/19/2021' || data[i].saledate ==='3/20/2021' || data[i].saledate ==='3/21/2021'|| data[i].saledate ==='3/22/2021' || data[i].saledate ==='3/23/2021' || data[i].saledate ==='3/24/2021' || data[i].saledate ==='3/25/2021' || data[i].saledate ==='3/26/2021' || data[i].saledate ==='3/27/2021'|| data[i].saledate ==='3/28/2021' || data[i].saledate ==='3/29/2021' || data[i].saledate ==='3/30/2021' || data[i].saledate ==='3/31/2021')){
              ...
              barnstablecounty.sort((a, b) => b.saleprice - a.saleprice);
              setLastyear(barnstablecounty);
              barnstablecountyAP.push(data[i]);
  
              if (data[i].saleprice >= data[i].listprice){
                great.push(data[i]);
                great.sort((a, b) => b.saleprice - a.saleprice);
                setLastyear2(great);
                //jconsole.log(great);
              }
           ...
           // let averagelist = Math.round(listprice / length);
            ...
            let differential2 = 0
             ...
             barnstablecountyAP.forEach(add3);
        ...
        setAverageSP22(formatter.format(Math.round( differential3 / length ))); // title
...
const [currentPage92, setCurrentPage92] = React.useState(0);


function handlePageClick92({ selected: selectedPage}){
setCurrentPage92(selectedPage);
}




const offset92 = currentPage92 * PER_PAGE;

const currentPageData92 = lastyear3
.slice(offset92, offset92 + PER_PAGE)
.map((item, index) => (
...
const pageCount92 = Math.ceil(lastyear3.length / PER_PAGE); 
...
const [currentPage93, setCurrentPage93] = React.useState(0);


function handlePageClick93({ selected: selectedPage}){
setCurrentPage93(selectedPage);
}




const offset93 = currentPage93 * PER_PAGE;

const currentPageData93 = lastyear4
.slice(offset93, offset93 + PER_PAGE)
.map((item, index) => (
...
const pageCount93 = Math.ceil(lastyear4.length / PER_PAGE); 
...
const [averageSP23, setAverageSP23] = React.useState(0);
  ...
  // entireArrayIndex(); doesnt fire here.....
   ...
   for (let i = 0; i<data.length; i++){
    ...
    // let averagelist = Math.round(listprice / length);
     ...
     let differential3 = 0;
     function add3(item, counter, array){
      differential3+=(item.saleprice); //NaN
     }
     barnstablecountyAP.forEach(add3);
    ...
    document.getElementById('sultan212').innerHTML = avgdom;
     ...
     setAverageSP23(formatter.format(Math.round( differential3 / length ))); // title
...
const [currentPage94, setCurrentPage94] = React.useState(0);
     
     
function handlePageClick94({ selected: selectedPage}){
  setCurrentPage94(selectedPage);
}




const offset94 = currentPage94 * PER_PAGE;

const currentPageData94 = lastyear5
.slice(offset94, offset94 + PER_PAGE)
.map((item, index) => (
...
const pageCount94 = Math.ceil(lastyear5.length / PER_PAGE); 
...
const [currentPage95, setCurrentPage95] = React.useState(0);
     
     
function handlePageClick95({ selected: selectedPage}){
  setCurrentPage95(selectedPage);
}




const offset95 = currentPage95 * PER_PAGE;

const currentPageData95 = lastyear6
.slice(offset95, offset95 + PER_PAGE)
.map((item, index) => (
...
const pageCount95 = Math.ceil(lastyear6.length / PER_PAGE); 
...
const [averageSP24, setAverageSP24] = React.useState(0);
       ...
       // entireArrayIndex(); doesnt fire here.....
        ...
        barnstablecountyAP.forEach(add3);
         ...
         document.getElementById('sultan20').innerHTML = avgdom;
          ...
          setAverageSP24(formatter.format(Math.round( differential3 / length ))); // title
...
const [currentPage96, setCurrentPage96] = React.useState(0);
 
 
function handlePageClick96({ selected: selectedPage}){
setCurrentPage96(selectedPage);
}




const offset96 = currentPage96 * PER_PAGE;

const currentPageData96 = lastyear7
.slice(offset96, offset96 + PER_PAGE)
.map((item, index) => (
...
const pageCount96 = Math.ceil(lastyear7.length / PER_PAGE); 
...
const [currentPage97, setCurrentPage97] = React.useState(0);
 
 
function handlePageClick97({ selected: selectedPage}){
setCurrentPage97(selectedPage);
}




const offset97 = currentPage97 * PER_PAGE;

const currentPageData97 = lastyear8
.slice(offset97, offset97 + PER_PAGE)
.map((item, index) => (
...
const pageCount97 = Math.ceil(lastyear8.length / PER_PAGE); 
...
const [averageSP25, setAverageSP25] = React.useState(0);
         ...
         // entireArrayIndex(); doesnt fire here.....
          ...
          for (let i = 0; i<data.length; i++){
           ...
           document.getElementById('sultan211').innerHTML = avgdom;
            ...
            setAverageSP25(formatter.format(Math.round( differential3 / length ))); // title
...
const currentPageData13 = fourteen12
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-31px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-279x', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
 ...
 const pageCount13 = Math.ceil(fourteen12.length / PER_PAGE);  
...
const currentPageData15 = thirty12
...
<br/>
 ...
 const pageCount15 = Math.ceil(thirty12.length / PER_PAGE);  
...
const currentPageData17 = fortyfive12
...
<br/>
 ...
 const pageCount17 = Math.ceil(fortyfive12.length / PER_PAGE);  
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
           ...
           const currentPageData19 = ninety12
...
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
            ...
            const pageCount19 = Math.ceil(ninety12.length / PER_PAGE);  
           ...
           const currentPageData21 = onetwenty12
...
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
            ...
            const pageCount21 = Math.ceil(onetwenty12.length / PER_PAGE);  
           ...
           const [onetwoone12, setOnetwoone12] = React.useState([]);
            ...
            const currentPageData23 = onetwoone12
          ...
          <br/>
             ...
             const pageCount23 = Math.ceil(onetwoone12.length / PER_PAGE);  
           ...
           // commercial render...
           const [twofourzero12, setTwofourzero12] = React.useState([]);
////pagination...
...
const currentPageData25 = twofourzero12
...
<br/>
 ...
 const pageCount25 = Math.ceil(twofourzero12.length / PER_PAGE);  


////////////////////////////////////////////////////////////////////////////////////////////////////////////


           const [threezeroone12, setThreezeroone12] = React.useState([]);
...
const currentPageData27 =threezeroone12
...
<br/>
 ...
 const pageCount27 = Math.ceil(threezeroone12.length / PER_PAGE);  
...
const currentPageData14 = fourteengreat14
...
<br/>
 ...
 const pageCount14 = Math.ceil(fourteengreat14.length / PER_PAGE);  
...
const currentPageData16 = thirtygreat30
...
<br/>
 ...
 const pageCount16 = Math.ceil(thirtygreat30.length / PER_PAGE);  
...
const currentPageData18 = fortyfivegreat45
...
<br/>
 ...
 const pageCount18 = Math.ceil(fortyfivegreat45.length / PER_PAGE);  
...
const currentPageData20 = ninetygreat90
...
<br/>
 ...
 const pageCount20 = Math.ceil(ninetygreat90.length / PER_PAGE);  
...
const currentPageData22 = onetwentygreat120
...
<br/>
 ...
 const pageCount22 = Math.ceil(onetwentygreat120.length / PER_PAGE);  
...
const currentPageData24 = onetwoonegreat121
...
<br/>
 ...
 const pageCount24 = Math.ceil(onetwoonegreat121.length / PER_PAGE);  
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
           ...
           //commercial render...
           const [onetwentygreat240, setOnetwentygreat240] = React.useState([]);

           ////pagination... twofourzero12
           ...
           const currentPageData26 = onetwentygreat240
...
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
            ...
            const pageCount26 = Math.ceil(onetwentygreat240.length / PER_PAGE);  
           
           
           ////////////////////////////////////////////////////////////////////////////////////////////////////////////


           const [onetwoonegreat301, setOnetwoonegreat301] = React.useState([]);
           ...
           const currentPageData28 = onetwoonegreat301
...
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
            ...
            const pageCount28 = Math.ceil(onetwoonegreat301.length / PER_PAGE);  
           
           
           ///////////////////////////////////////////////////////////////////////////////////////////////////////////

 const [averageSPfm, setAverageSPfm ] = React.useState(0); //titles *s14
 const [averageSP2fm, setAverageSP2fm ] = React.useState(0); //titles
 const [averageSP3fm, setAverageSP3fm ] = React.useState(0); //titles
 const [averageSP4fm, setAverageSP4fm ] = React.useState(0); //titles
 const [averageSP5fm, setAverageSP5fm ] = React.useState(0); //titles
 const [averageSP6fm, setAverageSP6fm ] = React.useState(0); //titles
 const [averageSP7fm, setAverageSP7fm ] = React.useState(0); //titles
 const [averageSP8fm, setAverageSP8fm ] = React.useState(0); //titles
           ...
           // entireArrayIndex(); doesnt fire here.....
            ...
            //commercial render...
            let twofourzerogreat = [];
            let threehundredonegreat = [];
            ...
            for (let i = 0; i<data.length; i++){
              if (data[i].county === `${pricerangecounty1}` && data[i].townstate === `${pricerangetown1}` && data[i].year === 2022 && data[i].listprice !=='AUCTION' && data[i].differenial !== "#VALUE!" ){
                ...
                if (data[i].DOM <= 30){
                  ...
                  fourteen.sort((a, b) => b.saleprice - a.saleprice);
                  fourteenASP.push(data[i]);
                  setFourteen12(fourteen);
                  //fourteen[i].differential
                 
                }
                if (data[i].DOM <= 30 && data[i].saleprice >= data[i].listprice){
                  fourteengreat.push(data[i]);
                  fourteengreat.sort((a, b) => b.saleprice - a.saleprice);
                  setFourteengreat14(fourteengreat);
                }
                if (data[i].DOM > 31 && data[i].DOM <= 60){
                  thirty.push(data[i]);
                  thirty.sort((a, b) => b.saleprice - a.saleprice);
                  thirtyASP.push(data[i]);
                  setThirty12(thirty);
                  
                }
                if (data[i].DOM > 31 && data[i].DOM <= 60 && data[i].saleprice >= data[i].listprice){
                  thirtygreat.push(data[i]);
                  thirtygreat.sort((a, b) => b.saleprice - a.saleprice);
                  setThirtygreat30(thirtygreat);
                }
                if (data[i].DOM > 61 && data[i].DOM <= 90){
                  fortyfive.push(data[i]);
                  fortyfive.sort((a, b) => b.saleprice - a.saleprice);
                  fortyfiveASP.push(data[i]);
                  setFortyfive12(fortyfive);
                  
                }
                if (data[i].DOM > 61 && data[i].DOM <= 90 && data[i].saleprice >= data[i].listprice){
                  fortyfivegreat.push(data[i]);
                  fortyfivegreat.sort((a, b) => b.saleprice - a.saleprice);
                ...
                if (data[i].DOM > 91 && data[i].DOM <= 120){
                  ninety.push(data[i]);
                  console.log(ninety);
                  ninety.sort((a, b) => b.saleprice - a.saleprice);
                  ninetyASP.push(data[i]);
                  setNinety12(ninety);
                  
                }
                if (data[i].DOM > 91 && data[i].DOM <= 120 && data[i].saleprice >= data[i].listprice){
                  ninetygreat.push(data[i]);
                  ninetygreat.sort((a, b) => b.saleprice - a.saleprice);
                  setNinetygreat90(ninetygreat);
                }
                if (data[i].DOM > 121 && data[i].DOM <= 180){
                  onetwenty.push(data[i]);
                  onetwenty.sort((a, b) => b.saleprice - a.saleprice);
                  onetwentyASP.push(data[i]);
                  setOnetwenty12(onetwenty);
                  
                }
                if (data[i].DOM > 121 && data[i].DOM <= 180 && data[i].saleprice >= data[i].listprice){
                  onetwentygreat.push(data[i]);
                  onetwentygreat.sort((a, b) => b.saleprice - a.saleprice);
                ...
                if (data[i].DOM > 181 && data[i].DOM <= 240){ // copy/paste residential render...
                  ...
                  onetwoone.sort((a, b) => b.saleprice - a.saleprice);
                  setOnetwoone12(onetwoone);
                  onetwooneASP.push(data[i]);
                }

                if (data[i].DOM > 181 && data[i].DOM <= 240 && data[i].saleprice >= data[i].listprice){
                  onetwoonegreat.push(data[i]);
                  onetwoonegreat.sort((a, b) => b.saleprice - a.saleprice);
                  setOnetwoonegreat121(onetwoonegreat);
                }

                if (data[i].DOM > 241 && data[i].DOM <= 300){ // commercial render...
                 twofourzero.push(data[i]);
                 twofourzero.sort((a, b) => b.saleprice - a.saleprice);
                 twofourzeroASP.push(data[i]);
                 setTwofourzero12(twofourzero);
                 
               }
               if (data[i].DOM > 241 && data[i].DOM <= 300 && data[i].saleprice >= data[i].listprice){
                twofourzerogreat.push(data[i]);
                twofourzerogreat.sort((a, b) => b.saleprice - a.saleprice);
                setOnetwentygreat240(twofourzerogreat);
              }

               if (data[i].DOM > 301){ // commercial render...
                 threehundredone.push(data[i]);
                 threehundredone.sort((a, b) => b.saleprice - a.saleprice);
                 threehundredoneASP.push(data[i]);
                 setThreezeroone12(threehundredone);
                 
               }
               if (data[i].DOM > 301 && data[i].saleprice >= data[i].listprice){
                threehundredonegreat.push(data[i]);
                threehundredonegreat.sort((a, b) => b.saleprice - a.saleprice);
                setOnetwoonegreat301(threehundredonegreat);
              }
               ...
               const formatter = new Intl.NumberFormat('en-US', {
                ...
                let lengthgreat14 = great14.length || 0; //provides the length of sales above= list via specified DOM 
                let lengthgreat30 = great30.length || 0;
                let lengthgreat45 = great45.length || 0;
                let lengthgreat90 = great90.length || 0;
                let lengthgreat120 = great120.length || 0;
                let lengthgreat121 = great121.length || 0; 
                //commercial render...
                ...
                //commercial render...
                let atabove240 = Math.round((lengthgreat240 / sale240) * 100) || 0;
                let atabove301 = Math.round((lengthgreat301 / sale301) * 100) || 0;
        
        
        
             
                document.getElementById('salesTpopulate22').innerHTML = `2022: ${sales.length} Total Sales`;
                ...
                twofourzero.forEach(add15); //all sales above= 240-300
                ...
                threehundredone.forEach(add16); //all sales above= 301+
                ...
                ///////////////////////////////////////////////
                  ...
                  let differential23 = 0;
                      
                  function add23(item, counter, array){
                        differential23+=(item.saleprice); 
                       }
                       fourteenASP.forEach(add23);
                       ...
                       let differential24 = 0;
                       function add24(item, counter, array){
                        differential24+=(item.saleprice); 
                       }
                       thirtyASP.forEach(add24);
                       
               

                       let differential25 = 0;
                       function add25(item, counter, array){
                        differential25+=(item.saleprice); 
                       }
                       fortyfiveASP.forEach(add25);

                      

                      
                       let differential26 = 0;
                       function add26(item, counter, array){
                        differential26+=(item.saleprice); 
                       }
                       ninetyASP.forEach(add26);



                       let differential27 = 0;
                       function add27(item, counter, array){
                        differential27+=(item.saleprice); 
                       }
                       onetwentyASP.forEach(add27);

                      


                       let differential28 = 0;
                       function add28(item, counter, array){
                        differential28+=(item.saleprice); 
                       }
                       onetwooneASP.forEach(add28);

                      


                       let differential29 = 0;
                       function add29(item, counter, array){
                        differential29+=(item.saleprice); 
                       }
                       twofourzeroASP.forEach(add29);

                       



                       let differential30 = 0;
                       function add30(item, counter, array){
                        differential30+=(item.saleprice); 
                       }
                       threehundredoneASP.forEach(add30);
                       ...
                       setTotallessdiff240(formatter.format(Math.round(differential15 / lengthgreat240)));
                       setTotallessdiff301(formatter.format(Math.round(differential16 / lengthgreat301)));
        
              
                       setAverageSPfm(formatter.format(Math.round(differential23 / sale14)));
                       setAverageSP2fm(formatter.format(Math.round(differential24 / sale30)));
                       setAverageSP3fm(formatter.format(Math.round(differential25 / sale45)));
                       setAverageSP4fm(formatter.format(Math.round(differential26 / sale90)));
                       setAverageSP5fm(formatter.format(Math.round(differential27 / sale120)));
                       setAverageSP6fm(formatter.format(Math.round(differential28 / sale121)));
                       setAverageSP7fm(formatter.format(Math.round(differential29 / sale240)));
                       setAverageSP8fm(formatter.format(Math.round(differential30 / sale301)));
               ...
               //commercial render...
               let averagediff240 = formatter.format(Math.round(differential13 / sale240) || 0);
               let averagediff301 = formatter.format(Math.round(differential14 / sale301) || 0);
...
const currentPageData30 = great14pq
...
<br/>
 ...
 const pageCount30 = Math.ceil(great14pq.length / PER_PAGE);  
...
const currentPageData32 = great30pq
...
<br/>
 ...
 const pageCount32 = Math.ceil(great30pq.length / PER_PAGE);  
...
const currentPageData34 = great45pq
...
<br/>
 ...
 const pageCount34 = Math.ceil(great45pq.length / PER_PAGE);  
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  const currentPageData36 = great90pq
...
<br/>
   ...
   const pageCount36 = Math.ceil(great90pq.length / PER_PAGE);  
  ...
  const currentPageData38 = great120pq
...
<br/>
   ...
   const pageCount38 = Math.ceil(great120pq.length / PER_PAGE);  
 ...
 const currentPageData40 = great121pq
...
<br/>
  ...
  const pageCount40 = Math.ceil(great121pq.length / PER_PAGE);  
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   //commercial render...
   const [great240pq, setGreat240pq] = React.useState([]);
////pagination...
...
const currentPageData42 = great240pq
...
<br/>
 ...
 const pageCount42 = Math.ceil(great240pq.length / PER_PAGE);  


///////////////////////////////////////////////////////////////////////////////////////////////////////////


   const [great301pq, setGreat301pq] = React.useState([]);
...
const currentPageData44 = great301pq
...
<br/>
 ...
 const pageCount44 = Math.ceil(great301pq.length / PER_PAGE);  
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   const currentPageData29 = fourteen11
...
<br/>
    ...
    const pageCount29 = Math.ceil(fourteen11.length / PER_PAGE);  
...
const currentPageData31 = thirty11
...
<br/>
 ...
 const pageCount31 = Math.ceil(thirty11.length / PER_PAGE);  
...
const currentPageData33 = fortyfive11
...
<br/>
 ...
 const pageCount33 = Math.ceil(fortyfive11.length / PER_PAGE);  
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 const currentPageData35 = ninety11
...
<br/>
  ...
  const pageCount35 = Math.ceil(ninety11.length / PER_PAGE);  
 ...
 const currentPageData37 = onetwenty11
...
<br/>
  ...
  const pageCount37 = Math.ceil(onetwenty11.length / PER_PAGE);  
 ...
 const currentPageData39 = onetwoone11
...
<br/>
  ...
  const pageCount39 = Math.ceil(onetwoone11.length / PER_PAGE);  
 
 
 ///////////////////////////////////////////////////////////////////////////////////////////////////////////

   const [twofourzero11, setTwofourzero11] = React.useState([]);
...
const currentPageData41 = twofourzero11
...
<br/>
 ...
 const pageCount41 = Math.ceil(twofourzero11.length / PER_PAGE);  


///////////////////////////////////////////////////////////////////////////////////////////////////////////

   const [threezeroone11, setThreezeroone11] = React.useState([]);
...
const currentPageData43 = threezeroone11
...
<br/>
 ...
 const pageCount43 = Math.ceil(threezeroone11.length / PER_PAGE);  
...
const [averageSP16am, setAverageSP16am] = React.useState(0);
const [averageSP17am, setAverageSP17am] = React.useState(0);
const [averageSP18am, setAverageSP18am] = React.useState(0);
const [averageSP19am, setAverageSP19am] = React.useState(0);
const [averageSP20am, setAverageSP20am] = React.useState(0);
const [averageSP21am, setAverageSP21am] = React.useState(0);

//commercial render...LAH
const [averageSP22am, setAverageSP22am] = React.useState(0);
const [averageSP23am, setAverageSP23am] = React.useState(0);


   async function populateQuote(e){ //this functions onClick...
     const req = await fetch('https://jungleebook297-e68d158789dd.herokuapp.com/prototypeJS')
     const data = await req.json();
     //if (data.status ==='ok'){
       console.log(data) // all 15k objects...
         ...
         if (data[i].county ===`${county3}` && data[i].townstate === `${town2}` && data[i].listprice !=='AUCTION' && data[i].differenial !== "#VALUE!" ){
          ...
          if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}`){
           ...
           if (data[i].DOM > 240 && data[i].DOM <= 300 && data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}`){
            twofourzero.push(data[i]);
            twofourzero.sort((a,b) => a.saleprice - b.salperice);
            setTwofourzero11(twofourzero);
            twofourzeroSP.push(data[i]);
          }
          if (data[i].DOM > 300 && data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}`){
            threehundredone.push(data[i]);
            threehundredone.sort((a,b) => a.saleprice - b.salperice);
            setThreezeroone11(threehundredone);
            threehundredoneSP.push(data[i]);
          }
          //
           if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}` && data[i].saleprice >= data[i].listprice && data[i].DOM <= 30 ){
             great14.push(data[i]);
             console.log(great14);
             great14.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}` && data[i].saleprice >= data[i].listprice && data[i].DOM > 31 && data[i].DOM <= 60){
             great30.push(data[i]);
             great30.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}` && data[i].saleprice >= data[i].listprice && data[i].DOM > 60 && data[i].DOM <= 90){
             great45.push(data[i]);
             great45.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}` && data[i].saleprice >= data[i].listprice && data[i].DOM > 90 && data[i].DOM <= 120){
             great90.push(data[i]);
             great90.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}` && data[i].saleprice >= data[i].listprice && data[i].DOM > 120 && data[i].DOM <= 180){
             great120.push(data[i]);
             great120.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}` && data[i].saleprice >= data[i].listprice && data[i].DOM > 180 && data[i].DOM <= 240){
             great121.push(data[i]);
             great121.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}` && data[i].saleprice >= data[i].listprice && data[i].DOM > 240 && data[i].DOM <= 300){
            twofourzero1.push(data[i]);
            twofourzero1.sort((a, b) => b.saleprice - a.saleprice);
            setGreat240pq(twofourzero1);
          }
          if (data[i].county === `${county3}` && data[i].townstate === `${town2}` && data[i].year === 2022 && data[i].saleprice >= `${pricevalue}` && data[i].saleprice < `${pricevalue2}` && data[i].saleprice >= data[i].listprice && data[i].DOM > 300){
            ...
            threehundredone1.sort((a, b) => b.saleprice - a.saleprice);
            setGreat301pq(threehundredone1);
          }
          //
           ...
           let sale14 = fourteen.length || 0; //provides the length of all sales above=
           let sale30 = thirty.length || 0;
           let sale45 = fortyfive.length || 0;
           let sale90 = ninety.length || 0;
           let sale120 = onetwenty.length || 0;
           let sale121 = onetwoone.length || 0;
           //commercial render...
           let sale240 = twofourzero.length || 0;
           let sale301 = threehundredone.length || 0;
           ...
           const atabove121 =  Math.round((lengthgreat121 / sale121)  * 100) || 0;
           //commercial render...
           const atabove240 = Math.round((lengthgreat240 / sale240) * 100) || 0;
           const atabove301 = Math.round((lengthgreat301 / sale301) * 100) || 0;
           ...
           let differential28 = 0;
           function add28(item, counter, array){
             differential28+=(item.differential);
           }
   
           twofourzero.forEach(add28); 
   
           let differential29 = 0;
           function add29(item, counter, array){
             differential29+=(item.differential);
           }
   
           threehundredone.forEach(add29); 
           console.log(differential29);
          ...
          //greater diff avg
           ...
           threehundredone1.forEach(add14); 
...
/////////////// commercial render UP... 16-23

          
           let differential16 = 0;
           function add16(item, counter, array){
             differential16+=(item.saleprice);
           }
   
           fourteenSP.forEach(add16); 
           console.log(differential16);

           

           let differential17 = 0;
           function add17(item, counter, array){
            differential17+=(item.saleprice);
           }
           thirtySP.forEach(add17);
           
           let differential18 = 0;
           function add18(item, counter, array){
            differential18+=(item.saleprice);
           }
           fortyfiveSP.forEach(add18);

           let differential19 = 0;
           function add19(item, counter, array){
            differential19+=(item.saleprice);
           }
           ninetySP.forEach(add19);


           let differential20 = 0;
           function add20(item, counter, array){
            differential20+=(item.saleprice);
           }
           onetwentySP.forEach(add20);

           let differential21 = 0;
           function add21(item, counter, array){
            differential21+=(item.saleprice);
           }
           onetwooneSP.forEach(add21);


           let differential22 = 0;
           function add22(item, counter, array){
            differential22+=(item.saleprice); 
           }
           twofourzeroSP.forEach(add22);

           let differential23 = 0;
           function add23(item, counter, array){
            differential23+=(item.saleprice); 
           }
           threehundredoneSP.forEach(add23);
          ...
          ///////////////////////////////////////////////////////
           ...
           averagesaleprice.forEach(add24);


           let differential25 = 0;
           function add25(item, counter, array){
            differential25+=(item.listprice); 
           }
           averagesaleprice.forEach(add25);

           let differential26 = 0;
           function add26(item, counter, array){
            differential26+=(item.DOM); 
           }
           averagesaleprice.forEach(add26);
         ...
         ///////////////////////////////////////////////////////
           ...
           let avgDOMpopulate = Math.round(differential26 / averagesaleprice.length);
           let avgSalepopulate = formatter.format(Math.round(differential24 / averagesaleprice.length));
           let avgListpopulate = formatter.format(Math.round(differential25 / averagesaleprice.length));
           ...
           document.getElementById('salesTpopulate').innerHTML = `${averagesaleprice.length} Sales`;

  
   
   
   
          //differentials wrong.... 24 => 31 
           // console.log(saleprice);
          let averagediff14 = formatter.format(Math.round( differential / sale14 ) || 0);
          let averagediff30 = formatter.format(Math.round( differential2 / sale30 ) || 0);
          let averagediff45 = formatter.format(Math.round( differential3 / sale45 ) || 0);
          ...
          let averagediff121 = formatter.format(Math.round( differential6 / sale121 ) || 0);
          //commercial render...
          let averagediff240 = formatter.format(Math.round( differential28 / sale240 ) || 0);
          let averagediff301 = formatter.format(Math.round( differential29 / sale301 ) || 0);
        ...
        // commercial render...
        setBelowdiffrates240avg(formatter.format(Math.round( differential13 / lengthgreat240 ))); // title
        setBelowdiffrates301avg(formatter.format(Math.round( differential14 / lengthgreat301 ))); // title


        setAverageSP16am(formatter.format(Math.round( differential16 / sale14 ) || 0));
        setAverageSP17am(formatter.format(Math.round( differential17 / sale30 ) || 0));
        setAverageSP18am(formatter.format(Math.round( differential18 / sale45 ) || 0));
        setAverageSP19am(formatter.format(Math.round( differential19 / sale90 ) || 0));
        setAverageSP20am(formatter.format(Math.round( differential20 / sale120 ) || 0));
        setAverageSP21am(formatter.format(Math.round( differential21 / sale121 ) || 0));
        //commercial render...
        setAverageSP22am(formatter.format(Math.round( differential22 / sale240 ) || 0));
        setAverageSP23am(formatter.format(Math.round( differential23 / sale301 ) || 0));
   ...
   const availableState4 = GLOBE1.states.find((s) => s.name === selectedState4); // that is what this says...
   ...
   console.log(index21);
       ...
       for (let i = 0; i<data.length; i++){
         if (data[i].county === `${county4}` && data[i].townstate === `${town}` && data[i].listprice !=='AUCTION' && data[i].differenial !== "#VALUE!" ){
           ...
           let yearCurrentlength = yearCurrent.length || 0;
           ...
           let yearPreviouslength = yearPrevious.length || 0;
           ...
           let yearCallength = yearcall2021.length || 0;
          ...
          let percentpie = yearPreviouslength * updown || 0;
          console.log(percentpie);
   
   
         
           let increase = Math.round(yearPreviouslength + percentpie) || 0;
           console.log(increase);
   
           let decrease = Math.round(yearPreviouslength - percentpie) || 0;
         ...
         let month4length = month4.length || 0;
   ...
   const availableState5 = GLOBE1.states.find((s) => s.name === selectedState5); // that is what this says...
   ...
   console.log(index22.indexOf(index22[i]));
   openarray.unshift(index22.splice(index22.indexOf(index22[i]), 240)); //commercial render..
   return openarray;
 ...
 const currentPageData45 = subaruWRX
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-31px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-121px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
  ...
  const pageCount45 = Math.ceil(subaruWRX.length / PER_PAGE);  
 ...
 const currentPageData51 = subaruWRX2
...
<br/>
  ...
  const pageCount51 = Math.ceil(subaruWRX2.length / PER_PAGE);  
 ...
 const currentPageData57 = subaruWRX3
...
<br/>
  ...
  const pageCount57 = Math.ceil(subaruWRX3.length / PER_PAGE);  
...
const currentPageData63 = subaruWRX4
...
<br/>
 ...
 const pageCount63 = Math.ceil(subaruWRX4.length / PER_PAGE);  
...
const currentPageData69 = subaruWRX5
...
<br/>
 ...
 const pageCount69 = Math.ceil(subaruWRX5.length / PER_PAGE);  
...
const currentPageData46 = planAatabovegreat
...
const pageCount46 = Math.ceil(planAatabovegreat.length / PER_PAGE);  
...
const currentPageData52 = planBatabovegreat
...
const pageCount52 = Math.ceil(planBatabovegreat.length / PER_PAGE);  
...
const currentPageData58 = planCatabovegreat
.slice(offset52, offset52 + PER_PAGE)
.map((item, index) => (
...
const pageCount58 = Math.ceil(planCatabovegreat.length / PER_PAGE);  
...
const currentPageData64 = planDatabovegreat
...
const pageCount64 = Math.ceil(planDatabovegreat.length / PER_PAGE);  
...
const currentPageData70 = planEatabovegreat
...
const pageCount70 = Math.ceil(planEatabovegreat.length / PER_PAGE);  
...
const [averageSP34, setAverageSP34] = React.useState(0);
const [averageSP35, setAverageSP35] = React.useState(0);
const [averageSP36, setAverageSP36] = React.useState(0);
const [averageSP37, setAverageSP37] = React.useState(0);
const [averageSP38, setAverageSP38] = React.useState(0);
   ...
   async function businessplanning(e){ 
     ...
     const req = await fetch('https://jungleebook297-e68d158789dd.herokuapp.com/prototypeJS', {mode: 'cors'})
       ...
       document.getElementById('date14').innerHTML = `${newArray[0][0]}` + ' - ' + `${newArray[0][44]}` + ' 0-45 days ';
       document.getElementById('date30').innerHTML = `${newArray[0][45]}` + ' - ' + `${newArray[0][89]}` + ' 46-90 days ';
       document.getElementById('date45').innerHTML = `${newArray[0][90]}` + ' - ' + `${newArray[0][134]}` + ' 91-135 days ';
       document.getElementById('date90').innerHTML = `${newArray[0][135]}` + ' - ' + `${newArray[0][179]}` + ' 136-180 days ';
       document.getElementById('date120').innerHTML = `${newArray[0][180]}` + ' - ' + `${newArray[0][240]}` + ' 181-240 days ';
       ...
       for (let i = 0; i<data.length; i++){
         if (data[i].county === `${county2}` && data[i].townstate === `${town3}` && data[i].saleprice >= `${pricevalue3}` && data[i].saleprice < `${pricevalue4}` && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" && (data[i].saledate === newArray[0][0] || data[i].saledate === newArray[0][1] || data[i].saledate === newArray[0][2] || data[i].saledate === newArray[0][3] || data[i].saledate === newArray[0][4] || data[i].saledate === newArray[0][5] || data[i].saledate === newArray[0][6] || data[i].saledate === newArray[0][7] || data[i].saledate === newArray[0][8] || data[i].saledate === newArray[0][9] || data[i].saledate === newArray[0][10] || data[i].saledate === newArray[0][11] || data[i].saledate === newArray[0][12] || data[i].saledate === newArray[0][13] || data[i].saledate === newArray[0][14] || data[i].saledate === newArray[0][15] || data[i].saledate === newArray[0][16] || data[i].saledate === newArray[0][17] || data[i].saledate === newArray[0][18] || data[i].saledate === newArray[0][19] || data[i].saledate === newArray[0][20] || data[i].saledate === newArray[0][21] || data[i].saledate === newArray[0][22] || data[i].saledate === newArray[0][23] || data[i].saledate === newArray[0][24] || data[i].saledate === newArray[0][25] || data[i].saledate === newArray[0][26] || data[i].saledate === newArray[0][27] || data[i].saledate === newArray[0][28] || data[i].saledate === newArray[0][29] || data[i].saledate === newArray[0][30] || data[i].saledate === newArray[0][31] || data[i].saledate === newArray[0][32] || data[i].saledate === newArray[0][33] || data[i].saledate === newArray[0][34] || data[i].saledate === newArray[0][35] || data[i].saledate === newArray[0][36] || data[i].saledate === newArray[0][37] || data[i].saledate === newArray[0][38] || data[i].saledate === newArray[0][39] || data[i].saledate === newArray[0][40] || data[i].saledate === newArray[0][41] ||
           ...
           || data[i].saledate === newArray[0][120] || data[i].saledate === newArray[0][121] || data[i].saledate === newArray[0][122] || data[i].saledate === newArray[0][123] || data[i].saledate === newArray[0][124] || data[i].saledate === newArray[0][125] || data[i].saledate === newArray[0][126] || data[i].saledate === newArray[0][127] || data[i].saledate === newArray[0][128] || data[i].saledate === newArray[0][129] || data[i].saledate === newArray[0][130] || data[i].saledate === newArray[0][131] || data[i].saledate === newArray[0][132] || data[i].saledate === newArray[0][133]
           || data[i].saledate === newArray[0][134] || data[i].saledate === newArray[0][135] || data[i].saledate === newArray[0][136] || data[i].saledate === newArray[0][137] || data[i].saledate === newArray[0][138] || data[i].saledate === newArray[0][139] ||
           data[i].saledate === newArray[0][140] || data[i].saledate === newArray[0][141] || data[i].saledate === newArray[0][142] || data[i].saledate === newArray[0][143] || data[i].saledate === newArray[0][144] || data[i].saledate === newArray[0][145] || data[i].saledate === newArray[0][146] || data[i].saledate === newArray[0][147] || data[i].saledate === newArray[0][148] || data[i].saledate === newArray[0][149] || data[i].saledate === newArray[0][150]    
          || data[i].saledate === newArray[0][151] || data[i].saledate === newArray[0][152] || data[i].saledate === newArray[0][153] || data[i].saledate === newArray[0][154] || data[i].saledate === newArray[0][155] || data[i].saledate === newArray[0][156] || data[i].saledate === newArray[0][157] || data[i].saledate === newArray[0][158] || data[i].saledate === newArray[0][159] || data[i].saledate === newArray[0][160]  
          ||  data[i].saledate === newArray[0][170] || data[i].saledate === newArray[0][171] || data[i].saledate === newArray[0][172] || data[i].saledate === newArray[0][173] || data[i].saledate === newArray[0][174] || data[i].saledate === newArray[0][175] || data[i].saledate === newArray[0][176] || data[i].saledate === newArray[0][177] || data[i].saledate === newArray[0][178] || data[i].saledate === newArray[0][179] || data[i].saledate === newArray[0][180]
          || data[i].saledate === newArray[0][180]
          || data[i].saledate === newArray[0][181] || data[i].saledate === newArray[0][182] || data[i].saledate === newArray[0][183] || data[i].saledate === newArray[0][184] || data[i].saledate === newArray[0][185] || data[i].saledate === newArray[0][186] || data[i].saledate === newArray[0][187] || data[i].saledate === newArray[0][188] || data[i].saledate === newArray[0][189] 
          || data[i].saledate === newArray[0][190] || data[i].saledate === newArray[0][191] || data[i].saledate === newArray[0][192] || data[i].saledate === newArray[0][193] || data[i].saledate === newArray[0][194] || data[i].saledate === newArray[0][195] || data[i].saledate === newArray[0][196] || data[i].saledate === newArray[0][197] || data[i].saledate === newArray[0][198] || data[i].saledate === newArray[0][199] 
          || data[i].saledate === newArray[0][200] || data[i].saledate === newArray[0][201] || data[i].saledate === newArray[0][202] || data[i].saledate === newArray[0][203] || data[i].saledate === newArray[0][204] || data[i].saledate === newArray[0][205] || data[i].saledate === newArray[0][206] || data[i].saledate === newArray[0][207] || data[i].saledate === newArray[0][208] || data[i].saledate === newArray[0][209] 
          || data[i].saledate === newArray[0][210] || data[i].saledate === newArray[0][211] || data[i].saledate === newArray[0][212] || data[i].saledate === newArray[0][213] || data[i].saledate === newArray[0][214] || data[i].saledate === newArray[0][215] || data[i].saledate === newArray[0][216] || data[i].saledate === newArray[0][217] || data[i].saledate === newArray[0][218] || data[i].saledate === newArray[0][219] 
          || data[i].saledate === newArray[0][220] || data[i].saledate === newArray[0][221] || data[i].saledate === newArray[0][222] || data[i].saledate === newArray[0][223] || data[i].saledate === newArray[0][224] || data[i].saledate === newArray[0][225] || data[i].saledate === newArray[0][226] || data[i].saledate === newArray[0][227] || data[i].saledate === newArray[0][228] || data[i].saledate === newArray[0][229] 
          || data[i].saledate === newArray[0][230] || data[i].saledate === newArray[0][231] || data[i].saledate === newArray[0][232] || data[i].saledate === newArray[0][233] || data[i].saledate === newArray[0][234] || data[i].saledate === newArray[0][235] || data[i].saledate === newArray[0][236] || data[i].saledate === newArray[0][237] || data[i].saledate === newArray[0][238] || data[i].saledate === newArray[0][239] 
         ||  data[i].saledate === newArray[0][240] )){
           planK.push(data[i]);
           ...
           if (data[i].saleprice >= data[i].listprice && ( data[i].saledate === newArray[0][0] || data[i].saledate === newArray[0][1] || data[i].saledate === newArray[0][2] || data[i].saledate === newArray[0][3] || data[i].saledate === newArray[0][4] || data[i].saledate === newArray[0][5] || data[i].saledate === newArray[0][6] || data[i].saledate === newArray[0][7] || data[i].saledate === newArray[0][8] || data[i].saledate === newArray[0][9] || data[i].saledate === newArray[0][10] || data[i].saledate === newArray[0][11] || data[i].saledate === newArray[0][12] || data[i].saledate === newArray[0][13] || data[i].saledate === newArray[0][14] || data[i].saledate === newArray[0][15] || data[i].saledate === newArray[0][16] || data[i].saledate === newArray[0][17] || data[i].saledate === newArray[0][18] || data[i].saledate === newArray[0][19] || data[i].saledate === newArray[0][20] || data[i].saledate === newArray[0][21] || data[i].saledate === newArray[0][22] || data[i].saledate === newArray[0][23] || data[i].saledate === newArray[0][24] || data[i].saledate === newArray[0][25] || data[i].saledate === newArray[0][26] || data[i].saledate === newArray[0][27] || data[i].saledate === newArray[0][28] || data[i].saledate === newArray[0][29] || data[i].saledate === newArray[0][30] ||
            data[i].saledate === newArray[0][31] || data[i].saledate === newArray[0][32] || data[i].saledate === newArray[0][33] || data[i].saledate === newArray[0][34] || data[i].saledate === newArray[0][35] || data[i].saledate === newArray[0][36] || data[i].saledate === newArray[0][37] || data[i].saledate === newArray[0][38] || data[i].saledate === newArray[0][39] || data[i].saledate === newArray[0][40] || data[i].saledate === newArray[0][41] ||
            data[i].saledate === newArray[0][42] || data[i].saledate === newArray[0][43] || data[i].saledate === newArray[0][44] || data[i].saledate === newArray[0][45]
            )){
             planAatabove.push(data[i]);
             console.log(planAatabove);
             planAatabove.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].saledate === newArray[0][0] || data[i].saledate === newArray[0][1] || data[i].saledate === newArray[0][2] || data[i].saledate === newArray[0][3] || data[i].saledate === newArray[0][4] || data[i].saledate === newArray[0][5] || data[i].saledate === newArray[0][6] || data[i].saledate === newArray[0][7] || data[i].saledate === newArray[0][8] || data[i].saledate === newArray[0][9] || data[i].saledate === newArray[0][10] || data[i].saledate === newArray[0][11] || data[i].saledate === newArray[0][12] || data[i].saledate === newArray[0][13] || data[i].saledate === newArray[0][14] || data[i].saledate === newArray[0][15] || data[i].saledate === newArray[0][16] || data[i].saledate === newArray[0][17] || data[i].saledate === newArray[0][18] || data[i].saledate === newArray[0][19] || data[i].saledate === newArray[0][20] || data[i].saledate === newArray[0][21] || data[i].saledate === newArray[0][22] || data[i].saledate === newArray[0][23] || data[i].saledate === newArray[0][24] || data[i].saledate === newArray[0][25] || data[i].saledate === newArray[0][26] || data[i].saledate === newArray[0][27] || data[i].saledate === newArray[0][28] || data[i].saledate === newArray[0][29] || data[i].saledate === newArray[0][30] ||
            ...
            data[i].saledate === newArray[0][42] || data[i].saledate === newArray[0][43] || data[i].saledate === newArray[0][44] || data[i].saledate === newArray[0][45]
             ...
             planA.push(data[i]);
             console.log(planA);
             planA.sort((a, b) => b.saleprice - a.saleprice);
             setSubaruWRX(planA);
             planAOP.push(data[i]);
           }
   
           if (data[i].saledate === newArray[0][46] || data[i].saledate === newArray[0][47] || data[i].saledate === newArray[0][48] || data[i].saledate === newArray[0][49] || data[i].saledate === newArray[0][50] || data[i].saledate === newArray[0][51] || data[i].saledate === newArray[0][52] || data[i].saledate === newArray[0][53] || data[i].saledate === newArray[0][54] || data[i].saledate === newArray[0][55] ||data[i].saledate === newArray[0][56] || data[i].saledate === newArray[0][57] || data[i].saledate === newArray[0][58] || data[i].saledate === newArray[0][59] || data[i].saledate === newArray[0][60] ||
            data[i].saledate === newArray[0][61] || data[i].saledate === newArray[0][62] || data[i].saledate === newArray[0][63] || data[i].saledate === newArray[0][64] || data[i].saledate === newArray[0][65] || data[i].saledate === newArray[0][66] || data[i].saledate === newArray[0][67] || data[i].saledate === newArray[0][68] || data[i].saledate === newArray[0][69] 
            || data[i].saledate === newArray[0][70] || data[i].saledate === newArray[0][71] || data[i].saledate === newArray[0][72] || data[i].saledate === newArray[0][73] || data[i].saledate === newArray[0][74] || data[i].saledate === newArray[0][75] || data[i].saledate === newArray[0][76] || data[i].saledate === newArray[0][77] || data[i].saledate === newArray[0][78] || data[i].saledate === newArray[0][79] || data[i].saledate === newArray[0][80] || data[i].saledate === newArray[0][81] || data[i].saledate === newArray[0][82] || data[i].saledate === newArray[0][83]
            || data[i].saledate === newArray[0][84] || data[i].saledate === newArray[0][85] || data[i].saledate === newArray[0][86] || data[i].saledate === newArray[0][87] || data[i].saledate === newArray[0][88] || data[i].saledate === newArray[0][89] || data[i].saledate === newArray[0][90]){
             planB.push(data[i]);
             console.log(planB);
             planB.sort((a, b) => b.saleprice - a.saleprice);
             setSubaruWRX2(planB);
             planBOP.push(data[i]);
           }
           if (data[i].saledate === newArray[0][91] || data[i].saledate === newArray[0][92] || data[i].saledate === newArray[0][93] || data[i].saledate === newArray[0][94] || data[i].saledate === newArray[0][95] || data[i].saledate === newArray[0][96] || data[i].saledate === newArray[0][97] || data[i].saledate === newArray[0][98] || data[i].saledate === newArray[0][99] 
            || data[i].saledate === newArray[0][100] || data[i].saledate === newArray[0][101] || data[i].saledate === newArray[0][102] || data[i].saledate === newArray[0][103] || data[i].saledate === newArray[0][104] || data[i].saledate === newArray[0][105] || data[i].saledate === newArray[0][106] || data[i].saledate === newArray[0][107] || data[i].saledate === newArray[0][108] || data[i].saledate === newArray[0][109] || data[i].saledate === newArray[0][110] || data[i].saledate === newArray[0][111] || data[i].saledate === newArray[0][112] || data[i].saledate === newArray[0][113]
            || data[i].saledate === newArray[0][114] || data[i].saledate === newArray[0][115] || data[i].saledate === newArray[0][116] || data[i].saledate === newArray[0][117] || data[i].saledate === newArray[0][118] || data[i].saledate === newArray[0][119] || data[i].saledate === newArray[0][120] || data[i].saledate === newArray[0][121] || data[i].saledate === newArray[0][122] || data[i].saledate === newArray[0][123] || data[i].saledate === newArray[0][124] || data[i].saledate === newArray[0][125] || data[i].saledate === newArray[0][126] || data[i].saledate === newArray[0][127] || data[i].saledate === newArray[0][128] || data[i].saledate === newArray[0][129] || data[i].saledate === newArray[0][130] || data[i].saledate === newArray[0][131] || data[i].saledate === newArray[0][132] || data[i].saledate === newArray[0][133]
            || data[i].saledate === newArray[0][134] || data[i].saledate === newArray[0][135]){
             planC.push(data[i]);
             console.log(planC);
             planC.sort((a, b) => b.saleprice - a.saleprice);
             setSubaruWRX3(planC);
             planCOP.push(data[i]);
           }
           if (data[i].saledate === newArray[0][136] || data[i].saledate === newArray[0][137] || data[i].saledate === newArray[0][138] || data[i].saledate === newArray[0][139]
            ||  data[i].saledate === newArray[0][140] || data[i].saledate === newArray[0][141] || data[i].saledate === newArray[0][142] || data[i].saledate === newArray[0][143] || data[i].saledate === newArray[0][144] || data[i].saledate === newArray[0][145] || data[i].saledate === newArray[0][146] || data[i].saledate === newArray[0][147] || data[i].saledate === newArray[0][148] || data[i].saledate === newArray[0][149] || data[i].saledate === newArray[0][150]    
             || data[i].saledate === newArray[0][151] || data[i].saledate === newArray[0][152] || data[i].saledate === newArray[0][153] || data[i].saledate === newArray[0][154] || data[i].saledate === newArray[0][155] || data[i].saledate === newArray[0][156] || data[i].saledate === newArray[0][157] || data[i].saledate === newArray[0][158] || data[i].saledate === newArray[0][159] || data[i].saledate === newArray[0][160]  
            ||  data[i].saledate === newArray[0][170] || data[i].saledate === newArray[0][171] || data[i].saledate === newArray[0][172] || data[i].saledate === newArray[0][173] || data[i].saledate === newArray[0][174] || data[i].saledate === newArray[0][175] || data[i].saledate === newArray[0][176] || data[i].saledate === newArray[0][177] || data[i].saledate === newArray[0][178] || data[i].saledate === newArray[0][179] || data[i].saledate === newArray[0][180]
            || data[i].saledate === newArray[0][180]){
             planD.push(data[i]);
             console.log(planD);
             planD.sort((a, b) => b.saleprice - a.saleprice);
             setSubaruWRX4(planD);
             planDOP.push(data[i]);
           }
           if (data[i].saledate === newArray[0][181] || data[i].saledate === newArray[0][182] || data[i].saledate === newArray[0][183] || data[i].saledate === newArray[0][184] || data[i].saledate === newArray[0][185] || data[i].saledate === newArray[0][186] || data[i].saledate === newArray[0][187] || data[i].saledate === newArray[0][188] || data[i].saledate === newArray[0][189] 
           || data[i].saledate === newArray[0][190] || data[i].saledate === newArray[0][191] || data[i].saledate === newArray[0][192] || data[i].saledate === newArray[0][193] || data[i].saledate === newArray[0][194] || data[i].saledate === newArray[0][195] || data[i].saledate === newArray[0][196] || data[i].saledate === newArray[0][197] || data[i].saledate === newArray[0][198] || data[i].saledate === newArray[0][199] 
           || data[i].saledate === newArray[0][200] || data[i].saledate === newArray[0][201] || data[i].saledate === newArray[0][202] || data[i].saledate === newArray[0][203] || data[i].saledate === newArray[0][204] || data[i].saledate === newArray[0][205] || data[i].saledate === newArray[0][206] || data[i].saledate === newArray[0][207] || data[i].saledate === newArray[0][208] || data[i].saledate === newArray[0][209] 
           || data[i].saledate === newArray[0][210] || data[i].saledate === newArray[0][211] || data[i].saledate === newArray[0][212] || data[i].saledate === newArray[0][213] || data[i].saledate === newArray[0][214] || data[i].saledate === newArray[0][215] || data[i].saledate === newArray[0][216] || data[i].saledate === newArray[0][217] || data[i].saledate === newArray[0][218] || data[i].saledate === newArray[0][219] 
           || data[i].saledate === newArray[0][220] || data[i].saledate === newArray[0][221] || data[i].saledate === newArray[0][222] || data[i].saledate === newArray[0][223] || data[i].saledate === newArray[0][224] || data[i].saledate === newArray[0][225] || data[i].saledate === newArray[0][226] || data[i].saledate === newArray[0][227] || data[i].saledate === newArray[0][228] || data[i].saledate === newArray[0][229] 
           ...
           || data[i].saledate === newArray[0][240]){
             planE.push(data[i]);
             console.log(planE);
             planE.sort((a, b) => b.saleprice - a.saleprice);
             setSubaruWRX5(planE);
             planEOP.push(data[i]);
           }
   ...
   ///////////////////////////////////////////////////
           ...
           function add(item, counter, array){
                  ...
                  let differentialF = 0;
                  function add11(item, counter, array){
                    differentialF+=(item.saleprice);
                  }
                 planAOP.forEach(add11);

                 let differentialG = 0;
                 function add12(item, counter, array){
                   differentialG+=(item.saleprice);
                 }
                planBOP.forEach(add12);


                let differentialH = 0;
                function add13(item, counter, array){
                  differentialH+=(item.saleprice);
                }
               planCOP.forEach(add13);


               let differentialI = 0;
               function add14(item, counter, array){
                 differentialI+=(item.saleprice);
               }
              planDOP.forEach(add14);


              let differentialJ = 0;
               function add15(item, counter, array){
                 differentialJ+=(item.saleprice);
               }
              planEOP.forEach(add15);
                ...
                setAverageSP34(formatter.format(Math.round(differentialF / planAlength)) || 0); //title
                setAverageSP35(formatter.format(Math.round(differentialG / planBlength)) || 0); //title
                setAverageSP36(formatter.format(Math.round(differentialH / planClength)) || 0); //title
                setAverageSP37(formatter.format(Math.round(differentialI / planDlength)) || 0); //title
                setAverageSP38(formatter.format(Math.round(differentialJ / planElength)) || 0); //title
   ...
   console.log(index21.indexOf(index21[i]));
   openarray21.unshift(index21.splice(index21.indexOf(index21[i]), 240)); //commercial render...
   return openarray21;
...
const currentPageData47 = subaruWRX211
...
const pageCount47 = Math.ceil(subaruWRX211.length / PER_PAGE);  
...
const currentPageData53 = subaruWRX212
...
const pageCount53 = Math.ceil(subaruWRX212.length / PER_PAGE);  
...
const currentPageData59 = subaruWRX213
...
const pageCount59 = Math.ceil(subaruWRX213.length / PER_PAGE);  
...
const currentPageData65 = subaruWRX214
...
const pageCount65 = Math.ceil(subaruWRX214.length / PER_PAGE);  
...
const currentPageData71 = subaruWRX215
...
const pageCount71 = Math.ceil(subaruWRX215.length / PER_PAGE);  
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 const currentPageData48 = planA21atabovegreat
 ...
 <img style={{zIndex: '7', height: '500px', width: '700px'}} src={item.photosMAIN}></img>
 <br/>
 ...
 const pageCount48 = Math.ceil(planA21atabovegreat.length / PER_PAGE);  
...
const currentPageData54 = planB21atabovegreat
...
const pageCount54 = Math.ceil(planB21atabovegreat.length / PER_PAGE);  
...
const currentPageData60 = planC21atabovegreat
...
const pageCount60 = Math.ceil(planC21atabovegreat.length / PER_PAGE);  
...
const currentPageData66 = planD21atabovegreat
...
const pageCount66 = Math.ceil(planD21atabovegreat.length / PER_PAGE);  
...
const currentPageData72 = planE21atabovegreat
...
const pageCount72 = Math.ceil(planE21atabovegreat.length / PER_PAGE);  


///////////////////////////////////////////////////////////////////////////////////////////////////////////
   
   
const [averageSP39, setAverageSP39] = React.useState(0);
const [averageSP40, setAverageSP40] = React.useState(0);
const [averageSP41, setAverageSP41] = React.useState(0);
const [averageSP42, setAverageSP42] = React.useState(0);
const [averageSP43, setAverageSP43] = React.useState(0);
     ...
     const req = await fetch('https://jungleebook297-e68d158789dd.herokuapp.com/prototypeJS', {mode: 'cors'})
       ...
       for (let i = 0; i<data.length; i++){
         if (data[i].county === `${county2}` && data[i].townstate === `${town3}` && data[i].saleprice >= `${pricevalue3}` && data[i].saleprice < `${pricevalue4}` && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" && (data[i].saledate === newArray[0][0] || data[i].saledate === newArray[0][1] || data[i].saledate === newArray[0][2] || data[i].saledate === newArray[0][3] || data[i].saledate === newArray[0][4] || data[i].saledate === newArray[0][5] || data[i].saledate === newArray[0][6] || data[i].saledate === newArray[0][7] || data[i].saledate === newArray[0][8] || data[i].saledate === newArray[0][9] || data[i].saledate === newArray[0][10] || data[i].saledate === newArray[0][11] || data[i].saledate === newArray[0][12] || data[i].saledate === newArray[0][13] || data[i].saledate === newArray[0][14] || data[i].saledate === newArray[0][15] || data[i].saledate === newArray[0][16] || data[i].saledate === newArray[0][17] || data[i].saledate === newArray[0][18] || data[i].saledate === newArray[0][19] || data[i].saledate === newArray[0][20] || data[i].saledate === newArray[0][21] || data[i].saledate === newArray[0][22] || data[i].saledate === newArray[0][23] || data[i].saledate === newArray[0][24] || data[i].saledate === newArray[0][25] || data[i].saledate === newArray[0][26] || data[i].saledate === newArray[0][27] || data[i].saledate === newArray[0][28] || data[i].saledate === newArray[0][29] || data[i].saledate === newArray[0][30] || data[i].saledate === newArray[0][31] || data[i].saledate === newArray[0][32] || data[i].saledate === newArray[0][33] || data[i].saledate === newArray[0][34] || data[i].saledate === newArray[0][35] || data[i].saledate === newArray[0][36] || data[i].saledate === newArray[0][37] || data[i].saledate === newArray[0][38] || data[i].saledate === newArray[0][39] || data[i].saledate === newArray[0][40] || data[i].saledate === newArray[0][41] ||
          ...
          || data[i].saledate === newArray[0][134] || data[i].saledate === newArray[0][135] || data[i].saledate === newArray[0][136] || data[i].saledate === newArray[0][137] || data[i].saledate === newArray[0][138] || data[i].saledate === newArray[0][139] ||
          data[i].saledate === newArray[0][140] || data[i].saledate === newArray[0][141] || data[i].saledate === newArray[0][142] || data[i].saledate === newArray[0][143] || data[i].saledate === newArray[0][144] || data[i].saledate === newArray[0][145] || data[i].saledate === newArray[0][146] || data[i].saledate === newArray[0][147] || data[i].saledate === newArray[0][148] || data[i].saledate === newArray[0][149] || data[i].saledate === newArray[0][150]    
         || data[i].saledate === newArray[0][151] || data[i].saledate === newArray[0][152] || data[i].saledate === newArray[0][153] || data[i].saledate === newArray[0][154] || data[i].saledate === newArray[0][155] || data[i].saledate === newArray[0][156] || data[i].saledate === newArray[0][157] || data[i].saledate === newArray[0][158] || data[i].saledate === newArray[0][159] || data[i].saledate === newArray[0][160] || data[i].saledate === newArray[0][161] || data[i].saledate === newArray[0][162] || data[i].saledate === newArray[0][163] || data[i].saledate === newArray[0][164] || data[i].saledate === newArray[0][165] || data[i].saledate === newArray[0][166] || data[i].saledate === newArray[0][167] || data[i].saledate === newArray[0][168] || data[i].saledate === newArray[0][169]
         ||  data[i].saledate === newArray[0][170] || data[i].saledate === newArray[0][171] || data[i].saledate === newArray[0][172] || data[i].saledate === newArray[0][173] || data[i].saledate === newArray[0][174] || data[i].saledate === newArray[0][175] || data[i].saledate === newArray[0][176] || data[i].saledate === newArray[0][177] || data[i].saledate === newArray[0][178] || data[i].saledate === newArray[0][179] || data[i].saledate === newArray[0][180]
         || data[i].saledate === newArray[0][181] || data[i].saledate === newArray[0][182] || data[i].saledate === newArray[0][183] || data[i].saledate === newArray[0][184] || data[i].saledate === newArray[0][185] || data[i].saledate === newArray[0][186] || data[i].saledate === newArray[0][187] || data[i].saledate === newArray[0][188] || data[i].saledate === newArray[0][189] 
         || data[i].saledate === newArray[0][190] || data[i].saledate === newArray[0][191] || data[i].saledate === newArray[0][192] || data[i].saledate === newArray[0][193] || data[i].saledate === newArray[0][194] || data[i].saledate === newArray[0][195] || data[i].saledate === newArray[0][196] || data[i].saledate === newArray[0][197] || data[i].saledate === newArray[0][198] || data[i].saledate === newArray[0][199] 
         || data[i].saledate === newArray[0][200] || data[i].saledate === newArray[0][201] || data[i].saledate === newArray[0][202] || data[i].saledate === newArray[0][203] || data[i].saledate === newArray[0][204] || data[i].saledate === newArray[0][205] || data[i].saledate === newArray[0][206] || data[i].saledate === newArray[0][207] || data[i].saledate === newArray[0][208] || data[i].saledate === newArray[0][209] 
         ...
         || data[i].saledate === newArray[0][230] || data[i].saledate === newArray[0][231] || data[i].saledate === newArray[0][232] || data[i].saledate === newArray[0][233] || data[i].saledate === newArray[0][234] || data[i].saledate === newArray[0][235] || data[i].saledate === newArray[0][236] || data[i].saledate === newArray[0][237] || data[i].saledate === newArray[0][238] || data[i].saledate === newArray[0][239] 
           ...
           if (data[i].saleprice >= data[i].listprice && (data[i].saledate === newArray[0][0] || data[i].saledate === newArray[0][1] || data[i].saledate === newArray[0][2] || data[i].saledate === newArray[0][3] || data[i].saledate === newArray[0][4] || data[i].saledate === newArray[0][5] || data[i].saledate === newArray[0][6] || data[i].saledate === newArray[0][7] || data[i].saledate === newArray[0][8] || data[i].saledate === newArray[0][9] || data[i].saledate === newArray[0][10] || data[i].saledate === newArray[0][11] || data[i].saledate === newArray[0][12] || data[i].saledate === newArray[0][13] || data[i].saledate === newArray[0][14] || data[i].saledate === newArray[0][15] || data[i].saledate === newArray[0][16] || data[i].saledate === newArray[0][17] || data[i].saledate === newArray[0][18] || data[i].saledate === newArray[0][19] || data[i].saledate === newArray[0][20] || data[i].saledate === newArray[0][21] || data[i].saledate === newArray[0][22] || data[i].saledate === newArray[0][23] || data[i].saledate === newArray[0][24] || data[i].saledate === newArray[0][25] || data[i].saledate === newArray[0][26] || data[i].saledate === newArray[0][27] || data[i].saledate === newArray[0][28] || data[i].saledate === newArray[0][29] || data[i].saledate === newArray[0][30] ||
            data[i].saledate === newArray[0][31] || data[i].saledate === newArray[0][32] || data[i].saledate === newArray[0][33] || data[i].saledate === newArray[0][34] || data[i].saledate === newArray[0][35] || data[i].saledate === newArray[0][36] || data[i].saledate === newArray[0][37] || data[i].saledate === newArray[0][38] || data[i].saledate === newArray[0][39] || data[i].saledate === newArray[0][40] || data[i].saledate === newArray[0][41] ||
            data[i].saledate === newArray[0][42] || data[i].saledate === newArray[0][43] || data[i].saledate === newArray[0][44])){
             planAatabove.push(data[i]);
             console.log(planAatabove);
             planAatabove.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].saledate === newArray[0][45] || data[i].saledate === newArray[0][46] || data[i].saledate === newArray[0][47] || data[i].saledate === newArray[0][48] || data[i].saledate === newArray[0][49] || data[i].saledate === newArray[0][50] || data[i].saledate === newArray[0][51] || data[i].saledate === newArray[0][52] || data[i].saledate === newArray[0][53] || data[i].saledate === newArray[0][54] || data[i].saledate === newArray[0][55] ||data[i].saledate === newArray[0][56] || data[i].saledate === newArray[0][57] || data[i].saledate === newArray[0][58] || data[i].saledate === newArray[0][59] || data[i].saledate === newArray[0][60] ||
            data[i].saledate === newArray[0][61] || data[i].saledate === newArray[0][62] || data[i].saledate === newArray[0][63] || data[i].saledate === newArray[0][64] || data[i].saledate === newArray[0][65] || data[i].saledate === newArray[0][66] || data[i].saledate === newArray[0][67] || data[i].saledate === newArray[0][68] || data[i].saledate === newArray[0][69] 
            || data[i].saledate === newArray[0][70] || data[i].saledate === newArray[0][71] || data[i].saledate === newArray[0][72] || data[i].saledate === newArray[0][73] || data[i].saledate === newArray[0][74] || data[i].saledate === newArray[0][75] || data[i].saledate === newArray[0][76] || data[i].saledate === newArray[0][77] || data[i].saledate === newArray[0][78] || data[i].saledate === newArray[0][79] || data[i].saledate === newArray[0][80] || data[i].saledate === newArray[0][81] || data[i].saledate === newArray[0][82] || data[i].saledate === newArray[0][83]
            || data[i].saledate === newArray[0][84] || data[i].saledate === newArray[0][85] || data[i].saledate === newArray[0][86] || data[i].saledate === newArray[0][87] || data[i].saledate === newArray[0][88] || data[i].saledate === newArray[0][89] ){
             planB.push(data[i]);
             console.log(planB);
             planB.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].saledate === newArray[0][90]  || data[i].saledate === newArray[0][91] || data[i].saledate === newArray[0][92] || data[i].saledate === newArray[0][93] || data[i].saledate === newArray[0][94] || data[i].saledate === newArray[0][95] || data[i].saledate === newArray[0][96] || data[i].saledate === newArray[0][97] || data[i].saledate === newArray[0][98] || data[i].saledate === newArray[0][99] 
            || data[i].saledate === newArray[0][100] || data[i].saledate === newArray[0][101] || data[i].saledate === newArray[0][102] || data[i].saledate === newArray[0][103] || data[i].saledate === newArray[0][104] || data[i].saledate === newArray[0][105] || data[i].saledate === newArray[0][106] || data[i].saledate === newArray[0][107] || data[i].saledate === newArray[0][108] || data[i].saledate === newArray[0][109] || data[i].saledate === newArray[0][110] || data[i].saledate === newArray[0][111] || data[i].saledate === newArray[0][112] || data[i].saledate === newArray[0][113]
            || data[i].saledate === newArray[0][114] || data[i].saledate === newArray[0][115] || data[i].saledate === newArray[0][116] || data[i].saledate === newArray[0][117] || data[i].saledate === newArray[0][118] || data[i].saledate === newArray[0][119] || data[i].saledate === newArray[0][120] || data[i].saledate === newArray[0][121] || data[i].saledate === newArray[0][122] || data[i].saledate === newArray[0][123] || data[i].saledate === newArray[0][124] || data[i].saledate === newArray[0][125] || data[i].saledate === newArray[0][126] || data[i].saledate === newArray[0][127] || data[i].saledate === newArray[0][128] || data[i].saledate === newArray[0][129] || data[i].saledate === newArray[0][130] || data[i].saledate === newArray[0][131] || data[i].saledate === newArray[0][132] || data[i].saledate === newArray[0][133]
            || data[i].saledate === newArray[0][134] ){
             planC.push(data[i]);
             console.log(planC);
             planC.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].saledate === newArray[0][135] ||  data[i].saledate === newArray[0][136] || data[i].saledate === newArray[0][137] || data[i].saledate === newArray[0][138] || data[i].saledate === newArray[0][139]
            ||  data[i].saledate === newArray[0][140] || data[i].saledate === newArray[0][141] || data[i].saledate === newArray[0][142] || data[i].saledate === newArray[0][143] || data[i].saledate === newArray[0][144] || data[i].saledate === newArray[0][145] || data[i].saledate === newArray[0][146] || data[i].saledate === newArray[0][147] || data[i].saledate === newArray[0][148] || data[i].saledate === newArray[0][149] || data[i].saledate === newArray[0][150]    
             || data[i].saledate === newArray[0][151] || data[i].saledate === newArray[0][152] || data[i].saledate === newArray[0][153] || data[i].saledate === newArray[0][154] || data[i].saledate === newArray[0][155] || data[i].saledate === newArray[0][156] || data[i].saledate === newArray[0][157] || data[i].saledate === newArray[0][158] || data[i].saledate === newArray[0][159] || data[i].saledate === newArray[0][160]  
           ...
           if (data[i].saledate === newArray[0][180] || data[i].saledate === newArray[0][181] || data[i].saledate === newArray[0][182] || data[i].saledate === newArray[0][183] || data[i].saledate === newArray[0][184] || data[i].saledate === newArray[0][185] || data[i].saledate === newArray[0][186] || data[i].saledate === newArray[0][187] || data[i].saledate === newArray[0][188] || data[i].saledate === newArray[0][189] 
            || data[i].saledate === newArray[0][190] || data[i].saledate === newArray[0][191] || data[i].saledate === newArray[0][192] || data[i].saledate === newArray[0][193] || data[i].saledate === newArray[0][194] || data[i].saledate === newArray[0][195] || data[i].saledate === newArray[0][196] || data[i].saledate === newArray[0][197] || data[i].saledate === newArray[0][198] || data[i].saledate === newArray[0][199] 
            || data[i].saledate === newArray[0][200] || data[i].saledate === newArray[0][201] || data[i].saledate === newArray[0][202] || data[i].saledate === newArray[0][203] || data[i].saledate === newArray[0][204] || data[i].saledate === newArray[0][205] || data[i].saledate === newArray[0][206] || data[i].saledate === newArray[0][207] || data[i].saledate === newArray[0][208] || data[i].saledate === newArray[0][209] 
            || data[i].saledate === newArray[0][210] || data[i].saledate === newArray[0][211] || data[i].saledate === newArray[0][212] || data[i].saledate === newArray[0][213] || data[i].saledate === newArray[0][214] || data[i].saledate === newArray[0][215] || data[i].saledate === newArray[0][216] || data[i].saledate === newArray[0][217] || data[i].saledate === newArray[0][218] || data[i].saledate === newArray[0][219] 
            || data[i].saledate === newArray[0][220] || data[i].saledate === newArray[0][221] || data[i].saledate === newArray[0][222] || data[i].saledate === newArray[0][223] || data[i].saledate === newArray[0][224] || data[i].saledate === newArray[0][225] || data[i].saledate === newArray[0][226] || data[i].saledate === newArray[0][227] || data[i].saledate === newArray[0][228] || data[i].saledate === newArray[0][229] 
           ...
           setPlanA21salelength(planAlength);
            ...
            if (data[i].saleprice >= data[i].listprice && (data[i].saledate === newArray[0][45] || data[i].saledate === newArray[0][46] || data[i].saledate === newArray[0][47] || data[i].saledate === newArray[0][48] || data[i].saledate === newArray[0][49] || data[i].saledate === newArray[0][50] || data[i].saledate === newArray[0][51] || data[i].saledate === newArray[0][52] || data[i].saledate === newArray[0][53] || data[i].saledate === newArray[0][54] || data[i].saledate === newArray[0][55] ||data[i].saledate === newArray[0][56] || data[i].saledate === newArray[0][57] || data[i].saledate === newArray[0][58] || data[i].saledate === newArray[0][59] || data[i].saledate === newArray[0][60] ||
             ...
             planBatabove.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].saleprice >= data[i].listprice && (data[i].saledate === newArray[0][90] || data[i].saledate === newArray[0][91] || data[i].saledate === newArray[0][92] || data[i].saledate === newArray[0][93] || data[i].saledate === newArray[0][94] || data[i].saledate === newArray[0][95] || data[i].saledate === newArray[0][96] || data[i].saledate === newArray[0][97] || data[i].saledate === newArray[0][98] || data[i].saledate === newArray[0][99] 
            ...
            || data[i].saledate === newArray[0][134] )){
             planCatabove.push(data[i]);
             console.log(planCatabove);  //gz
             planCatabove.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].saleprice >= data[i].listprice && (data[i].saledate === newArray[0][135] || data[i].saledate === newArray[0][136] || data[i].saledate === newArray[0][137] || data[i].saledate === newArray[0][138] || data[i].saledate === newArray[0][139]
            ||  data[i].saledate === newArray[0][140] || data[i].saledate === newArray[0][141] || data[i].saledate === newArray[0][142] || data[i].saledate === newArray[0][143] || data[i].saledate === newArray[0][144] || data[i].saledate === newArray[0][145] || data[i].saledate === newArray[0][146] || data[i].saledate === newArray[0][147] || data[i].saledate === newArray[0][148] || data[i].saledate === newArray[0][149] || data[i].saledate === newArray[0][150]    
             || data[i].saledate === newArray[0][151] || data[i].saledate === newArray[0][152] || data[i].saledate === newArray[0][153] || data[i].saledate === newArray[0][154] || data[i].saledate === newArray[0][155] || data[i].saledate === newArray[0][156] || data[i].saledate === newArray[0][157] || data[i].saledate === newArray[0][158] || data[i].saledate === newArray[0][159] || data[i].saledate === newArray[0][160]  || data[i].saledate === newArray[0][161] || data[i].saledate === newArray[0][162] || data[i].saledate === newArray[0][163] || data[i].saledate === newArray[0][164] || data[i].saledate === newArray[0][165] || data[i].saledate === newArray[0][166] || data[i].saledate === newArray[0][167] || data[i].saledate === newArray[0][168] || data[i].saledate === newArray[0][169]
            ||  data[i].saledate === newArray[0][170] || data[i].saledate === newArray[0][171] || data[i].saledate === newArray[0][172] || data[i].saledate === newArray[0][173] || data[i].saledate === newArray[0][174] || data[i].saledate === newArray[0][175] || data[i].saledate === newArray[0][176] || data[i].saledate === newArray[0][177] || data[i].saledate === newArray[0][178] || data[i].saledate === newArray[0][179]
             )){
             planDatabove.push(data[i]);
             console.log(planDatabove);  //gz
             planDatabove.sort((a, b) => b.saleprice - a.saleprice);
           ...
           if (data[i].saleprice >= data[i].listprice && (data[i].saledate === newArray[0][180] || data[i].saledate === newArray[0][181] || data[i].saledate === newArray[0][182] || data[i].saledate === newArray[0][183] || data[i].saledate === newArray[0][184] || data[i].saledate === newArray[0][185] || data[i].saledate === newArray[0][186] || data[i].saledate === newArray[0][187] || data[i].saledate === newArray[0][188] || data[i].saledate === newArray[0][189] 
            || data[i].saledate === newArray[0][190] || data[i].saledate === newArray[0][191] || data[i].saledate === newArray[0][192] || data[i].saledate === newArray[0][193] || data[i].saledate === newArray[0][194] || data[i].saledate === newArray[0][195] || data[i].saledate === newArray[0][196] || data[i].saledate === newArray[0][197] || data[i].saledate === newArray[0][198] || data[i].saledate === newArray[0][199] 
            || data[i].saledate === newArray[0][200] || data[i].saledate === newArray[0][201] || data[i].saledate === newArray[0][202] || data[i].saledate === newArray[0][203] || data[i].saledate === newArray[0][204] || data[i].saledate === newArray[0][205] || data[i].saledate === newArray[0][206] || data[i].saledate === newArray[0][207] || data[i].saledate === newArray[0][208] || data[i].saledate === newArray[0][209] 
            || data[i].saledate === newArray[0][210] || data[i].saledate === newArray[0][211] || data[i].saledate === newArray[0][212] || data[i].saledate === newArray[0][213] || data[i].saledate === newArray[0][214] || data[i].saledate === newArray[0][215] || data[i].saledate === newArray[0][216] || data[i].saledate === newArray[0][217] || data[i].saledate === newArray[0][218] || data[i].saledate === newArray[0][219] 
            || data[i].saledate === newArray[0][220] || data[i].saledate === newArray[0][221] || data[i].saledate === newArray[0][222] || data[i].saledate === newArray[0][223] || data[i].saledate === newArray[0][224] || data[i].saledate === newArray[0][225] || data[i].saledate === newArray[0][226] || data[i].saledate === newArray[0][227] || data[i].saledate === newArray[0][228] || data[i].saledate === newArray[0][229] 
            || data[i].saledate === newArray[0][230] || data[i].saledate === newArray[0][231] || data[i].saledate === newArray[0][232] || data[i].saledate === newArray[0][233] || data[i].saledate === newArray[0][234] || data[i].saledate === newArray[0][235] || data[i].saledate === newArray[0][236] || data[i].saledate === newArray[0][237] || data[i].saledate === newArray[0][238] || data[i].saledate === newArray[0][239] 
             ...
             planEatabove.push(data[i]);
             console.log(planEatabove);  
             planEatabove.sort((a, b) => b.saleprice - a.saleprice);
           ...
           function add(item, counter, array){
              ...
              planEOP.forEach(add15);
                  ...
                  const formatter = new Intl.NumberFormat('en-US', {
                   ...
                   setAverageSP39(formatter.format(Math.round(differentialF / planAlength)) || 0); //title
                   setAverageSP40(formatter.format(Math.round(differentialG / planBlength)) || 0); //title
                   setAverageSP41(formatter.format(Math.round(differentialH / planClength)) || 0); //title
                   setAverageSP42(formatter.format(Math.round(differentialI / planDlength)) || 0); //title
                   setAverageSP43(formatter.format(Math.round(differentialJ / planElength)) || 0); //title
...
const currentPageData50 = planA20atabovegreat
...
const pageCount50 = Math.ceil(planA20atabovegreat.length / PER_PAGE);  
...
const currentPageData56 = planB20atabovegreat
...
const pageCount56 = Math.ceil(planB20atabovegreat.length / PER_PAGE);  
...
const currentPageData62 = planC20atabovegreat
...
const pageCount62 = Math.ceil(planC20atabovegreat.length / PER_PAGE);  
...
const currentPageData68 = planD20atabovegreat
...
const pageCount68 = Math.ceil(planD20atabovegreat.length / PER_PAGE);  
...
const offset74 = currentPage74 * PER_PAGE;

const currentPageData74 = planE20atabovegreat
...
const pageCount74 = Math.ceil(planE20atabovegreat.length / PER_PAGE);  
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  const currentPageData49 = subaruWRX201
  ...
  const pageCount49 = Math.ceil(subaruWRX201.length / PER_PAGE);  
...
const currentPageData55 = subaruWRX202
...
const pageCount55 = Math.ceil(subaruWRX202.length / PER_PAGE);  
...
const currentPageData61 = subaruWRX203
...
const pageCount61 = Math.ceil(subaruWRX203.length / PER_PAGE);  
...
const offset67 = currentPage64 * PER_PAGE;

const currentPageData67 = subaruWRX204
...
const pageCount67 = Math.ceil(subaruWRX204.length / PER_PAGE);  
...
const currentPageData73 = subaruWRX205
...
const pageCount73 = Math.ceil(subaruWRX205.length / PER_PAGE);  
...
const [averageSP44, setAverageSP44] = React.useState(0);
const [averageSP45, setAverageSP45] = React.useState(0);
const [averageSP46, setAverageSP46] = React.useState(0);
const [averageSP47, setAverageSP47] = React.useState(0);
const [averageSP48, setAverageSP48] = React.useState(0);
       ...
       for (let i = 0; i<data.length; i++){
        ...
        ||  data[i].saledate === newArray[0][240])){
           ...
           setPlanA20salelength(planAlength);
            ...
            if (data[i].saleprice >= data[i].listprice && (data[i].saledate === newArray[0][46] || data[i].saledate === newArray[0][47] || data[i].saledate === newArray[0][48] || data[i].saledate === newArray[0][49] || data[i].saledate === newArray[0][50] || data[i].saledate === newArray[0][51] || data[i].saledate === newArray[0][52] || data[i].saledate === newArray[0][53] || data[i].saledate === newArray[0][54] || data[i].saledate === newArray[0][55] ||data[i].saledate === newArray[0][56] || data[i].saledate === newArray[0][57] || data[i].saledate === newArray[0][58] || data[i].saledate === newArray[0][59] || data[i].saledate === newArray[0][60] ||
              data[i].saledate === newArray[0][61] || data[i].saledate === newArray[0][62] || data[i].saledate === newArray[0][63] || data[i].saledate === newArray[0][64] || data[i].saledate === newArray[0][65] || data[i].saledate === newArray[0][66] || data[i].saledate === newArray[0][67] || data[i].saledate === newArray[0][68] || data[i].saledate === newArray[0][69] 
              || data[i].saledate === newArray[0][70] || data[i].saledate === newArray[0][71] || data[i].saledate === newArray[0][72] || data[i].saledate === newArray[0][73] || data[i].saledate === newArray[0][74] || data[i].saledate === newArray[0][75] || data[i].saledate === newArray[0][76] || data[i].saledate === newArray[0][77] || data[i].saledate === newArray[0][78] || data[i].saledate === newArray[0][79] || data[i].saledate === newArray[0][80] || data[i].saledate === newArray[0][81] || data[i].saledate === newArray[0][82] || data[i].saledate === newArray[0][83]
              || data[i].saledate === newArray[0][84] || data[i].saledate === newArray[0][85] || data[i].saledate === newArray[0][86] || data[i].saledate === newArray[0][87] || data[i].saledate === newArray[0][88] || data[i].saledate === newArray[0][89] || data[i].saledate === newArray[0][90])){
             planBatabove.push(data[i]);
           ...
           if (data[i].saleprice >= data[i].listprice && (data[i].saledate === newArray[0][136] || data[i].saledate === newArray[0][137] || data[i].saledate === newArray[0][138] || data[i].saledate === newArray[0][139]
            ||  data[i].saledate === newArray[0][140] || data[i].saledate === newArray[0][141] || data[i].saledate === newArray[0][142] || data[i].saledate === newArray[0][143] || data[i].saledate === newArray[0][144] || data[i].saledate === newArray[0][145] || data[i].saledate === newArray[0][146] || data[i].saledate === newArray[0][147] || data[i].saledate === newArray[0][148] || data[i].saledate === newArray[0][149] || data[i].saledate === newArray[0][150]    
             || data[i].saledate === newArray[0][151] || data[i].saledate === newArray[0][152] || data[i].saledate === newArray[0][153] || data[i].saledate === newArray[0][154] || data[i].saledate === newArray[0][155] || data[i].saledate === newArray[0][156] || data[i].saledate === newArray[0][157] || data[i].saledate === newArray[0][158] || data[i].saledate === newArray[0][159] || data[i].saledate === newArray[0][160]  
            ||  data[i].saledate === newArray[0][170] || data[i].saledate === newArray[0][171] || data[i].saledate === newArray[0][172] || data[i].saledate === newArray[0][173] || data[i].saledate === newArray[0][174] || data[i].saledate === newArray[0][175] || data[i].saledate === newArray[0][176] || data[i].saledate === newArray[0][177] || data[i].saledate === newArray[0][178] || data[i].saledate === newArray[0][179] || data[i].saledate === newArray[0][180]
            || data[i].saledate === newArray[0][180])){
           ...
           if (data[i].saleprice >= data[i].listprice && (data[i].saledate === newArray[0][181] || data[i].saledate === newArray[0][182] || data[i].saledate === newArray[0][183] || data[i].saledate === newArray[0][184] || data[i].saledate === newArray[0][185] || data[i].saledate === newArray[0][186] || data[i].saledate === newArray[0][187] || data[i].saledate === newArray[0][188] || data[i].saledate === newArray[0][189] 
            || data[i].saledate === newArray[0][190] || data[i].saledate === newArray[0][191] || data[i].saledate === newArray[0][192] || data[i].saledate === newArray[0][193] || data[i].saledate === newArray[0][194] || data[i].saledate === newArray[0][195] || data[i].saledate === newArray[0][196] || data[i].saledate === newArray[0][197] || data[i].saledate === newArray[0][198] || data[i].saledate === newArray[0][199] 
            || data[i].saledate === newArray[0][200] || data[i].saledate === newArray[0][201] || data[i].saledate === newArray[0][202] || data[i].saledate === newArray[0][203] || data[i].saledate === newArray[0][204] || data[i].saledate === newArray[0][205] || data[i].saledate === newArray[0][206] || data[i].saledate === newArray[0][207] || data[i].saledate === newArray[0][208] || data[i].saledate === newArray[0][209] 
            || data[i].saledate === newArray[0][210] || data[i].saledate === newArray[0][211] || data[i].saledate === newArray[0][212] || data[i].saledate === newArray[0][213] || data[i].saledate === newArray[0][214] || data[i].saledate === newArray[0][215] || data[i].saledate === newArray[0][216] || data[i].saledate === newArray[0][217] || data[i].saledate === newArray[0][218] || data[i].saledate === newArray[0][219] 
            || data[i].saledate === newArray[0][220] || data[i].saledate === newArray[0][221] || data[i].saledate === newArray[0][222] || data[i].saledate === newArray[0][223] || data[i].saledate === newArray[0][224] || data[i].saledate === newArray[0][225] || data[i].saledate === newArray[0][226] || data[i].saledate === newArray[0][227] || data[i].saledate === newArray[0][228] || data[i].saledate === newArray[0][229] 
           ...
           function add(item, counter, array){
              ...
              planEOP.forEach(add15);
                  ...
                  const formatter = new Intl.NumberFormat('en-US', {
                   ...
                   setAverageSP44(formatter.format(Math.round(differentialF / planAlength)) || 0); //title
                   setAverageSP45(formatter.format(Math.round(differentialG / planBlength)) || 0); //title
                   setAverageSP46(formatter.format(Math.round(differentialH / planClength)) || 0); //title
                   setAverageSP47(formatter.format(Math.round(differentialI / planDlength)) || 0); //title
                   setAverageSP48(formatter.format(Math.round(differentialJ / planElength)) || 0); //title
...
const currentPageData76 = headlights
...
const pageCount76 = Math.ceil(headlights.length / PER_PAGE);  
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     const [headlights2, setHeadlights2] = React.useState([]);
      ...
      ////pagination...    
const [currentPage78, setCurrentPage78] = React.useState(0);
              
              
              
              
function handlePageClick78({ selected: selectedPage}){
setCurrentPage78(selectedPage);
}

const offset78 = currentPage78 * PER_PAGE;

const currentPageData78 = headlights2
.slice(offset78, offset78 + PER_PAGE)
.map((item, index) => (
...
const pageCount78 = Math.ceil(headlights2.length / PER_PAGE);  
...
const currentPageData80 = headlights3
...
const pageCount80 = Math.ceil(headlights3.length / PER_PAGE);  
...
const currentPageData82 = headlights4
...
const pageCount82 = Math.ceil(headlights4.length / PER_PAGE);  
...
const currentPageData84 = headlights5
...
const pageCount84 = Math.ceil(headlights5.length / PER_PAGE);  
...
const currentPageData86 = headlights6
...
const pageCount86 = Math.ceil(headlights6.length / PER_PAGE);  
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     const [headlights7, setHeadlights7] = React.useState([]);
     const [headlights8, setHeadlights8] = React.useState([]);
...
const currentPageData77 = greatgun14
...
const pageCount77 = Math.ceil(greatgun14.length / PER_PAGE);  
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     ////pagination...    
const [currentPage79, setCurrentPage79] = React.useState(0);
              
              
              
              
function handlePageClick79({ selected: selectedPage}){
setCurrentPage79(selectedPage);
}

const offset79 = currentPage79 * PER_PAGE;

const currentPageData79 = greatgun30
.slice(offset79, offset79 + PER_PAGE)
.map((item, index) => (
...
const pageCount79 = Math.ceil(greatgun30.length / PER_PAGE);  
...
const currentPageData81 = greatgun45
...
const pageCount81 = Math.ceil(greatgun45.length / PER_PAGE);  
...
const currentPageData83 = greatgun90
...
const pageCount83 = Math.ceil(greatgun90.length / PER_PAGE);  
...
const currentPageData85 = greatgun120
...
const pageCount85 = Math.ceil(greatgun120.length / PER_PAGE);  
...
const currentPageData87 = greatgun121
...
const pageCount87 = Math.ceil(greatgun121.length / PER_PAGE);  
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     const [greatgun240, setGreatgun240] = React.useState([]);
     const [greatgun301, setGreatgun301] = React.useState([]);

const [averageSP49, setAverageSP49] = React.useState(0);
const [averageSP50, setAverageSP50] = React.useState(0);
const [averageSP51, setAverageSP51] = React.useState(0);
const [averageSP52, setAverageSP52] = React.useState(0);
const [averageSP53, setAverageSP53] = React.useState(0);
const [averageSP54, setAverageSP54] = React.useState(0);
//commercial render...
const [averageSP55, setAverageSP55] = React.useState(0);
const [averageSP56, setAverageSP56] = React.useState(0);
         ...
         for (let i = 0; i<data.length; i++){
           ...
           || data[i].saledate === newArray[0][230] || data[i].saledate === newArray[0][231] || data[i].saledate === newArray[0][232] || data[i].saledate === newArray[0][233] || data[i].saledate === newArray[0][234] || data[i].saledate === newArray[0][235] || data[i].saledate === newArray[0][236] || data[i].saledate === newArray[0][237] || data[i].saledate === newArray[0][238] || data[i].saledate === newArray[0][239] )){
             ...
             if (data[i].DOM > 121 && data[i].DOM <= 180){
               ...
               onetwentyAP.push(data[i]);
             }
             if (data[i].saleprice >= data[i].listprice && data[i].DOM > 121 && data[i].DOM <= 180){
              great120.push(data[i]);
              console.log(great120);
              great120.sort((a, b) => b.saleprice - a.saleprice);
             ...
             if (data[i].DOM > 180 && data[i].DOM <= 240){
               ...
               onetwooneAP.push(data[i]);
             }
             if (data[i].saleprice >= data[i].listprice && data[i].DOM > 180 && data[i].DOM <= 240){
              great121.push(data[i]);
            ...
            //  twofourzero.push(data[i]);
            //  twofourzero.sort((a, b) => b.saleprice - a.saleprice);
            //  setHeadlights7(twofourzero);
              //twofourzeroAP.push(data[i]);
          //  }
          //  if (data[i].saleprice >= data[i].listprice && data[i].DOM > 240 && data[i].DOM <= 300){
           //   great240.push(data[i]);
            //  console.log(great121);
            //  great240.sort((a, b) => b.saleprice - a.saleprice);
           //   setGreatgun240(great240);
          //  }
          //  if (data[i].DOM > 300){
            //  threehundredone.push(data[i]);
            //  threehundredone.sort((a, b) => b.saleprice - a.saleprice);
            //  setHeadlights8(threehundredone);
            //  threehundredoneAP.push(data[i]);
          //  }
         //   if (data[i].saleprice >= data[i].listprice && data[i].DOM > 300){
           //   great301.push(data[i]);
           //   console.log(great301);
           //   great301.sort((a, b) => b.saleprice - a.saleprice);
           //   setGreatgun301(great301);
          //  }
            //
...
//threehundredoneAP.forEach(add25); 
...
setAverageSP49(formatter.format(Math.round(differential18 / sale14)) || 0);
setAverageSP50(formatter.format(Math.round(differential19 / sale30)) || 0);
setAverageSP51(formatter.format(Math.round(differential20 / sale45)) || 0);
setAverageSP52(formatter.format(Math.round(differential21 / sale90)) || 0);
setAverageSP53(formatter.format(Math.round(differential22 / sale120)) || 0);
setAverageSP54(formatter.format(Math.round(differential23 / sale121)) || 0);
//commercial render...
//setAverageSP55(formatter.format(Math.round(differential24 / sale240)) || 0);
//setAverageSP56(formatter.format(Math.round(differential25 / sale301)) || 0);
      ...
      function useHover() {
       ...
       return(
         <>
          <div id='DKre' className='background64'>
                  <a className='fontnav64' style={{zIndex: '7', position: 'absolute', left: '75px', top: '45px' }}href='/activesinglefamily' {...buttonDHoverProps}>{buttonDIsHovering ? 'Click here to applyscience' : 'Single Family'}</a>
                    ...
                    <img  id="batsymbol" src={NeilWhite} width={255} height={350} style={{zIndex: '7', position: 'absolute', left: '500px', top: '54px' }} />
                    ...
                    <a className='fontnav64' style={{zIndex: '7', position: 'absolute', left: '1050px', top: '45px' }}href='/applysciencewaterfront' {...buttonCHoverProps}>{buttonCIsHovering ? 'Click here to applyscience' : 'Commercial'}</a>
                    </div>   
                    <div className='back'>
   ...
   <div className='hashh66'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Seller</div>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='/activecommercial#map'>MAP</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/activecommercial">Active</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '375px' }}href='/carapp'>Buyer</a>
    <br/>
    <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/carappwaterfront'>WaterFront</a>
...
<div className='autoy' itemsPerRow={3} style={{ marginTop: 20 }}>
                    ...
                    filteredResults.map((item) => {
                        return (
                            <div>
                                ...
                                <Popup
      trigger={<div className='inputbatactives'>{item.streetAddress}</div>}
      position="center"
      modal
      nested       
      >
      
      <div className="modalpopactive" tabindex='0'>
                 ...
                 <ul>
         <br/>
         <div className='borderspopactive'>
         <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>List Price: {formatter.format(item.listprice)}</td><br/>
   <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.streetAddress} </td>
   <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.townstate} {item.zipcode}</td><br/>
   <td style={{zIndex: '7', position: 'absolute', left: '70px', top: '190px' }} className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td><br/>
   <td style={{zIndex: '7', position: 'absolute', left: '70px', top: '245px' }} className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td><br/>
        <td style={{zIndex: '7', position: 'absolute', left: '70px', top: '300px' }} className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td><br/>
   <td style={{zIndex: '7', position: 'absolute', left: '780px', top: '190px' }} className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.bedrooms} bds</td><br/>
    <td style={{zIndex: '7', position: 'absolute', left: '780px', top: '245px' }} className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.bathrooms} ba</td><br/>
    <td style={{zIndex: '7', position: 'absolute', left: '780px', top: '300px' }} className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.livingArea} sqft</td><br/>
          <br/>
          
          <Popup
               trigger={<img style={{zIndex: '7', height: '260px', width: '580px', position: 'absolute', left: '190px', top: '155px'}} src={item.photosMAIN}></img>} 
               position="center" 
               modal
               nested       
             >
      ...
      <div className="modalpopactive" tabindex='0'> 
                 ...
                 <ul> 
         <br/>
         <div className='borderspopactive2'>
         <br/>
    <img style={{zIndex: '7', height: '260px', width: '580px', left: '50%'}} src={item.photosMAIN}></img><br/>
    <br/>
    <img style={{zIndex: '7', height: '260px', width: '580px', left: '50%' }} src={item.photos[1]}></img><br/>
    <br/>
    <img style={{zIndex: '7', height: '260px', width: '580px', left: '50%' }} src={item.photos[2]}></img><br/>
    <br/>
    <img style={{zIndex: '7', height: '260px', width: '580px', left: '50%'}} src={item.photos[3]}></img><br/>
    <br/>
    <img style={{zIndex: '7', height: '260px', width: '580px', left: '50%'}} src={item.photos[4]}></img><br/>
    <br/>
    <img style={{zIndex: '7', height: '260px', width: '580px', left: '50%' }} src={item.photos[5]}></img>
    <br/>
      </div>
      </ul>
    ...
    <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>{item.description}</td>
   ...
   <br/>
   <br/>
  <Popup lockScroll={true} trigger={<a id ='inject' title={titleavgdiff} className='awater' href='#/inject' style={{zIndex: '7', position: 'absolute', left: '820px', top: '605px' }}></a>}
...
{close => (
   ...
   <a id ='harley' href='#' className='awater' style={{zIndex: '7', position: 'absolute', left: '1065px', top: '605px' }}></a>
   ...
   <a id ='oj' href='#' className='awater' style={{zIndex: '7', position: 'absolute', left: '1065px', top: '680px' }}></a>
   <div  className='fontwater' style={{zIndex: '7', position: 'absolute', left: '990px', top: '695px' }}>Avg. List___________</div>
  <Popup lockScroll={true} trigger={<a id ='threebears' title={titleavgdiff} href='#/threebears' className='awater' style={{zIndex: '7', position: 'absolute', left: '820px', top: '755px' }}></a>}
  position='center' modal nested>
{close => (
   ...
   <a id ='lordof' href='#' className='awater' style={{zIndex: '7', position: 'absolute', left: '1105px', top: '755px' }}></a>
   <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '990px', top: '770px' }}>Avg. Differential___________</div>
   <a id ='min' href='#' className='awaterHL' style={{zIndex: '7', position: 'absolute', left: '770px', top: '830px' }}></a>
   <a id ='max' href='#' className='awaterHL' style={{zIndex: '7', position: 'absolute', left: '870px', top: '830px' }}></a>
   ...
   <h2 className='yeartitle' style={{zIndex: '7', position: 'absolute', left: '305px', top: '510px' }}>2021</h2>
   <br/>
   <br/>
    <Popup lockScroll={true} trigger={<a id ='inject21' title={titleavgdiff2} className='awater' href='#/inject21' style={{zIndex: '7', position: 'absolute', left: '215px', top: '605px' }}></a>}
    position='center' modal nested>
  {close => (
   ...
   <Popup lockScroll={true} trigger={<a id ='threebears21' title={titleavgdiff2} href='#/threebears21' className='awater' style={{zIndex: '7', position: 'absolute', left: '215px', top: '755px' }}></a>}
   position='center' modal nested>
 {close => (
   ...
   <a id ='min21' href='#' className='awaterHL' style={{zIndex: '7', position: 'absolute', left: '150px', top: '830px' }}></a>
   <a id ='max21' href='#' className='awaterHL' style={{zIndex: '7', position: 'absolute', left: '260px', top: '830px' }}></a>
   ...
   <br/>
    ...
    >
      <option id='value' style={{zIndex: '7', position: 'absolute', left: '1100px', top: '850px' }}>---Choose State--</option>
      {GLOBE1.states.map((value, key) => {
        return(
          ...
          >
            <option style={{zIndex: '7', position: 'absolute', left: '990px', top: '870px' }}>--Choose County--</option>
   ...
   <br/>
   <br/>
       <input className='inputbat' style={{zIndex: '7', position: 'absolute', left: '990px', top: '800px' }}type='number' onChange={(e)=> setPrice1(e.target.value)}/>
       <input className='inputbat' style={{zIndex: '7', position: 'absolute', left: '990px', top: '825px' }}type='number' onChange={(e)=> setPrice2(e.target.value)}/>
       <Button className='button' style={{zIndex: '7', position: 'absolute', left: '855px', top: '870px' }}variant='dark' type="button" value='Submit' onClick={()=> {brucewayne22a(); brucewayne22b(); brucewayne21a(); brucewayne21b();}}>Apply Science</Button>
     <br/>
     <br/>
     <br/>
  ...
  <Popup lockScroll={true} trigger={<a id ='threek21' className='awater' title={averageSP26} href='#/threek21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1060px' }}></a>}
  position='center' modal nested>
{close => (
  ...
  <Popup lockScroll={true} trigger={<a id ='threek' className='awater' title={averageSP30} href='#/threek' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1060px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a id ='s3k' href='#' className='awater' style={{zIndex: '7', position: 'absolute', left: '505px', top: '1060px' }}></a>
  ...
  <Popup lockScroll={true} trigger={<a id ='fourk21' className='awater' title={averageSP27} href='#/fourk21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1135px' }}></a>}
  position='center' modal nested>
{close => (
  ...
  <Popup lockScroll={true} trigger={<a id ='fourk' className='awater' title={averageSP31} href='#/fourk' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1135px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a id ='s4k' href='#' className='awater' style={{zIndex: '7', position: 'absolute', left: '505px', top: '1135px' }}></a>
   ...
   <Popup lockScroll={true} trigger={<a id ='sevenk21' className='awater' title={averageSP28} href='#/sevenk21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1210px' }}></a>}
   position='center' modal nested>
 {close => (
...
<div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '205px', top: '1225px' }}>______________</div>
  <Popup lockScroll={true} trigger={<a id ='sevenk' className='awater' title={averageSP32} href='#/sevenk' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1210px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a id ='s7k' href='#' className='awater' style={{zIndex: '7', position: 'absolute', left: '505px', top: '1210px' }}></a>
  ...
  <Popup lockScroll={true} trigger={<a id ='sevenfivek21' className='awater' title={averageSP29} href='#/sevenfivek21' style={{zIndex: '7', position: 'absolute', left: '235px', top: '1285px' }}></a>}
  position='center' modal nested>
{close => (
   ...
   <Popup lockScroll={true} trigger={<a id ='sevenfivek' className='awater' title={averageSP33} href='#/sevenfivek' style={{zIndex: '7', position: 'absolute', left: '370px', top: '1285px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a id ='s75k' href='#' className='awater' style={{zIndex: '7', position: 'absolute', left: '505px', top: '1285px' }}></a>
         ...
         <select style={{zIndex: '7', position: 'absolute', left: '75px', top: '1335px' }}
          ...
          >
      <option id='value' style={{zIndex: '7', position: 'absolute', left: '75px', top: '1325px' }}>---Choose State--</option>
      {GLOBE1.states.map((value, key) => {
        return(
          ...
          >
            <option style={{zIndex: '7', position: 'absolute', left: '75px', top: '1430px' }}>--Choose County--</option>
        ...
        <select style={{zIndex: '7', position: 'absolute', left: '225px', top: '1335px' }}
         ...
         <br/>
         <br/>
         <Button className='button' style={{zIndex: '7', position: 'absolute', left: '217px', top: '1357px' }}variant='dark' type="button" value='Submit' onClick={()=> {sealteam1(); sealteam2(); sealteam3(); sealteam4(); straitofhormuz5();}}>Apply Science</Button>
        
       <div id='salesTpopulate22' className='a12water' style={{zIndex: '7', position: 'absolute', left: '395px', top: '1372px' }}></div>
       <div id='salesTpopulate21' className='a12water' style={{zIndex: '7', position: 'absolute', left: '395px', top: '1345px' }}></div>
  
   <br/>
   <br/>
   <br/>
   <img style={{height: '360px', width: '570px', left: '55px', top: '1415px', position: 'absolute' }}  src={sanfran} alt='chicagowheel' />
   <br/>
   <br/>
         <div className='fontwater' id='DOMTotalsalesinnerElement' style={{zIndex: '7', position: 'absolute', left: '88px', top: '1425px'}}></div>
         <div className='fontwater' id='DOM85innerElement' style={{zIndex: '7', position: 'absolute', left: '88px', top: '1450px'}}></div>
         <a></a>
         <br/>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '75px', top: '1806px' }}>1/1/2021 - 3/31/2021:</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '240px', top: '1781px' }}>sales</div>
         <a></a>
         <Popup lockScroll={true} trigger={<a id='quarterly' className='awater' title={averageSP22} href='#/quarterly' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1806px' }} ></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
          previousLabel={"<- Previous"}
          nextLabel={"Next ->"}
          pageCount={pageCount90}
          onPageChange={handlePageClick90}
          initialPage={0}
          containerClassName={"pagination"}
          previousLinkClassName={"pagination__link"}
          nextLinkClassName={"pagination__link--disabled"}
         ...
         <a></a>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '310px', top: '1781px' }}>belowList rate</div>
         <Popup lockScroll={true} trigger={<a id='catchmaxmil' className='awater' title={popquoteJan} href='#/catchmaxmil' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1806px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
          previousLabel={"<- Previous"}
          nextLabel={"Next ->"}
          pageCount={pageCount91}
          onPageChange={handlePageClick91}
          initialPage={0}
          containerClassName={"pagination"}
          previousLinkClassName={"pagination__link"}
          nextLinkClassName={"pagination__link--disabled"}
         ...
         <div ></div>
         <a></a>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '435px', top: '1781px' }}>differential</div>
         <div id='lordof2' className='awater' style={{zIndex: '7', position: 'absolute', left: '450px', top: '1806px' }}></div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '550px', top: '1781px' }}>DOMavg</div>
         <div id='sultan2' className='awater' style={{zIndex: '7', position: 'absolute', left: '550px', top: '1806px' }}></div>
        <br/>
        <br/>
        <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '75px', top: '1856px' }}>4/1/2021 - 6/30/2021:</div>
         <a></a>
         <Popup lockScroll={true} trigger={<a id='quarterly21' className='awater' title={averageSP23}  href='#/quarterly21' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1856px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
          previousLabel={"<- Previous"}
          nextLabel={"Next ->"}
          pageCount={pageCount92}
          onPageChange={handlePageClick92}
          initialPage={0}
          containerClassName={"pagination"}
          previousLinkClassName={"pagination__link"}
          nextLinkClassName={"pagination__link--disabled"}
         ...
         <a></a>
         <Popup lockScroll={true} trigger={<a id='catchmaxmil21' className='awater' title={popquoteApril} href='#/catchmaxmil21' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1856px' }} ></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
          previousLabel={"<- Previous"}
          nextLabel={"Next ->"}
          pageCount={pageCount93}
          onPageChange={handlePageClick93}
          initialPage={0}
          containerClassName={"pagination"}
          previousLinkClassName={"pagination__link"}
          nextLinkClassName={"pagination__link--disabled"}
         ...
         <div ></div>
         <a></a>
         <div id='lordof212'className='awater' style={{zIndex: '7', position: 'absolute', left: '450px', top: '1856px' }}></div>
         <div id='sultan212'className='awater' style={{zIndex: '7', position: 'absolute', left: '550px', top: '1856px' }}></div>
         <br/>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '75px', top: '1906px' }}>7/1/2021 - 9/30/2021:</div>
         <a></a>
         <Popup lockScroll={true} trigger={<a id='quarterly20' className='awater' title={averageSP24} href='#/quarterly20' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1906px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
          previousLabel={"<- Previous"}
          nextLabel={"Next ->"}
          pageCount={pageCount94}
          onPageChange={handlePageClick94}
          initialPage={0}
          containerClassName={"pagination"}
          previousLinkClassName={"pagination__link"}
          nextLinkClassName={"pagination__link--disabled"}
         ...
         <a></a>
         <Popup lockScroll={true} trigger={<a id='catchmaxmil20' className='awater' title={popquoteJuly} href='#/catchmaxmil20' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1906px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
          previousLabel={"<- Previous"}
          nextLabel={"Next ->"}
          pageCount={pageCount95}
          onPageChange={handlePageClick95}
          initialPage={0}
          containerClassName={"pagination"}
          previousLinkClassName={"pagination__link"}
          nextLinkClassName={"pagination__link--disabled"}
         ...
         <div ></div>
         <a></a>
         <div id='lordof20' className='awater' style={{zIndex: '7', position: 'absolute', left: '450px', top: '1906px' }}></div>
         <div id='sultan20' className='awater' style={{zIndex: '7', position: 'absolute', left: '550px', top: '1906px' }}></div>
         <br/>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '75px', top: '1956px' }}>10/1/2021 - 12/31/2021:</div>
         <a></a>
         <Popup lockScroll={true} trigger={<a id='quarterly19' className='awater' title={averageSP25} href='#/quarterly19' style={{zIndex: '7', position: 'absolute', left: '250px', top: '1956px' }}></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
          previousLabel={"<- Previous"}
          nextLabel={"Next ->"}
          pageCount={pageCount96}
          onPageChange={handlePageClick96}
          initialPage={0}
          containerClassName={"pagination"}
          previousLinkClassName={"pagination__link"}
          nextLinkClassName={"pagination__link--disabled"}
         ...
         <a></a>
         <Popup lockScroll={true} trigger={<a id='catchmaxmil19' className='awater' title={popquoteOctober} href='#/catchmaxmil19' style={{zIndex: '7', position: 'absolute', left: '350px', top: '1956px' }} ></a>}
   position='center' modal nested>
 {close => (
    <div className="modal" tabindex='0'>
      <button className="close" onClick={close}>
      ...
      <div className="actions">
        <ReactPaginate
          previousLabel={"<- Previous"}
          nextLabel={"Next ->"}
          pageCount={pageCount97}
          onPageChange={handlePageClick97}
          initialPage={0}
          containerClassName={"pagination"}
          previousLinkClassName={"pagination__link"}
          nextLinkClassName={"pagination__link--disabled"}
         ...
         <a></a>
         <div id='lordof211' className='awater' style={{zIndex: '7', position: 'absolute', left: '450px', top: '1956px' }}></div>
         <div id='sultan211' className='awater' style={{zIndex: '7', position: 'absolute', left: '550px', top: '1956px' }}></div>
         <br/>
         <br/>
         <br/>
         <a id='townhash' className='hashh'  style={{zIndex: '7', position: 'absolute', left: '41px', top: '915px' }} href='#mozart'>Business Planning</a>
         <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '41px', top: '935px' }} href='#marketANThashh'>Market ANT</a>
         <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '41px', top: '955px' }} href='#populatequote11'>Price Range</a>
         <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '41px', top: '975px' }} href='#ntdoubleu297'>Nav297</a>
         <h5 className='awater' style={{zIndex: '7', position: 'absolute', left: '160px', top: '915px' }}>Previous 5 Month Market Condition Sales</h5>
     <h5 className='awater' style={{zIndex: '7', position: 'absolute', left: '731px', top: '915px'}}>Previous 5 Month Market Condition Sales 2022</h5>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1000px' }}>0-30 days</a>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='s14' className='a1water' title={averageSPfm} href='#/s14' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1000px' }} ></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fr14' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1000px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r14' title={totallessdiff14} href='#/r14' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1000px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='d14' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1000px' }}></div>
         <br/>
         <br/>
   <Popup lockScroll={true} trigger={<a id ='s30' className='a1water' title={averageSP2fm} href='#/s30' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1050px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
          <a></a>
         <div id='fr30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1050px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='r30' title={totallessdiff30} href='#/r30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1050px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='d30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1050px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1100px' }}>61-90 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='s45' className='a1water' title={averageSP3fm} href='#/s45' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1100px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fr45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1100px' }}></div>
         <a></a> 
  <Popup lockScroll={true} trigger={<a id='r45' title={totallessdiff45} href='#/r45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1100px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='d45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1100px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1150px' }}>91-120 days</a>
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='s90' className='a1water' href='#/s90' title={averageSP4fm} style={{zIndex: '7', position: 'absolute', left: '820px', top: '1150px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fr90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1150px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='r90' title={totallessdiff90} href='#/r90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1150px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='d90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1150px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1200px' }}>121-180 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s120' className='a1water' title={averageSP5fm} href='#/s120' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1200px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fr120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1200px' }}></div>
         <a></a>
         <Popup lockScroll={true} trigger={<a id='r120' title={totallessdiff120} href='#/r120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1200px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='d120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1200px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' id='matchesmaloneinf' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1250px' }}>181-240 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s121' className='a1water' title={averageSP6fm} href='#/s121' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1250px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fr121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1250px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r121' title={totallessdiff121} href='#/r121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1250px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='d121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1250px' }}></div>
         <br/>
         <a className='fontwater' id='matchesmaloneinf' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1300px' }}>241-300 days</a>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='s240' className='a1water' title={averageSP7fm} href='#/s240' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1300px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fr240' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1300px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r240' title={totallessdiff240} href='#/r240' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1300px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='d240' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1300px' }}></div>
         <br/>
         <a className='fontwater' id='matchesmaloneinf' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1350px' }}>301+ days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='s301' className='a1water' title={averageSP8fm} href='#/s301' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1350px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fr301' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1350px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='r301' title={totallessdiff301} href='#/r301' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1350px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='d301' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1350px' }}></div>
         <br/>
     <br/>
     ...
     <div style={{zIndex: '7', position: 'absolute', left: '100px', top: '1400px' }}>----------------------------------------------</div>
       ...
       <select style={{zIndex: '7', position: 'absolute', left: '900px', top: '1450px' }}
          ...
          >
      <option id='value' style={{zIndex: '7', position: 'absolute', left: '900px', top: '1450px' }}>---Choose State--</option>
      {GLOBE1.states.map((value, key) => {
        return(
          ...
          >
            <option style={{zIndex: '7', position: 'absolute', left: '900px', top: '1470px' }}>--Choose County--</option>
       ...
       <br/>
       <br/>
       <h5 className='awater' id='populatequote11' style={{zIndex: '7', position: 'absolute', left: '715px', top: '1380px'}}>Previous 5 Month Market Condition Sales 2022</h5>
       <br/>
       ...
       <div id='salesTpopulate' className='a12water' title={avgsalesavg} style={{zIndex: '7', position: 'absolute', left: '1060px', top: '1450.5px' }}></div>
       <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '1045px', top: '1480px', width: '76px', height: '30.5px', borderRadius: '31%', background: 'rgb(135, 135, 135)', border: '3.5px solid rgb(64, 64, 64)' }}></div>
       <div id='avgDOMpopulate' className='a12water' title={avgsalesavg} style={{zIndex: '7', position: 'absolute', left: '1060px', top: '1488px' }}></div>
       <br/>
       <br/>
       <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1130px', top: '1442.5px', width: '126px', height: '31.5px', borderRadius: '31%', background: 'rgb(135, 135, 135)', border: '3.5px solid rgb(64, 64, 64)' }}></div>
       <div id='avgListpopulate' className='a12water' title={listsaleslist} style={{zIndex: '7', position: 'absolute', left: '1145px', top: '1450.5px' }}></div>
       <br/>
       <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1130px', top: '1480px', width: '126px', height: '31.5px', borderRadius: '31%', background: 'rgb(135, 135, 135)', border: '3.5px solid rgb(64, 64, 64)' }}></div>
       <div id='avgSalepopulate' className='a12water' title={salesalessale} style={{zIndex: '7', position: 'absolute', left: '1145px', top: '1488px' }}></div>


       <input className='inputbat' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1450px'}} type='number' onChange={(e)=> setPricevalue(e.target.value)}/>
     <input className='inputbat' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1470px'}}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
     <Button id='benjamin' className='button' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1500px'}} variant='dark' type="button" value='Submit' onClick={() => {populateQuote(); DOM85PopulateQuote(); DOM85AbovePopulateQuote(); sealteam5(); sealteam6(); zerodark30(); jack10suit();}}>Apply Science</Button>
     ...
     <div id='DOM85populatequote' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '835px', top: '1515px'}}></div>
     <div id='DOM85abovepopulatequote' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '835px', top: '1530px'}}></div>
     <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1575px' }}>0-14 days</a>
         <a></a>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1550px' }}>sales</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '936px', top: '1550px' }}>belowList rate</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '1115px', top: '1550px' }}>differential</div>
  <Popup lockScroll={true} trigger={<a id ='sales14' className='a1water' title={averageSP16am} href='#/sales14' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1575px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fraction14' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1575px' }}></div>
         <a></a>
  <Popup lockScroll={true} trigger={<a id='rates14' title={belowdiffrates14avg} href='#/rates14' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1575px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='duff14' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1575px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1625px' }}>31-60 days</a>
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='sales30' className='a1water' title={averageSP17am} href='#/sales30' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1625px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fraction30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1625px' }}></div>
         <a></a>
  <Popup lockScroll={true} trigger={<a id='rates30' title={belowdiffrates30avg} href='#/rates30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1625px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='duff30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1625px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1675px' }}>61-90 days</a>
         <a></a>
  <Popup lockScroll={true} trigger={ <a id ='sales45' className='a1water' title={averageSP18am} href='#/sales45' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1675px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fraction45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1675px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates45' title={belowdiffrates45avg} href='#/rates45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1675px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='duff45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1675px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1725px' }}>91-120 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales90' className='a1water' title={averageSP19am} href='#/sales90' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1725px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fraction90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1725px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates90' title={belowdiffrates90avg} href='#/rates90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1725px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='duff90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1725px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1775px' }}>121-180 days</a>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='sales120' className='a1water' title={averageSP20am} href='#/sales120' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1775px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fraction120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1775px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates120' title={belowdiffrates120avg} href='#/rates120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1775px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='duff120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1775px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1825px' }}>181-240</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales121' className='a1water' title={averageSP21am} href='#/sales121' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1825px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fraction121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1825px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates121' title={belowdiffrates121avg} href='#/rates121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1825px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='duff121' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1825px' }}></div>
         <br/>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1875px' }}>241-300</a>
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='sales240' className='a1water' title={averageSP22am} href='#/sales240' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1875px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fraction240' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1875px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates240' title={belowdiffrates240avg} className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1875px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='duff240' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1875px' }}></div>
         <br/> 
         <br/>
         <br/>
         <a id='matchesmaloneinfin' className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1925px' }}>301+</a>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='sales301' className='a1water' title={averageSP23am} href='#/sales301' style={{zIndex: '7', position: 'absolute', left: '820px', top: '1925px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fraction301' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '1925px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates301' title={belowdiffrates301avg} className='a1water' style={{zIndex: '7', position: 'absolute', left: '1020px', top: '1925px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='duff301' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1120px', top: '1925px' }}></div>
         <br/>
       <select style={{zIndex: '7', position: 'absolute', left: '100px', top: '1985px' }}

          placeholder='State'
          value={selectedState4}
          onChange={(e) => setSelectedState4(e.target.value)}
          >
      <option id='value' style={{zIndex: '7', position: 'absolute', left: '100px', top: '1985px' }}>---Choose State--</option>
      {GLOBE1.states.map((value, key) => {
        return(
          <option id='value' style={{zIndex: '7', position: 'absolute', left: '100px', top: '1985px' }} value={value.name} key={key}>{value.name}</option>);
        })}
        </select>
          <select style={{zIndex: '7', position: 'absolute', left: '100px', top: '2010px' }}
                   placeholder='County'
                   value={county4}
                   onChange={(e) => setCounty4(e.target.value)}
          >
            <option style={{zIndex: '7', position: 'absolute', left: '100px', top: '2045px' }}>--Choose County--</option>
            {availableState4?.counties.map((e, key) => {
              return (
                <option style={{zIndex: '7', position: 'absolute', left: '100px', top: '2010px' }} value={e.name} key={key}>{e.name}</option>
              );
            })}
            </select>
       
        <select style={{zIndex: '7', position: 'absolute', left: '100px', top: '2035px' }}
          placeholder='Town'
          value={town}
          onChange={(e) => setTown(e.target.value)}>
            <option style={{zIndex: '7', position: 'absolute', left: '100px', top: '2035px' }}>--Choose Town--</option>
            {availableTowns4?.towns.map((e, key) => {
              return (
                <option style={{zIndex: '7', position: 'absolute', left: '100px', top: '2035px' }}value={e.name} key={key}>
                {e}
                </option>
              );
            })}
       ...
       <br/>
       <br/>
       <a id='mozart' className='hashh'  style={{zIndex: '7', position: 'absolute', left: '235px', top: '2025px' }} href='#ntdoubleu297'>Nav297</a>
        <a id='marketANThashh' className='hashh'  style={{zIndex: '7', position: 'absolute', left: '295px', top: '2025px' }} href='#townhash'>Town</a>
         <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '345px', top: '2025px' }} href='#mozart'>Business Planning</a>
         <input className='inputbat' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2065px' }}type='number' onChange={(e)=> setPricevalue(e.target.value)}/>
       <input className='inputbat' style={{zIndex: '7', position: 'absolute', left: '305px', top: '2065px' }}type='number' onChange={(e)=> setPricevalue2(e.target.value)}/>
       <Button className='button' style={{zIndex: '7', position: 'absolute', left: '510px', top: '2040px' }}variant='dark' type="button" value='Submit' onClick={marketANT}>Apply Science</Button>
       <a id='mozart' className='hashh'  style={{zIndex: '7', position: 'absolute', left: '235px', top: '2025px' }} href='#ntdoubleu297'>Nav297</a>
        <a id='marketANThashh' className='hashh'  style={{zIndex: '7', position: 'absolute', left: '295px', top: '2025px' }} href='#townhash'>Town</a>
         <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '345px', top: '2025px' }} href='#mozart'>Business Planning</a>
         <br/>
         ...
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2100px', width: '1100px', height: '300px', borderRadius: '0%', background: 'rgb(23, 23, 23)' }}></div>
         <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2100px'}}>[Year]</h5>
         <div id='salespermonthavg' className='marketantfont2' style={{zIndex: '7', position: 'absolute', left: '700px', top: '2040px'}}></div>
         <div id='updownperc' className='marketantfont2' style={{zIndex: '7', position: 'absolute', left: '700px', top: '1980px'}}></div>
         <div id='yearCurrent' className='a1water' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2200px' }}></div>
         <div id='yearCall' className='a1water' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2300px' }}></div>
         <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '300px', top: '2100px'}}>$June</h5>
         <div id='currentmonth1' className='a1water' style={{zIndex: '7', position: 'absolute', left: '300px', top: '2200px' }}></div>
         <div id='month1' className='a1water' style={{zIndex: '7', position: 'absolute', left: '300px', top: '2300px' }}></div>
         <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '500px', top: '2100px'}}>$July</h5>
         <div id='currentmonth2' className='a1water' style={{zIndex: '7', position: 'absolute', left: '500px', top: '2200px' }}></div>
         <div id='month2' className='a1water' style={{zIndex: '7', position: 'absolute', left: '500px', top: '2300px' }}></div>
         <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '2100px'}}>$August</h5>
         <div id='currentmonth3' className='a1water' style={{zIndex: '7', position: 'absolute', left: '700px', top: '2200px' }}></div>
         <div id='month3' className='a1water' style={{zIndex: '7', position: 'absolute', left: '700px', top: '2300px' }}></div>
         <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '900px', top: '2100px'}}>$September</h5>
         <div id='currentmonth4' className='a1water' style={{zIndex: '7', position: 'absolute', left: '900px', top: '2200px' }}></div>
         <div id='month4' className='a1water' style={{zIndex: '7', position: 'absolute', left: '900px', top: '2300px' }}></div>
         <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1100px', top: '2100px'}}>Total for Year</h5>
         <div  id='totalyearANT' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1100px', top: '2200px' }}></div>
         <div id='yearPrevious' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1100px', top: '2300px' }}></div>
         <br/>
         <br/>
         <br/>
         <a id='mozart' className='hashh'  style={{zIndex: '7', position: 'absolute', left: '100px', top: '2450px' }} href='#ntdoubleu297'>Nav297</a>
         <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '170px', top: '2450px' }} href='#townhash'>Town</a>
         <a className='hashh'  style={{zIndex: '7', position: 'absolute', left: '240px', top: '2450px' }} href='#populatequote11'>Price Point</a>
       ...
       <select style={{zIndex: '7', position: 'absolute', left: '250px', top: '2500px' }}
          ...
          >
      <option id='value' style={{zIndex: '7', position: 'absolute', left: '250px', top: '2500px' }}>---Choose State--</option>
      {GLOBE1.states.map((value, key) => {
        return(
          ...
          >
            <option style={{zIndex: '7', position: 'absolute', left: '400px', top: '2500px' }}>--Choose County--</option>
   ...
   return (
     <option value={index}>
       ...
       <input className='inputbat' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2550px' }}type='number' onChange={(e)=> setPricevalue3(e.target.value)}/>
       <input className='inputbat' style={{zIndex: '7', position: 'absolute', left: '305px', top: '2550px' }}type='number' onChange={(e)=> setPricevalue4(e.target.value)}/>
       <Button className='button' style={{zIndex: '7', position: 'absolute', left: '510px', top: '2538px' }}variant='dark' type="button" value='Submit' onClick={()=> {businessplanning(); businessplanning21(); businessplanning20(); clearAvg5(); marketflush21();}}>Apply Science</Button>
       <Button className='buttonAVGsuburb' id='businessplanningavgs' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2650px' }} variant='dark' type="button" value='Submit' onClick={()=> {battingAvg5();}}>Show Averages</Button>
      <br/>
      <br/>
      <br/>
      <img style={{height: '1200px', width: '1180px', position: 'absolute', left: '75px', top: '2700px' }} src={capesub} alt='northcarolina'/>
       <h5 className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2600px'}}>#APPLYSCIENCE - Seller Agency Residential - 
         ...
         <br/>
         <br/>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '2750px', width: '530px', height: '300px', borderRadius: '31%', background: 'rgb(34, 34, 34)', border: '3.5px solid rgb(15, 15, 15)' }}></div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '220px', top: '2794px' }}>sales</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '336px', top: '2794px' }}>at/above rate</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '500px', top: '2794px' }}>differential</div>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '2750px', width: '530px', height: '300px', borderRadius: '31%', background: 'rgb(34, 34, 34)', border: '3.5px solid rgb(15, 15, 15)' }}></div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '820px', top: '2794px' }}>sales</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '946px', top: '2794px' }}>at/above rate</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '1110px', top: '2794px' }}>differential</div>
         <br/>
         <a id='date14' className='a1water' style={{zIndex: '7', position: 'absolute', left: '260px', top: '2765px' }}></a>
         <a></a>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '120px', top: '2830px' }}>$2022:</div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='planAsales' className='a1water' title={averageSP34} href='#/planAsales' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2830px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fractionArate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '325px', top: '2830px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planArate' title={belowdiffratesPlanAavg} href='#/planArate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2830px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <div id='planAdiff' className='a1water' style={{zIndex: '7', position: 'absolute', left: '525px', top: '2830px' }}></div>
         <br/>
         <br/>
         <br/>
         <a></a>
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planAsales21' className='a1water' title={averageSP39} href='#/planAsales21' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2880px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fractionArate21'className='a1water' style={{zIndex: '7', position: 'absolute', left: '325px', top: '2880px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planArate21' title={belowdiffratesPlanA21avg} href='#/planArate21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2880px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <div  id='planAdiff21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '525px', top: '2880px' }}></div>
         <br/>
         <br/>
         <br/>
         <a></a>
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='planAsales20' className='a1water' title={averageSP44} href='#/planAsales20' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2930px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fractionArate20'  className='a1water' style={{zIndex: '7', position: 'absolute', left: '325px', top: '2930px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='planArate20' title={belowdiffratesPlanA20avg} href='#/planArate20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2930px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <div id='planAdiff20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '525px', top: '2930px' }}></div>
         ...
         <br/>
         <a></a>
         <div id='avgAsales' className='a1water' style={{zIndex: '7', position: 'absolute', left: '225px', top: '2990px' }}></div>
         <a></a>
         <div id='avgAfraction' className='a1water' style={{zIndex: '7', position: 'absolute', left: '325px', top: '2990px' }}></div>
         <a></a>
         <div id='avgArate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '2990px' }}></div>
         <div id='avgAdiff' className='a1water' style={{zIndex: '7', position: 'absolute', left: '525px', top: '2990px' }}></div>
         <br/>
         <br/>
         <br/>
         <a id='date30' className='a1water' style={{zIndex: '7', position: 'absolute', left: '860px', top: '2765px' }}></a>
         <a></a>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '720px', top: '2830px' }}>$2022:</div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planBsales' className='a1water' title={averageSP35} href='#/planBsales' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2830px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fractionBrate'className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '2830px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planBrate' title={belowdiffratesPlanBavg} href='#/planBrate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2830px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <div id='planBdiff' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '2830px' }}></div>
         <br/>
         <br/>
         <br/>
         <a></a>
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='planBsales21' className='a1water' title={averageSP40} href='#/planBsales21' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2880px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fractionBrate21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '2880px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planBrate21' title={belowdiffratesPlanB21avg} href='#/planBrate21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2880px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <div id='planBdiff21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '2880px' }}></div>
         <br/>
         <br/>
         <br/>
         <a></a>
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='planBsales20' className='a1water' title={averageSP45} href='#/planBsales20' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2930px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fractionBrate20'className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '2930px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a  id='planBrate20' title={belowdiffratesPlanB20avg} href='#/planBrate20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2930px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <div id='planBdiff20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '2930px' }}></div>
         ...
         <br/>
         <a></a>
         <div id='avgBsales' className='a1water' style={{zIndex: '7', position: 'absolute', left: '825px', top: '2990px' }}></div>
         <a></a>
         <div id='avgBfraction' className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '2990px' }}></div>
         <a></a>
         <div id='avgBrate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '2990px' }}></div>
         <div id='avgBdiff' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '2990px' }}></div>
         <br/>
         <br/>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '3095px', width: '530px', height: '300px', borderRadius: '31%',  background: 'rgb(34, 34, 34)', border: '3.5px solid rgb(15, 15, 15)' }}></div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '220px', top: '3139px' }}>sales</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '336px', top: '3139px' }}>at/above rate</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '500px', top: '3139px' }}>differential</div>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '3095px', width: '530px', height: '300px', borderRadius: '31%',  background: 'rgb(34, 34, 34)', border: '3.5px solid rgb(15, 15, 15)' }}></div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '820px', top: '3139px' }}>sales</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '946px', top: '3139px' }}>at/above rate</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '1110px', top: '3139px' }}>differential</div>     
         <br/>
         <br/>
         <br/>
         <a id='date45' className='a1water' style={{zIndex: '7', position: 'absolute', left: '260px', top: '3110px' }}></a>
         <a></a>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '120px', top: '3175px' }}>$2022:</div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planCsales' className='a1water' title={averageSP36} href='#/planCsales' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3175px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fractionCrate'className='a1water' style={{zIndex: '7', position: 'absolute', left: '325px', top: '3175px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planCrate' title={belowdiffratesPlanCavg} href='#/planCrate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3175px' }} ></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <div id='planCdiff' className='a1water' style={{zIndex: '7', position: 'absolute', left: '525px', top: '3175px' }}></div>
         <br/>
         <br/>
         <br/>
         <a></a>
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='planCsales21' className='a1water' title={averageSP41} href='#/planCsales21' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3225px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fractionCrate21'className='a1water' style={{zIndex: '7', position: 'absolute', left: '325px', top: '3225px' }}></div>
         <a></a>
  <Popup lockScroll={true} trigger={<a id='planCrate21' title={belowdiffratesPlanC21avg} href='#/planCrate21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3225px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <div id='planCdiff21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '525px', top: '3225px' }}></div>
         <br/>
         <br/>
         <br/>
         <a></a>
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planCsales20' className='a1water' title={averageSP46} href='#/planCsales20' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3275px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fractionCrate20'className='a1water' style={{zIndex: '7', position: 'absolute', left: '325px', top: '3275px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planCrate20' title={belowdiffratesPlanC20avg} href='#/planCrate20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3275px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <div id='planCdiff20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '525px', top: '3275px' }}></div>
         ...
         <br/>
         <a></a>
         <div id='avgCsales' className='a1water' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3340px' }}></div>
         <a></a>
         <div id='avgCfraction' className='a1water' style={{zIndex: '7', position: 'absolute', left: '325px', top: '3340px' }}></div>
         <a></a>
         <div id='avgCrate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3340px' }}></div>
         <div id='avgCdiff' className='a1water' style={{zIndex: '7', position: 'absolute', left: '525px', top: '3340px' }}></div>
         <br/>
         <br/>
         <br/>
         <a id='date90' className='a1water' style={{zIndex: '7', position: 'absolute', left: '860px', top: '3110px' }}></a>
         <a></a>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3175px' }}>$2022:</div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='planDsales' className='a1water' title={averageSP37} href='#/planDsales' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3175px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fractionDrate'className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3175px' }}></div>
         <a></a>
         <div ></div>
   <Popup lockScroll={true} trigger={<a id='planDrate' title={belowdiffratesPlanDavg} href='#/planDrate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3175px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <div id='planDdiff' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '3175px' }}></div>
         <br/>
         <br/>
         <br/>
         <a></a>
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planDsales21' className='a1water' title={averageSP42} href='#/planDsales21' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3225px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fractionDrate21'className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3225px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='planDrate21' title={belowdiffratesPlanD21avg} href='#/planDrate21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3225px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <div id='planDdiff21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '3225px' }}></div>
         <br/>
         <br/>
         <br/>
         <a></a>
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planDsales20' className='a1water' title={averageSP47} href='#/planDsales20' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3275px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fractionDrate20'className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3275px' }}></div>
         <a></a>
  <Popup lockScroll={true} trigger={<a id='planDrate20' title={belowdiffratesPlanD20avg} href='#/planDrate20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3275px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <div id='planDdiff20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '3275px' }}></div>
         ...
         <br/>
         <a></a>
         <div id='avgDsales' className='a1water' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3340px' }}></div>
         <a></a>
         <div id='avgDfraction' className='a1water' style={{zIndex: '7', position: 'absolute', left: '920px', top: '3340px' }}></div>
         <a></a>
         <div id='avgDrate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3340px' }}></div>
         <div id='avgDdiff' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1135px', top: '3340px' }}></div>
         <br/>
         <br/>
         <br/>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '100px', top: '3440px', width: '530px', height: '300px', borderRadius: '31%',  background: 'rgb(34, 34, 34)', border: '3.5px solid rgb(15, 15, 15)' }}></div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '220px', top: '3488px' }}>sales</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '336px', top: '3488px' }}>at/above rate</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '500px', top: '3488px' }}>differential</div>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '700px', top: '3440px', width: '530px', height: '365px', borderRadius: '10%',  background: 'rgb(34, 34, 34)', border: '3.5px solid rgb(15, 15, 15)' }}></div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '820px', top: '3486px' }}>sales</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '946px', top: '3486px' }}>at/above rate</div>
         <div className='a1water' style={{zIndex: '7', position: 'absolute', left: '1110px', top: '3486px' }}>differential</div>      
         <br/>
         <br/>
         <a id='date120' className='a1water' style={{zIndex: '7', position: 'absolute', left: '260px', top: '3450px' }}></a>
         <a></a>
         <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '120px', top: '3515px' }}>$2022:</div>
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='planEsales' className='a1water' title={averageSP38} href='#/planEsales' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3515px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fractionErate'className='a1water' style={{zIndex: '7', position: 'absolute', left: '325px', top: '3515px' }}></div>
   <Popup lockScroll={true} trigger={<a id='planErate' title={belowdiffratesPlanEavg} href='#/planErate' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3515px' }} ></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <div id='planEdiff' className='a1water' style={{zIndex: '7', position: 'absolute', left: '525px', top: '3515px' }}></div>
         <br/>
         <br/>
         <br/>
         <a></a>
         ...
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='planEsales21' className='a1water' title={averageSP43} href='#/planEsales21' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3565px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fractionErate21'className='a1water' style={{zIndex: '7', position: 'absolute', left: '325px', top: '3565px' }}></div>
         <a></a>
  <Popup lockScroll={true} trigger={<a id='planErate21' title={belowdiffratesPlanE21avg} href='#/planErate21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3565px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <div id='planEdiff21' className='a1water' style={{zIndex: '7', position: 'absolute', left: '525px', top: '3565px' }}></div>
         <br/>
         <br/>
         <br/>
         <a></a>
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='planEsales20' className='a1water' title={averageSP48} href='#/planEsales20'  style={{zIndex: '7', position: 'absolute', left: '225px', top: '3615px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fractionErate20'className='a1water' style={{zIndex: '7', position: 'absolute', left: '325px', top: '3615px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='planErate20' title={belowdiffratesPlanE20avg} href='#/planErate20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3615px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <div id='planEdiff20' className='a1water' style={{zIndex: '7', position: 'absolute', left: '525px', top: '3615px' }}></div>
         ...
         <br/>
         <a></a>  
         <div id='avgEsales' className='a1water' style={{zIndex: '7', position: 'absolute', left: '225px', top: '3675px' }}></div>
         <a></a>
         <div id='avgEfraction' className='a1water' style={{zIndex: '7', position: 'absolute', left: '325px', top: '3675px' }}></div>
         <a></a>
         <div id='avgErate'  className='a1water' style={{zIndex: '7', position: 'absolute', left: '425px', top: '3675px' }}></div>
         <div id='avgEdiff' className='a1water' style={{zIndex: '7', position: 'absolute', left: '525px', top: '3675px' }}></div>
         <br/>
         <br/>
         <br/>
     ...
     <br/>
         ...
         <a></a>
  <Popup lockScroll={true} trigger={<a id ='sales14flush' className='a1water'  title={averageSP49} href='#/sales14flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3510px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='fraction14flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3510px' }}></div>
         <a></a>
  <Popup lockScroll={true} trigger={<a id='rates14flush' title={belowdiffratesMF14avg} href='#/rates14flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3510px' }}></a>}
  position='center' modal nested>
{close => (
     ...
     <div className="modal" tabindex='0'>
       ...
       <div className="actions">
         ...
         <a></a>
         <div id='duff14flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '3510px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3560px' }}>31-60 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales30flush' className='a1water' title={averageSP50} href='#/sales90flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3560px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
          <ReactPaginate
            previousLabel={"<- Previous"}
            nextLabel={"Next ->"}
            pageCount={pageCount78}
            onPageChange={handlePageClick78}
            initialPage={0}
            containerClassName={"pagination"}
            previousLinkClassName={"pagination__link"}
            nextLinkClassName={"pagination__link--disabled"}
         ...
         <a></a>
         <div id='fraction30flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3560px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates30flush' title={belowdiffratesMF30avg} href='#/rates30flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3560px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <div className="actions">
           <ReactPaginate
             previousLabel={"<- Previous"}
             nextLabel={"Next ->"}
             pageCount={pageCount79}
             onPageChange={handlePageClick79}
             initialPage={0}
             containerClassName={"pagination"}
             previousLinkClassName={"pagination__link"}
             nextLinkClassName={"pagination__link--disabled"}
         ...
         <a></a>
    <Popup lockScroll={true} trigger={<a id ='sales45flush' className='fontwater' title={averageSP51} href='#/sales45flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3610px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='fraction45flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3610px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates45flush' title={belowdiffratesMF45avg} href='#/rates45flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3610px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='duff45flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '3610px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3660px' }}>91-120 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales90flush' className='a1water' title={averageSP52} href='#/sales90flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3660px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fraction90flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3660px' }}></div>
         <a></a>
    <Popup lockScroll={true} trigger={<a id='rates90flush' title={belowdiffratesMF90avg} href='#/rates90flush'  className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3660px' }}></a>}
    position='center' modal nested>
  {close => (
       ...
       <div className="modal" tabindex='0'>
         ...
         <a></a>
         <div id='duff90flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '3660px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3710px' }}>121-180 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales120flush' className='a1water' title={averageSP53} href='#/sales120flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3710px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fraction120flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3710px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates120flush' title={belowdiffratesMF120avg} href='#/rates120flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3710px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='duff120flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '3710px' }}></div>
         <br/>
         <br/>
         <a className='fontwater' style={{zIndex: '7', position: 'absolute', left: '720px', top: '3760px' }}>181-240 days</a>
         <a></a>
   <Popup lockScroll={true} trigger={<a id ='sales121flush' className='a1water' title={averageSP54} href='#/sales121flush' style={{zIndex: '7', position: 'absolute', left: '825px', top: '3760px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='fraction121flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '930px', top: '3760px' }}></div>
         <a></a>
   <Popup lockScroll={true} trigger={<a id='rates121flush' title={belowdiffratesMF121avg} href='#/rates121flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1035px', top: '3760px' }}></a>}
   position='center' modal nested>
 {close => (
      ...
      <div className="modal" tabindex='0'>
        ...
        <div className="actions">
         ...
         <a></a>
         <div id='duff121flush' className='a1water' style={{zIndex: '7', position: 'absolute', left: '1140px', top: '3760px' }}></div>
         <br/>
         <img style={{height: '440px', width: '1295px', position: 'absolute', top: '4100px' }} src={vegas} alt='pixa'/>
