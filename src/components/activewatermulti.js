 ...
 */
  ...
  console.log(index22);
        ...
        {name: 'MA', counties: [{name: 'Worcester', towns: ['Worcester, MA']}]},
       ...
       document.getElementById('geocoder').appendChild(geocoder.onAdd(map));
             ...
             //   if (data[i].propertytype === 'CONDO'){
              //   propertyT.push(data[i]);
               //  console.log(propertyT)
                ...
                // console.log(a);
                 ...
                 const makeGeoJSON = (data) => { //if/else conditional here...?
                 ...
                 // console.log(a);
                  for (let i = 0; i < data.length; i++) {
                   if (data[i].propertytype === 'MULTI_FAMILY'){
                    propertyT.push(data[i]);
                    console.log(propertyT)
                   } 
                  }
                  ...
                  return {
                     ...
                     features: propertyT.map(feature => {
                       return {
                         "type": "Feature",
                         "properties": {
                           "id": 'mapbox-streets',
                 ...
                 const myGeoJSONData = makeGeoJSON(data);
  ...
  center: e.features[0].geometry.coordinates
   ...
   const popup = new mapboxgl.Popup({
    ...
    <td style=font-size: 24.5px;
     ...
     <td className='fontpopactive'>Days On Market: ${marker.properties.DOM}</td>
     <td className='fontpopactive'>County: ${marker.properties.county}</td>
    <br/>
     <td className='fontpopactive'>Property Type: ${marker.properties.propertytype} </td><br/>
     <img style='width: 450px; height: 225px; padding-left: 50px; top: 10px;' src=${marker.properties.photosMAIN}></img>     
     <br/>
 ...
 <br/>
  ...
  React.useEffect(() => { //
   ...
   .then(data => {
     ...
     for (let i = 0; i < data.length; i++) {
       ...
       const spread = [...data];
       console.log(a);
       if (data[i].status === 'FOR_SALE' && data[i].listprice !=='AUCTION' && data[i].differential !== "#VALUE!" && data[i].propertytype === 'MULTI_FAMILY' ){
         sales.push(data[i]);
         //console.log(sales);
  ...
  <td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
          <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-125px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
          <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-175px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
  <br/>
       <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
  ...
  <br/>
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////////////////     
   //7/20/24 (5PM) DrHVMA => 12/25/23 - 2 virus' / facial wart (pics)/ facial sun rash (pics)/ facial pimple (pics) / eye floaters (confirmed) / light sensitivity / mild vertigo/fatigue / paraneal tendinitis right ankle / trouble breathing virus 2 / diahhrea virus 1 / March 2024 invega sustenna TRshot1mo. - 7/20/2024.
   //tumors - osteo right knee benign.  right leg groin benign. see. see. Temperature possible only for Virus 1 (no temp. virus 2) =>
   //https://www.invegasustennaschizoaffective.com/about/side-effects-and-safety PS. INVEGA SUSTENNA TR 1 month? SEs? mild stutter thru april to end of may. yes, beach trip clearing up. i figured the TR drug antipsych was wearing off. Not a single float at Duxbury beach 5/22.
   //i turned 35yrs on 12/9/2023 #joebiden #cheesecakefactory #samsung
   //12/25/2024ish-1/2/2024 stomach pain profuse diahrrea Christmas past. stomach virus (no lung issues). 
   //stay away from my entity USA Americans 
   //2/28/2024 -> facial wart appears over (under?) skin lesion on right cheek I have had since {childhood adolesence}? #DrLee. mole lesion though not a mole (much lighter more smooth) => thought I was born with?? Fine!! =>
   //9*facial wart*0% right cheek 2/28/2024approx - compound W freeze off dual power 1 application #burnCARNEYaquaforIbrought.dry/12daysMarchrecorded/dry.=> homeStPatricksDay => 1 small application of wart liquid (salicylic acid) day after StPs 24hrs => bar soap, sponge, warm tap water, **cocoa butter healing jelly Vaseline** 1wk. red skin surface shape wart right cheek no pain #healing.  => 
   //2/29/2024 -  3/15/2024 I was involuntarily brought to the Carney hospital ER on section 12 #alcohol.  I did nothing to warrant this in the ER or otherwise.  Its recorded 2 infinity. No psychosis Dr. None. I calmly followed involuntary demands which brought me to Carney ER. Please Watch... section 12s are 3 days long / turned 12 days involuntary inpatient.  Please watch all 12 days involuntary inpatient start to finish at Carney Hospital.  Thats me. Neil (no floats). Any/all. Its a public suit brewing my way for compensation and I have no idea how I am being sectioned. See Dr. Daggencourt.  Anyway, they drew my blood while I was being sectioned involuntarily and I give you permission to take my blood sample from March 2024 (feb?) to test for any/all malicious threats to my organism.  I have not read Carneys paperwork #HIPPAlaw. Vitals etc you wood like to examine you are free to examine in my best interest only.  Thank you. Aquafor was what i chose to bring with me when the ambulance came to my condo and told me i have to go with them.  I had just recently used compound W freeze off for my facial wart and it was so cold i burned my face. At that time, the burn was getting so dry over time daily i had to bring it with me to the hospital for regular maintainence/moisterization. The hospital let me hold onto the Aquafor throughout my 12 day involutary stint at Carney on render, but not once did a nurse/doctor or employee ask me about the burn on my face inside there. They just ignored it.  How i got the burn etc, no one asked.  And I opt to leverage to you every single one of my VScode components #Britannica VS Carneys paperwork (I have not read) at any time in my best interests speaking for myself now.        
    // stuttering IS? <=>
   // -> ... beach 5/22/2024 duxbury 6 hours temperature 75-80.  no floats. no sunglasses. 
   // -> ...nantasket beach 5/24/2024 2.5 hours temperature 75. no floats. no sunglasses. 
   //  -> no more beach -> fear of heat stroke/sickness over a very short period of time 85 plus - prefer AC bubble (condo/car etc) want to be close 24/7. I want to be able to jump into bubble AC in minutes. Awaiting September. 
   // 3/29/2024..- work was being done to the condo i stay in and afterwards sharp pieces of glass were made countertops inside my unit.  one of them shattered.  I have a laceration on my left leg that almmost needed stitches.  Today it is about an inch long and cm wide being treated with cocoa butter Vaseline and bandage (before virus 2 & floats and after virus 1. after initial facial wart).  I drove to the Braintree ER parking lot (subaru wrx) after neosporin and bandage to await if i needed stitches and decided against going to the ER. See my left calf (side).  I have thrown out all the glass except 1 long piece atop the divider between the kitchen and living room.  Please take out for examination.  Please wear gloves and walk carefully. I do not believe it to be infected.  
   //floats 6/6/2024 NBA finals begin 
   //6/7/2024 wake up AM shower. Massive pimple outbreak in the AM shower where the facial wart initially grew in late february (pictures), i run out to my car for pimple cream. Then, 1wk heal time cocoa butteer Vaseline. Heals (no S. Acid again) but aforementioned adolescent smooth lesion missing from my right cheek upon heal (no pain picture today). => 
   //6/8/2024 lights on floats while in the shower since  (lights on condo seen mildly on/off sometimes not at all.  somettimes CPU sometimes not at all - white screen.)=>
   //6/11/2024 somewhere over the rainbow JG => Walgreens bought a gatorade vertigo =>
   //6/13/2024 haircut (vertigo)/work day short vertigo => food chipolte burrito *less vertigo..food = less vertigo.  

   //6/18/2024 => ER visit floaters right eye, eye check OK, high blood pressure. No stuttering #IS.
   //6/20/2024 dry eyes blink eye drops walgreens no stuttering. #IS 
   //6/23/2024 light sensitivity (floats)...Overall the Sun is too bright (than usual summer). lights off my room mostly (i can and do turn them on indoor no sun). I can read fine. shades over windows.  creases of light from the blind creases are seen upon moving them away for seconds... initial squinting when going outdoors this summer hand up sometimes then down for good. can stay out hours in my car in/out glove compartment down no sun glasses. 
   //6/24/2024 Physical routine reporting eye floats, eye check pass => referral eye examination PCP.  Blood Pressure & temperature OK...no blood work...
   //Miss Polo OPR - brain? 36/6 = 6. 7 x 7 = 49. 6 42. <=> 1MRI back rerender youll find. Cervical pain weeks before Virus 2 thought it was from weight lifting. specific *just above/*below the neck bone.  (*T) shower water.  virus 2 end? gone..tendonitis next...right ankle. i say OK Dr. whats next after tendonitis 'heals'? ^youknow? A&P1&2. Massassoit. A facial lesion since early adolesence turns wart (pics) disappears (see?) into right ankle tendonitis with eye floats and light sensitivity at 35yrs.  blood? #ISviral2 12/25 - 7/20. And see what I got?! 
   //6/27/2024 conmprehensive eye test pass Atrius Health **sees Vitreous both eyes same. #Ophthalmology glasses rec No. (I wrote this on laptop lights off.)
   //7/4 light sensitviity #IS//?
   // 7/5+ two or more episdoes of light headedness fear of passing out.  food helps. fear of the heat need an indoor AC bubble for calm. no sun light fear of sun poisening short periods outdoors (stroke).  two or more episodes fear of passing out #heatdome. 7/5 - 7/20.
   //7/8/2024 spray tan (**light sensitivity devalues after**) => **trouble breathing night of (**6hrs later) #COPD #COVID19. virus?2? i think so.almost done. no test. => work off stomach/trouble breathing periodically throughout +- bed time no fever no mucus dry cough, dry nose stuff on/off, stomach queazing. poop regular, wet/moist outside each clump. inconsistent flatulence than the norm (less pressure etc) => 2 seperate days 4miles attempted during 3 finished (2 & 1) 4th unable solely due to my tendon right ankle (not lungs/stomach) => 7/20
   //7/20/2024 cannot drive my car due to pareneal tendinitis in my right ankle (today -> 3hrs of driving.) automatics.  ice. floats. mild LS.  driving? right heel ground lean right / towards the gas => tendon paIN right to left to right. ^overuse anything other?^ I attempt to straighten the leg&foot so directly aligned with gas pedal then the brake again instead of just my heel turning the foot to reduce pain/tightness. icing now...
   //36yrs 12/9 => 7/20 light sensitivity down since spray tan after 7/4/24 LS / sun a little bright (back forth wrx) / bothersome most while *driving (*LS/floats) mildly and not indoors minus gym LEDs. My Lights switched on OK.  smartphone OK.  SMART TV OK. CPU OK lights on/off OK. condo unit on/off OK.

   //ER pass out please read this..check tumors mentioned herein (2).  I leverage my JS for DrHighestValueMA assist under current health insurance. I write to you.  Dentist same. MSM OK. Full regeneration ill wait Dr ty ty.
   //ER unconscious? ^ 7/20/2024 11PM. #TendonitisFlLS1&2.=> Say the tendonitis heals then OK. Clear cheeks.  Floats (LSoutdoor) 35. Virus 2 COVID19? Unvaccinated.  
   // outpatient rendering...NSFB - no suicidal intentions (not me).  No  ambitions to harm self/others (not me).
...
<div className='background'>
   ...
   <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='#benjamin2'>MAP</a>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/alldatamulti">Seller</a>
   ...
   <div className='hashh65'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Active</div>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/activemultifamily'>Suburb</a>
     ...
     <a className='hashh64'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '1800px' }} href='#benjamin2'>Mapping</a>
     <div id='imme' className='activetitle64' style={{zIndex: '7', position: 'absolute', left: '395px', top: '511px' }}>Active Multi-Family</div>
     ...
     <Button id='benjamin' className='button64' style={{zIndex: '7', position: 'absolute', left: '948px', top: '595px'}} variant='dark' type="button" value='Submit' onClick={()=> {ActivePopulateQuote(); ActivePopulateQuoteBeds(); NoPlaceLikeHome(); Toto();}}>Apply Science</Button>
     ...
     <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '15px', top: '676px', width: '520px', height: '365px', borderRadius: '10%', background: 'rgb(170, 170, 170)', border: '3.5px solid rgb(101, 101, 101)' }}></div>
     <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '555px', top: '641px', width: '396px', height: '447px', borderRadius: '10%', background: 'rgb(170, 170, 170)', border: '3.5px solid rgb(101, 101, 101)' }}></div>
     <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '972px', top: '652px', width: '300px', height: '438px', borderRadius: '10%', background: 'rgb(170, 170, 170)', border: '3.5px solid rgb(101, 101, 101)' }}></div>
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData7}
                 ...
                 <Button id='benjamin' className='button64' style={{zIndex: '7', position: 'absolute', left: '199px', top: '595px'}} variant='dark' type="button" value='Submit' onClick={()=> {ghostreconcampaign();}}>Apply Science</Button>
     ...
     <br/>
      ...
      {GLOBE1.states.map((value, key) => {
        return(
          ...
          <select style={{zIndex: '7', position: 'absolute', left: '671px', top: '591px' }}
          placeholder='County'
          value={county3}
          onChange={(e) => setCounty3(e.target.value)}
          >
            <option style={{zIndex: '7', position: 'absolute', left: '681px', top: '591px' }}>--Choose County--</option>
       ...
       <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '663px', top: '642px' }}># Listings</div>
         <div className='a1water64' style={{zIndex: '7', position: 'absolute', left: '793px', top: '642px' }}>% Total Market</div>
                          ...
                          <a></a>                       
                           <Popup lockScroll={true} trigger={<a id='s14'  href='#/s14' title={avgdomPlanAavg} className='a1water64' style={{zIndex: '7', position: 'absolute', left: '690px', top: '671px' }}></a>}
                           position='center' modal nested>
                         {close => (
                      ...
                      <a></a>
                          ...
                          <a></a>
                          <Popup lockScroll={true} trigger={<a id='r14'  title={belowdiffratesPlanAavg} href='#/r14'  className='a1water64' style={{zIndex: '7', position: 'absolute', left: '842px', top: '671px' }}></a>}
                           position='center' modal nested>
                         {close => (
                          ...
                          <a></a>
   <Popup lockScroll={true} trigger={<a id='s30' title={avgdomPlanBavg}  href='#/s30' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '690px', top: '746px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData9}
                          ...
                          <a></a>
                          <Popup lockScroll={true} trigger={ <a id='r30' title={belowdiffratesPlanBavg} href='#/r30' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '842px', top: '746px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData9}
                          ...
                          <a></a>
  <Popup lockScroll={true} trigger={<a id='s45' href='#/s45' title={avgdomPlanCavg}  className='a1water64' style={{zIndex: '7', position: 'absolute', left: '690px', top: '821px' }}></a>}
  position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData10}
                          ...
                          <a></a>                       
                          <Popup lockScroll={true} trigger={<a id='r45' title={belowdiffratesPlanCavg} href='#/r45'  className='a1water64' style={{zIndex: '7', position: 'absolute', left: '842px', top: '821px' }}></a>}
  position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData10}
                          ...
                          <a></a>
  <Popup lockScroll={true} trigger={<a id='s90' title={avgdomPlanDavg} href='#/s90' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '690px', top: '896px' }}></a>}
  position='center' modal nested>
{close => (
         ...
         <ReactPaginate
           ...
           {currentPageData11}
                         ...
                         <a></a>
                          ...
                          <a></a>                       
                          <Popup lockScroll={true} trigger={ <a id='r90'  title={belowdiffratesPlanDavg} href='#/r90'  className='a1water64' style={{zIndex: '7', position: 'absolute', left: '842px', top: '896px' }}></a>}
  position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData11}
                          ...
                          <a></a>
   <Popup lockScroll={true} trigger={<a id='s120' href='#/s120' title={avgdomPlanEavg}  className='a1water64' style={{zIndex: '7', position: 'absolute', left: '690px', top: '971px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
           ...
           <a></a>
                          ...
                          <Popup lockScroll={true} trigger={ <a id='r120' title={belowdiffratesPlanEavg} href='#/r120' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '842px', top: '971px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData12}
                          ...
                          <a></a>
   <Popup lockScroll={true} trigger={<a id='s121' title={avgdomPlanFavg}  href='#/s121' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '690px', top: '1046px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData13}
                          ...
                          <a></a>                         
                          <Popup lockScroll={true} trigger={ <a id='r121' title={belowdiffratesPlanFavg} href='#/r121'  className='a1water64' style={{zIndex: '7', position: 'absolute', left: '842px', top: '1046px' }}></a>}
   position='center' modal nested>
 {close => (
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData13}
                          ...
                          <h5 className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1080px', top: '630px'}}>Number of Beds</h5>
                          <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '996px', top: '711px' }}>1 Beds</div>
                    
                    <Popup lockScroll={true} trigger={<a id ='onebed' title={belowdiffratesPlanAavgbed} href='#/onebed' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '695px' }} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData14}
                    ...
                    <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '1086px', top: '711px' }}>______________</div>
                 <br/>
                 <br/>
                 <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '996px', top: '801px' }}>2 Beds</div>
                 <Popup lockScroll={true} trigger={<a id ='twobed' title={belowdiffratesPlanBavgbed} href='#/twobed' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '784px' }}></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData15}
                 ...
                 <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '1086px', top: '801px' }}>______________</div>
                 <br/>
                 <br/>
                 <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '996px', top: '876px' }}>3 Beds</div>  
                 <Popup lockScroll={true} trigger={ <a  id='threebed' title={belowdiffratesPlanCavgbed} href='#/threebed' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '860px'}} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData16}
                 ...
                 <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '1086px', top: '876px' }}>______________</div>
                 <br/>
                 <br/>
                 <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '996px', top: '951px' }}>4 Beds</div>
                 <Popup lockScroll={true} trigger={<a id ='fourbed' title={belowdiffratesPlanDavgbed} href='#/fourbed' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '935px'}} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData17}
                 ...
                 <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '1086px', top: '951px' }}>______________</div>
                 <br/>
                 <br/>
                 <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '996px', top: '1026px' }}>5+ Beds</div>
                
                 <Popup lockScroll={true} trigger={<a id ='fivebed' title={belowdiffratesPlanEavgbed} href='#/fivebed' className='a1water64' style={{zIndex: '7', position: 'absolute', left: '1116px', top: '1010px'}} ></a>}
    position='center' modal nested>
{close => (
       ...
       <div className="actions">
         <ReactPaginate
           ...
           {currentPageData18}
                 ...
                 <div className='fontwater64' style={{zIndex: '7', position: 'absolute', left: '1086px', top: '1026px' }}>______________</div>
                      <br/> 
                      <div style={{zIndex: '7', position: 'absolute', left: '700px', top: '1090px', color: 'rgb(0, 51, 120)' }}>----------------------------------------------</div>
                      <div style={{zIndex: '7', position: 'absolute', left: '100px', top: '1070px', color: 'rgb(0, 51, 120' }}>----------------------------------------------</div>
     ...
     <div id='noplacelikehome' className='listpricediv' style={{zIndex: '7', position: 'absolute', left: '8px', top: '1171px' }}>
     {julius.map((item) => 
      
     

<div className='listprice643' tabindex='0'>  


<Popup
trigger={<img style={{zIndex: '7', height: '160px', width: '295px' }} src={item.photosMAIN} ></img>}
position="center"
modal
nested
lockScroll={true}     
...
<div className="modal" tabindex='0'>
   ...
   <td style={{zIndex: '7', position: 'absolute', left: '780px', top: '190px' }} className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.bedrooms} bds</td><br/>
    ...
    <td style={{zIndex: '7', position: 'absolute', left: '780px', top: '300px' }} className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.livingArea} sqft</td><br/>
      ...
      <div className="modalpopactive2" tabindex='0'> 
                 ...
                 <ul> 
         <br/>
         <div className='borderspopactive22'>
          <br/>
          <img style={{zIndex: '7', height: '260px', width: '580px'}} src={item.photosMAIN}></img><br/>
          <br/>
          <img style={{zIndex: '7', height: '260px', width: '580px'}} src={item.photos[1]}></img><br/>
          ...
          <img style={{zIndex: '7', height: '260px', width: '580px' }} src={item.photos[4]}></img><br/>
          <br/>
          <img style={{zIndex: '7', height: '260px', width: '580px'}} src={item.photos[5]}></img>
          <br/>
      </div>
      </ul>
...
<a id='toggle' className='listpricetext643'>{formatter.format(item.listprice)}</a><br/>
     
     <td className='fontpopactive3' >{item.streetAddress}</td> <br/>
     <br/>
     <td className='fontpopactive3'>{item.townstate} {item.zipcode}</td> <br/>
     <td className='fontpopactive3' >{item.bedrooms} bds {item.bathrooms} ba  {item.livingArea} sqft</td><br/>
     ...
     <div id='toto' className='listpricediv' style={{zIndex: '7', position: 'absolute', left: '1005px', top: '1171px' }}>
     {caesar.map((item) => 
  ...
  <td className='fontpopactive3' >{item.bedrooms} bds {item.bathrooms} ba  {item.livingArea} sqft</td><br/>
     ...
     <div id='map' style={{left: '290px', top: '1185px', height: '515px', width: '715px', position: 'absolute' }} ref={mapContainer} />
  <div id="geocoder" style={{zIndex: '1', left: '525px', margin_left: '-25%', top: '1720px', position: 'absolute', width: '775px', height: '31px' }}></div>
           
  <div style={{zIndex: '7', position: 'absolute', left: '530px', top: '355px'}}>
...
<div className='autoy'  itemsPerRow={3} style={{ marginTop: 20 }}>
  ...
  <a className='hashh64'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '532px' }} href='#geocoder'>Previous Market History</a>
     <a className='hashh64'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '552px' }} href='#benjamin2'>Mapping</a>
     </div>
...
{close => (
   ...
   <br/>
     ...
     <br/>
            ...
            export default ActiveWaterMulti; 
