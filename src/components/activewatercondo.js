 ...
 */
  ...
  console.log(index22);
        ...
        const GLOBE1 = {
         states: [
          {name: 'FL', counties: [{name: 'Monroe', towns: ['Key West, FL']}]}
       ]
       };  
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '3px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-60px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '3px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
        <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-85px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
     <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
...
<td className='fontpopactive'  ref={(_subtitle) => (subtitle = _subtitle)}>{item.status}</td>
      <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '6px', top: '-150px'}}  ref={(_subtitle) => (subtitle = _subtitle)}>{item.DOM} days</td>
      <td className='fontpopactive'  style={{zIndex: '7', position: 'relative', left: '-60px', top: '-80px'}} ref={(_subtitle) => (subtitle = _subtitle)}>{item.yearBuilt}</td>
<br/>
   <td className='fontpopactivedescript' ref={(_subtitle) => (subtitle = _subtitle)}>Description: {item.description}</td>
...
const handleChangePool = () => {
  ...
  //  setJulius([...variable1.filter(item => item.bedrooms === 2)]);
  //  setCaesar([...variable2.filter(item => item.bedrooms === 3)]);
...
<div className='background'>
   ...
   <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='#benjamin2'>MAP</a>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/alldatacondo">Seller</a>
   ...
   <div className='hashh65'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Active</div>
     <a className='innerelementwater64' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/activecondo'>Suburb</a>
    ...
    <a className='hashh64'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '1780px' }} href='#imme'>Active Listings Search</a>
     ...
     <div id='imme' className='activetitle64' style={{zIndex: '7', position: 'absolute', left: '395px', top: '511px' }}>Active Condominium</div>
  ...
  <select style={{zIndex: '7', position: 'absolute', left: '45px', top: '591px' }}
     ...
     <Button id='benjamin' className='button64' style={{zIndex: '7', position: 'absolute', left: '948px', top: '595px'}} variant='dark' type="button" value='Submit' onClick={()=> {ActivePopulateQuote();  ActivePopulateQuoteBeds(); NoPlaceLikeHome(); Toto(); brucewayne21a(); brucewayne21b();}}>Apply Science</Button>
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData7}
                 ...
                 <Button id='benjamin' className='button64' style={{zIndex: '7', position: 'absolute', left: '199px', top: '595px'}} variant='dark' type="button" value='Submit' onClick={()=> {ghostreconcampaign(); brucewayne22a(); brucewayne22b();}}>Apply Science</Button>
...
{close => (
     ...
     <br/>
         ...
         <Button id='benjamin2' className='buttonAVG' style={{zIndex: '7', position: 'absolute', left: '1010px', top: '1125px'}} variant='dark' type="button" value='Submit' onClick={()=> {ActivePopulateQuote();  ActivePopulateQuoteBeds(); NoPlaceLikeHome(); Toto(); brucewayne21a(); brucewayne21b();}}>Apply Science</Button>
...
{close => (
   ...
   <br/>
     ...
     <br/>
            ...
            export default ActiveWaterCondo; 
