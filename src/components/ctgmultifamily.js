...
//useEffect(() => {
  ...
  {name: 'RI', counties: [{name: 'Newport', towns: ['Newport, RI']}]}
...
.map((item, index) => (
   ...
   <ul data-index={index}>
    ...
    <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>Sale Price: {formatter.format(item.saleprice)}</td> 
     <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>Differential: {formatter.format(item.differential)}</td>
    <br/>
...
.map((item, index) => (
   ...
   <ul data-index={index}>
    ...
    <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>Sale Price: {formatter.format(item.saleprice)}</td> 
     <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>Differential: {formatter.format(item.differential)}</td>
    <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>Sale Price: {item.saleprice}</td> 
...
const [averageSP54, setAverageSP54] = React.useState(0);
   ...
   <img id='ntdoubleu297' style={{height: '280px', width: '950px', left: '200px', top: '250px', position: 'absolute' }}  src={multifam} alt='math' />
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '275px' }}href='/activemultifamilyctg#map'>MAP</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '45px', top: '325px' }}href="/multifamily">Suburb</a>
   ...
   position='center' modal nested>
     ...
     <br/>
     <div className='hashh666'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '250px' }}>Multi-Family</div>
   <div className='hashh666'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Seller</div>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '275px' }}href='/alldatamulti'>WaterFront</a>
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '325px' }}href="/activemultifamilyctg">Female ACT</a>
     <div>
          <ul>
        <li style={{zIndex: '7', position: 'absolute', left: '1175px', top: '370px' }}>
          <a className='innerelementwater642' href="/ctgmultifamily">Female Seller</a>
          </li>
          <li style={{zIndex: '7', position: 'absolute', left: '1175px', top: '395px' }}>
          <a className='innerelementwater642' href="/ctgmultifamilybuyer">Female Buyer</a>
        </li>
         </ul>
         </div>
...
<div className='autoy' itemsPerRow={3} style={{ marginTop: 20 }}>
      ...
      <div className="modalpopactive" tabindex='0'>
         ...
         <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>List Price: {item.listprice}</td>
         <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>Sale Price: {item.saleprice}</td> 
     <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>Differential: {item.differential}</td><br/>
   <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.streetAddress} </td>
   <td className='fontpopactive' ref={(_subtitle) => (subtitle = _subtitle)}>{item.townstate} {item.zipcode}</td><br/>
