      ...
      .setPopup(
        new mapboxgl.Popup({ offset: [20, 0] }) // add popups
          .setHTML(
            ...
            <ul>
    <br/>
    <div style='border: 4px solid rgb(64,64,64);
    padding: 20px;
    background-color: rgb(34,34,34);'>
     <img style='width: 370px;
     height: 11%; padding-left: 115px' src=${marker.properties.photosMAIN}></img>
     <br/>
     <br/>
     <br/>
     <br/>
     ...
     <td className='fontpopactive'>Property Type: ${marker.properties.propertytype} </td>
     <td className='fontpopactive'>Sale Date: ${marker.properties.saledate} </td>
   ...
   function firstdateIndex(e){
    ...
    .map((item, index) => (
      ...
      <div className='borderspix'>
       ...
       <td className='inborder' ref={(_subtitle) => (subtitle = _subtitle)}>List Price: {formatter.format(item.listprice)}</td>
    ...
    const formatter = new Intl.NumberFormat('en-US', {
      ...
      minimumFractionDigits: 0
               ...
               // html = '<div>';
                sales.forEach(item => {                    
                    html += `
                    <div class='listprice' tabindex='0'>
                    <img src="${item.photosMAIN}" width="100%" height="100%"/>
                    <a id='toggle' class='listpricetext'>${formatter.format(item.listprice)} </a>
                      <p>
                             ${item.bedrooms} bds
                             ${item.bathrooms} ba
                ...
                sales.forEach(item => {                    
                    html += `
                        ...
                        <img src="${item.photosMAIN}" width="100%" height="100%"/>
                            ...
                            <div class='listpricetext'> ${formatter.format(item.listprice)}</div>
                            <p>
                            ${item.bedrooms} bds
                            ${item.bathrooms} ba
                            ${item.livingArea} sqft<br>
...
<div className='background64ctg'>
   ...
   position='center' modal nested>
     ...
     <br/>
     <br/>
     <div className='hashh666'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '250px' }}>Commercial</div>
   <div className='hashh666'  style={{zIndex: '7', position: 'absolute', left: '1187px', top: '250px' }}>Active</div>
     ...
     <a className='innerelementwater' style={{zIndex: '7', position: 'absolute', left: '1160px', top: '325px' }}href="/activecommercialctg">Female ACT</a>
    
     <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '1780px' }} href='#imme'>Active Listings Search</a>
     <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '1800px' }} href='#mapinput'>Mapping</a>
  ...
  <select style={{zIndex: '7', position: 'absolute', left: '45px', top: '591px' }}
     ...
     <Button id='benjamin' className='button' style={{zIndex: '7', position: 'absolute', left: '948px', top: '595px'}} variant='dark' type="button" value='Submit' onClick={()=> {ActivePopulateQuote(); brucewayne22a(); brucewayne22b();}}>Apply Science</Button>
        ...
        <div className="actions">
          <ReactPaginate
            ...
            {currentPageData7}
                 ...
                 <Button id='benjamin' className='button' style={{zIndex: '7', position: 'absolute', left: '199px', top: '595px'}} variant='dark' type="button" value='Submit' onClick={()=> {ghostreconcampaign(); brucewayne21a(); brucewayne21b();}}>Apply Science</Button>
         ...
         <ReactPaginate
           ...
           {currentPageData18}
                 ...
                 <div className='fontwater' style={{zIndex: '7', position: 'absolute', left: '1086px', top: '1026px' }}>______________</div>
                      ...
                      <img style={{height: '375px', width: '1336px', position: 'absolute', top: '2195px' }} src={hottubbubblezzz} alt='pixa'/>
...
<div className='borders'>
 ...
 <td ref={(_subtitle) => (subtitle = _subtitle)}>Days On Market: {caesar.DOM}</td><br/>
  ...
  <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '532px' }} href='#geocoder'>Previous Market History</a>
     <a className='hashhctg'  style={{zIndex: '7', position: 'absolute', left: '72px', top: '552px' }} href='#mapinput'>Mapping</a>
     </div>
...
{close => (
   ...
   <br/>
     ...
     <br/>
            ...
            export default ActiveCommercialCtg; 
